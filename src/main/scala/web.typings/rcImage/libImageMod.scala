...
import web.typings.rcImage.anon.Transform
...
import web.typings.rcImage.rcImageStrings.`additions removals`
import web.typings.rcImage.rcImageStrings.`additions text`
import web.typings.rcImage.rcImageStrings.`inline`
import web.typings.rcImage.rcImageStrings.`lazy`
import web.typings.rcImage.rcImageStrings.`removals additions`
import web.typings.rcImage.rcImageStrings.`removals text`
import web.typings.rcImage.rcImageStrings.`text additions`
import web.typings.rcImage.rcImageStrings.`text removals`
import web.typings.rcImage.rcImageStrings.`use-credentials`
import web.typings.rcImage.rcImageStrings.additions
import web.typings.rcImage.rcImageStrings.all
import web.typings.rcImage.rcImageStrings.anonymous
import web.typings.rcImage.rcImageStrings.ascending
import web.typings.rcImage.rcImageStrings.assertive
import web.typings.rcImage.rcImageStrings.async
import web.typings.rcImage.rcImageStrings.auto
import web.typings.rcImage.rcImageStrings.both
import web.typings.rcImage.rcImageStrings.copy
import web.typings.rcImage.rcImageStrings.date
import web.typings.rcImage.rcImageStrings.decimal
import web.typings.rcImage.rcImageStrings.descending
import web.typings.rcImage.rcImageStrings.dialog
import web.typings.rcImage.rcImageStrings.eager
import web.typings.rcImage.rcImageStrings.email
import web.typings.rcImage.rcImageStrings.execute
import web.typings.rcImage.rcImageStrings.grammar
import web.typings.rcImage.rcImageStrings.grid
import web.typings.rcImage.rcImageStrings.horizontal
import web.typings.rcImage.rcImageStrings.inherit
import web.typings.rcImage.rcImageStrings.link
import web.typings.rcImage.rcImageStrings.list
import web.typings.rcImage.rcImageStrings.listbox
import web.typings.rcImage.rcImageStrings.location
import web.typings.rcImage.rcImageStrings.menu
import web.typings.rcImage.rcImageStrings.mixed
import web.typings.rcImage.rcImageStrings.move
import web.typings.rcImage.rcImageStrings.no
import web.typings.rcImage.rcImageStrings.none
import web.typings.rcImage.rcImageStrings.numeric
import web.typings.rcImage.rcImageStrings.off
import web.typings.rcImage.rcImageStrings.on
import web.typings.rcImage.rcImageStrings.other
import web.typings.rcImage.rcImageStrings.page
import web.typings.rcImage.rcImageStrings.polite
import web.typings.rcImage.rcImageStrings.popup
import web.typings.rcImage.rcImageStrings.removals
import web.typings.rcImage.rcImageStrings.search
import web.typings.rcImage.rcImageStrings.spelling
import web.typings.rcImage.rcImageStrings.step
import web.typings.rcImage.rcImageStrings.sync
import web.typings.rcImage.rcImageStrings.tel
import web.typings.rcImage.rcImageStrings.text
import web.typings.rcImage.rcImageStrings.time
import web.typings.rcImage.rcImageStrings.tree
import web.typings.rcImage.rcImageStrings.url
import web.typings.rcImage.rcImageStrings.vertical
import web.typings.rcImage.rcImageStrings.yes
...
object libImageMod extends Shortcut {
  ...
  trait ImagePreviewType extends StObject {
    ...
    var imageRender: js.UndefOr[
        js.Function2[/* originalNode */ ReactElement, /* info */ Transform, ReactElement]
      ] = js.native
    
    var keyboard: js.UndefOr[Boolean] = js.native
    
    var mask: js.UndefOr[ReactElement] = js.native
    ...
    var toolbarRender: js.UndefOr[
        js.Function2[/* originalNode */ ReactElement, /* info */ OmitToolbarRenderInfoType, ReactElement]
      ] = js.native
  ...
  object ImagePreviewType {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: ImagePreviewType] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setImageRender(value: (/* originalNode */ ReactElement, /* info */ Transform) => ReactElement): Self = StObject.set(x, "imageRender", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setMask(value: ReactElement): Self = StObject.set(x, "mask", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnVisibleChange(value: (/* value */ Boolean, /* prevValue */ Boolean) => Unit): Self = StObject.set(x, "onVisibleChange", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setToolbarRender(value: (/* originalNode */ ReactElement, /* info */ OmitToolbarRenderInfoType) => ReactElement): Self = StObject.set(x, "toolbarRender", js.Any.fromFunction2(value))
  ...
  trait ImageProps extends StObject {
    ...
    var onError: js.UndefOr[js.Function1[/* e */ SyntheticEvent[Event, HTMLImageElement], Unit]] = js.native
    ...
    var onResize: js.UndefOr[ReactEventHandler[HTMLImageElement]] = js.native
  ...
  object ImageProps {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: ImageProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnError(value: /* e */ SyntheticEvent[Event, HTMLImageElement] => Unit): Self = StObject.set(x, "onError", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnPreviewClose(value: (/* value */ Boolean, /* prevValue */ Boolean) => Unit): Self = StObject.set(x, "onPreviewClose", js.Any.fromFunction2(value))
      
      @scala.inline
      def setOnPreviewCloseUndefined: Self = StObject.set(x, "onPreviewClose", js.undefined)
      ...
      @scala.inline
      def setOnResize(value: SyntheticEvent[Event, HTMLImageElement] => Unit): Self = StObject.set(x, "onResize", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setPreview(value: Boolean | ImagePreviewType): Self = StObject.set(x, "preview", value.asInstanceOf[js.Any])
