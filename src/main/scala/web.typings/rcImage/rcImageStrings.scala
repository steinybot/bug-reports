...
import web.typings.rcImage.libHooksUseStatusMod.ImageStatus
...
object rcImageStrings {
  ...
  @js.native
  sealed trait decoding extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait dragRebound
    extends StObject
       with TransformAction
  @scala.inline
  def dragRebound: dragRebound = "dragRebound".asInstanceOf[dragRebound]
  ...
  sealed trait flipX
    extends StObject
       with TransformAction
  @scala.inline
  def flipX: flipX = "flipX".asInstanceOf[flipX]
  ...
  @js.native
  sealed trait touchZoom
    extends StObject
       with TransformAction
  @scala.inline
  def touchZoom: touchZoom = "touchZoom".asInstanceOf[touchZoom]
  ...
  @js.native
  sealed trait useMap extends StObject
  @scala.inline
