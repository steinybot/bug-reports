...
import web.typings.rcInputNumber.anon.AffixWrapper
import web.typings.rcInputNumber.anon.Children
import web.typings.rcInputNumber.anon.DisplayName
import web.typings.rcInputNumber.anon.Group
import web.typings.rcInputNumber.anon.Input
import web.typings.rcInputNumber.anon.Offset
import web.typings.rcInputNumber.rcInputNumberStrings._empty
import web.typings.rcInputNumber.rcInputNumberStrings.`additions removals`
import web.typings.rcInputNumber.rcInputNumberStrings.`additions text`
import web.typings.rcInputNumber.rcInputNumberStrings.`inline`
import web.typings.rcInputNumber.rcInputNumberStrings.`removals additions`
import web.typings.rcInputNumber.rcInputNumberStrings.`removals text`
import web.typings.rcInputNumber.rcInputNumberStrings.`text additions`
import web.typings.rcInputNumber.rcInputNumberStrings.`text removals`
import web.typings.rcInputNumber.rcInputNumberStrings.`use-credentials`
import web.typings.rcInputNumber.rcInputNumberStrings.additions
import web.typings.rcInputNumber.rcInputNumberStrings.all
import web.typings.rcInputNumber.rcInputNumberStrings.anonymous
import web.typings.rcInputNumber.rcInputNumberStrings.ascending
import web.typings.rcInputNumber.rcInputNumberStrings.assertive
import web.typings.rcInputNumber.rcInputNumberStrings.both
import web.typings.rcInputNumber.rcInputNumberStrings.copy
import web.typings.rcInputNumber.rcInputNumberStrings.date
import web.typings.rcInputNumber.rcInputNumberStrings.decimal
import web.typings.rcInputNumber.rcInputNumberStrings.descending
import web.typings.rcInputNumber.rcInputNumberStrings.dialog
import web.typings.rcInputNumber.rcInputNumberStrings.done
import web.typings.rcInputNumber.rcInputNumberStrings.email
import web.typings.rcInputNumber.rcInputNumberStrings.enter
import web.typings.rcInputNumber.rcInputNumberStrings.environment
import web.typings.rcInputNumber.rcInputNumberStrings.execute
import web.typings.rcInputNumber.rcInputNumberStrings.go
import web.typings.rcInputNumber.rcInputNumberStrings.grammar
import web.typings.rcInputNumber.rcInputNumberStrings.grid
import web.typings.rcInputNumber.rcInputNumberStrings.horizontal
import web.typings.rcInputNumber.rcInputNumberStrings.inherit
import web.typings.rcInputNumber.rcInputNumberStrings.link
import web.typings.rcInputNumber.rcInputNumberStrings.list
import web.typings.rcInputNumber.rcInputNumberStrings.listbox
import web.typings.rcInputNumber.rcInputNumberStrings.location
import web.typings.rcInputNumber.rcInputNumberStrings.menu
import web.typings.rcInputNumber.rcInputNumberStrings.mixed
import web.typings.rcInputNumber.rcInputNumberStrings.move
import web.typings.rcInputNumber.rcInputNumberStrings.next
import web.typings.rcInputNumber.rcInputNumberStrings.no
import web.typings.rcInputNumber.rcInputNumberStrings.none
import web.typings.rcInputNumber.rcInputNumberStrings.numeric
import web.typings.rcInputNumber.rcInputNumberStrings.off
import web.typings.rcInputNumber.rcInputNumberStrings.on
import web.typings.rcInputNumber.rcInputNumberStrings.other
import web.typings.rcInputNumber.rcInputNumberStrings.page
import web.typings.rcInputNumber.rcInputNumberStrings.polite
import web.typings.rcInputNumber.rcInputNumberStrings.popup
import web.typings.rcInputNumber.rcInputNumberStrings.previous
import web.typings.rcInputNumber.rcInputNumberStrings.removals
import web.typings.rcInputNumber.rcInputNumberStrings.search
import web.typings.rcInputNumber.rcInputNumberStrings.send
import web.typings.rcInputNumber.rcInputNumberStrings.spelling
import web.typings.rcInputNumber.rcInputNumberStrings.step
import web.typings.rcInputNumber.rcInputNumberStrings.tel
import web.typings.rcInputNumber.rcInputNumberStrings.text
import web.typings.rcInputNumber.rcInputNumberStrings.time
import web.typings.rcInputNumber.rcInputNumberStrings.tree
import web.typings.rcInputNumber.rcInputNumberStrings.url
import web.typings.rcInputNumber.rcInputNumberStrings.user
import web.typings.rcInputNumber.rcInputNumberStrings.vertical
import web.typings.rcInputNumber.rcInputNumberStrings.yes
...
object esInputNumberMod extends Shortcut {
  ...
  /* Inlined parent std.Omit<react.react.InputHTMLAttributes<std.HTMLInputElement>, 'value' | 'defaultValue' | 'onInput' | 'onChange' | 'prefix' | 'suffix'> */
  @js.native
  trait InputNumberProps[T /* <: ValueType */] extends StObject {
    ...
    var classNames: js.UndefOr[Group] = js.native
    ...
    var formatter: js.UndefOr[js.Function2[/* value */ js.UndefOr[T], /* info */ Input, String]] = js.native
    ...
    var max: js.UndefOr[T] = js.native
    
    var maxLength: js.UndefOr[Double] = js.native
    
    var min: js.UndefOr[T] = js.native
    ...
    var onChange: js.UndefOr[js.Function1[/* value */ T | Null, Unit]] = js.native
    ...
    var onInput: js.UndefOr[js.Function1[/* text */ String, Unit]] = js.native
    ...
    var onStep: js.UndefOr[js.Function2[/* value */ T, /* info */ Offset, Unit]] = js.native
    ...
    var parser: js.UndefOr[js.Function1[/* displayValue */ js.UndefOr[String], T]] = js.native
    ...
    var step: js.UndefOr[ValueType] = js.native
    
    /** value will show as string */
    var stringMode: js.UndefOr[Boolean] = js.native
  ...
  object InputNumberProps {
    ...
    @scala.inline
    def apply[T /* <: ValueType */](): InputNumberProps[T] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[InputNumberProps[T]]
    }
    
    @scala.inline
    implicit class MutableBuilder[Self <: InputNumberProps[_], T /* <: ValueType */] (val x: Self with InputNumberProps[T]) extends AnyVal {
      ...
      @scala.inline
      def setClassNames(value: Group): Self = StObject.set(x, "classNames", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setFormatter(value: (/* value */ js.UndefOr[T], /* info */ Input) => String): Self = StObject.set(x, "formatter", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setMax(value: T): Self = StObject.set(x, "max", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setMin(value: T): Self = StObject.set(x, "min", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnChange(value: /* value */ T | Null => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnInput(value: /* text */ String => Unit): Self = StObject.set(x, "onInput", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnStep(value: (/* value */ T, /* info */ Offset) => Unit): Self = StObject.set(x, "onStep", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setParser(value: /* displayValue */ js.UndefOr[String] => T): Self = StObject.set(x, "parser", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setStep(value: ValueType): Self = StObject.set(x, "step", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setStepUndefined: Self = StObject.set(x, "step", js.undefined)
      
      @scala.inline
      def setStringMode(value: Boolean): Self = StObject.set(x, "stringMode", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setStringModeUndefined: Self = StObject.set(x, "stringMode", js.undefined)
  ...
  /* This means you don't have to write `default`, but can instead just say `esInputNumberMod.foo` */
