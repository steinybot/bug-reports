...
@scala.inline
class SharedBuilder_ChildrenInputNumberProps2052148856[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  @scala.inline
  def classNames(value: Group): this.type = set("classNames", value.asInstanceOf[js.Any])
  ...
  @scala.inline
  def formatter(value: (/* value */ js.UndefOr[ValueType], /* info */ Input) => String): this.type = set("formatter", js.Any.fromFunction2(value))
  ...
  @scala.inline
  def max(value: ValueType): this.type = set("max", value.asInstanceOf[js.Any])
  
  @scala.inline
  def maxLength(value: Double): this.type = set("maxLength", value.asInstanceOf[js.Any])
  
  @scala.inline
  def min(value: ValueType): this.type = set("min", value.asInstanceOf[js.Any])
  ...
  @scala.inline
  def onChange(value: /* value */ ValueType | Null => Unit): this.type = set("onChange", js.Any.fromFunction1(value))
  ...
  @scala.inline
  def onInput(value: /* text */ String => Unit): this.type = set("onInput", js.Any.fromFunction1(value))
  ...
  @scala.inline
  def onResize(value: SyntheticEvent[Event, HTMLInputElement] => Unit): this.type = set("onResize", js.Any.fromFunction1(value))
  ...
  @scala.inline
  def onStep(value: (ValueType, /* info */ Offset) => Unit): this.type = set("onStep", js.Any.fromFunction2(value))
  ...
  @scala.inline
  def parser(value: /* displayValue */ js.UndefOr[String] => ValueType): this.type = set("parser", js.Any.fromFunction1(value))
  ...
  @scala.inline
  def step(value: ValueType): this.type = set("step", value.asInstanceOf[js.Any])
  
  @scala.inline
  def stringMode(value: Boolean): this.type = set("stringMode", value.asInstanceOf[js.Any])
