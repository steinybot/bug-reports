...
object Panel {
  ...
  def apply(prefixCls: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[PanelProps with RefAttributes[ContentRef]]))
  }
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def ariaId(value: String): this.type = set("ariaId", value.asInstanceOf[js.Any])
  ...
  type Props = PanelProps with RefAttributes[ContentRef]
  
  def withProps(p: PanelProps with RefAttributes[ContentRef]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
