...
object Content {
  ...
  @scala.inline
  def apply(ariaId: String, motionName: String, onVisibleChanged: Boolean => Unit, prefixCls: String): Builder = {
    val __props = js.Dynamic.literal(ariaId = ariaId.asInstanceOf[js.Any], motionName = motionName.asInstanceOf[js.Any], onVisibleChanged = js.Any.fromFunction1(onVisibleChanged), prefixCls = prefixCls.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[motionNamestringariaIdstr]))
  }
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def holderRef(value: Ref[HTMLDivElement]): this.type = set("holderRef", value.asInstanceOf[js.Any])
    
    @scala.inline
    def holderRefFunction1(value: /* instance */ HTMLDivElement | Null => Unit): this.type = set("holderRef", js.Any.fromFunction1(value))
    
    @scala.inline
    def holderRefNull: this.type = set("holderRef", null)
    
    @scala.inline
    def holderRefReactRef(value: ReactRef[HTMLDivElement]): this.type = set("holderRef", value.asInstanceOf[js.Any])
  ...
  type Props = motionNamestringariaIdstr
  
  def withProps(p: motionNamestringariaIdstr): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
