...
object anon {
  ...
  object Left {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: Left] (val x: Self) extends AnyVal {
  ...
  trait motionNamestringariaIdstr extends StObject {
    ...
    /**
      ...
      */
    var ref: js.UndefOr[Ref[ContentRef]] = js.native
  ...
  object motionNamestringariaIdstr {
    ...
    @scala.inline
    def apply(ariaId: String, motionName: String, onVisibleChanged: Boolean => Unit, prefixCls: String): motionNamestringariaIdstr = {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: motionNamestringariaIdstr] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRef(value: Ref[ContentRef]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRefFunction1(value: /* instance */ ContentRef | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
      
      @scala.inline
      def setRefNull: Self = StObject.set(x, "ref", null)
      
      @scala.inline
      def setRefReactRef(value: ReactRef[ContentRef]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
