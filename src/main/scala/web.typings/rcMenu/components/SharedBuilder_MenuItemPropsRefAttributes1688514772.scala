...
@scala.inline
class SharedBuilder_MenuItemPropsRefAttributes1688514772[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  @scala.inline
  def onResize(value: SyntheticEvent[Event, HTMLLIElement] => Unit): this.type = set("onResize", js.Any.fromFunction1(value))
