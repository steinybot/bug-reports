...
object esMenuItemMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[MenuItemProps with RefAttributes[HTMLElement]] = js.native
  ...
  object MenuItemProps {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: MenuItemProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnResize(value: SyntheticEvent[Event, HTMLLIElement] => Unit): Self = StObject.set(x, "onResize", js.Any.fromFunction1(value))
  ...
  type _To = ReactComponentClass[MenuItemProps with RefAttributes[HTMLElement]]
  
  /* This means you don't have to write `default`, but can instead just say `esMenuItemMod.foo` */
  override def _to: ReactComponentClass[MenuItemProps with RefAttributes[HTMLElement]] = default
}
