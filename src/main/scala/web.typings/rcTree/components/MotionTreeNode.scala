...
import web.typings.rcTree.esMotionTreeNodeMod.MotionTreeNodeProps
...
object MotionTreeNode {
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def motionNodes(value: js.Array[FlattenNode[DataNode]]): this.type = set("motionNodes", value.asInstanceOf[js.Any])
    
    @scala.inline
    def motionNodesVarargs(value: FlattenNode[DataNode]*): this.type = set("motionNodes", js.Array(value :_*))
  ...
  type Props = MotionTreeNodeProps with RefAttributes[HTMLDivElement]
