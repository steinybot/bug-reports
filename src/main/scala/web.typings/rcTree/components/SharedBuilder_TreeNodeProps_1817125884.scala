...
@scala.inline
class SharedBuilder_TreeNodeProps_1817125884 (val args: js.Array[Any])
  extends AnyVal
  ...
  @scala.inline
  def title(value: ReactElement | (js.Function1[DataNode, ReactElement])): this.type = set("title", value.asInstanceOf[js.Any])
  
  @scala.inline
  def titleFunction1(value: DataNode => ReactElement): this.type = set("title", js.Any.fromFunction1(value))
