...
import web.typings.rcTree.esUtilsTreeUtilMod.TreeNodeRequiredProps
import web.typings.rcTree.rcTreeStrings.hide
import web.typings.rcTree.rcTreeStrings.show
...
object esMotionTreeNodeMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[MotionTreeNodeProps with RefAttributes[HTMLDivElement]] = js.native
  
  /* Inlined parent std.Omit<rc-tree.rc-tree/es/interface.TreeNodeProps<rc-tree.rc-tree/es/interface.DataNode>, 'domRef'> */
  @js.native
  trait MotionTreeNodeProps extends StObject {
    ...
    var motionNodes: js.UndefOr[js.Array[FlattenNode[DataNode]]] = js.native
    ...
    var treeNodeRequiredProps: TreeNodeRequiredProps[DataNode] = js.native
  }
  object MotionTreeNodeProps {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: MotionTreeNodeProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setMotionNodes(value: js.Array[FlattenNode[DataNode]]): Self = StObject.set(x, "motionNodes", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMotionNodesUndefined: Self = StObject.set(x, "motionNodes", js.undefined)
      
      @scala.inline
      def setMotionNodesVarargs(value: FlattenNode[DataNode]*): Self = StObject.set(x, "motionNodes", js.Array(value :_*))
      ...
      @scala.inline
      def setTreeNodeRequiredProps(value: TreeNodeRequiredProps[DataNode]): Self = StObject.set(x, "treeNodeRequiredProps", value.asInstanceOf[js.Any])
    }
  }
  
  type _To = ReactComponentClass[MotionTreeNodeProps with RefAttributes[HTMLDivElement]]
  
  /* This means you don't have to write `default`, but can instead just say `esMotionTreeNodeMod.foo` */
  override def _to: ReactComponentClass[MotionTreeNodeProps with RefAttributes[HTMLDivElement]] = default
}
