...
object esIndentMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[js.Function1[/* param0 */ IndentProps, Element]] = js.native
  ...
  object IndentProps {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: IndentProps] (val x: Self) extends AnyVal {
  ...
  type _To = ReactComponentClass[js.Function1[/* param0 */ IndentProps, Element]]
  
  /* This means you don't have to write `default`, but can instead just say `esIndentMod.foo` */
  override def _to: ReactComponentClass[js.Function1[/* param0 */ IndentProps, Element]] = default
}
