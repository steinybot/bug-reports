...
object RcSteps {
  ...
  implicit def make(companion: RcSteps.type): SharedBuilder_StepsProps_684409827 = new SharedBuilder_StepsProps_684409827(js.Array(this.component, js.Dictionary.empty))()
