...
trait TransformStream[I, O] extends StObject {
  ...
  /* standard dom */
  val readable: org.scalajs.dom.ReadableStream[O] = js.native
...
object TransformStream {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: TransformStream[_, _], I, O] (val x: Self with (TransformStream[I, O])) extends AnyVal {
