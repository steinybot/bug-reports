...
trait ReadableWritablePair[R, W] extends StObject {
  ...
  /* standard dom */
  var readable: org.scalajs.dom.ReadableStream[R] = js.native
...
object ReadableWritablePair {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: ReadableWritablePair[_, _], R, W] (val x: Self with (ReadableWritablePair[R, W])) extends AnyVal {
