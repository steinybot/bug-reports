...
trait MessageChannel extends StObject {
  ...
  /**
    ...
    */
  /* standard dom */
  val port1: org.scalajs.dom.MessagePort = js.native
  
  /**
    * Returns the second MessagePort object.
    */
  /* standard dom */
  val port2: org.scalajs.dom.MessagePort = js.native
}
object MessageChannel {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: MessageChannel] (val x: Self) extends AnyVal {
