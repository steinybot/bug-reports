...
trait StaticRangeInit extends StObject {
  ...
  /* standard dom */
  var endContainer: org.scalajs.dom.Node = js.native
  
  /* standard dom */
  var endOffset: Double = js.native
  
  /* standard dom */
  var startContainer: org.scalajs.dom.Node = js.native
...
object StaticRangeInit {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: StaticRangeInit] (val x: Self) extends AnyVal {
