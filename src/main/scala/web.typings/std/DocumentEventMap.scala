...
trait DocumentEventMap
  ...
  /* standard dom */
  var pointerlockchange: org.scalajs.dom.Event = js.native
  
  /* standard dom */
  var pointerlockerror: org.scalajs.dom.Event = js.native
  
  /* standard dom */
  var readystatechange: org.scalajs.dom.Event = js.native
  
  /* standard dom */
  var visibilitychange: org.scalajs.dom.Event = js.native
}
object DocumentEventMap {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: DocumentEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPointerlockchange(value: org.scalajs.dom.Event): Self = StObject.set(x, "pointerlockchange", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPointerlockerror(value: org.scalajs.dom.Event): Self = StObject.set(x, "pointerlockerror", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setReadystatechange(value: org.scalajs.dom.Event): Self = StObject.set(x, "readystatechange", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setVisibilitychange(value: org.scalajs.dom.Event): Self = StObject.set(x, "visibilitychange", value.asInstanceOf[js.Any])
  }
}
