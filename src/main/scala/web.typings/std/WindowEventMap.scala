...
trait WindowEventMap
  ...
  /* standard dom */
  var compassneedscalibration: org.scalajs.dom.Event = js.native
  
  /* standard dom */
  var devicemotion: org.scalajs.dom.DeviceMotionEvent = js.native
  
  /* standard dom */
  var deviceorientation: org.scalajs.dom.DeviceOrientationEvent = js.native
  
  /* standard dom */
  var deviceorientationabsolute: org.scalajs.dom.DeviceOrientationEvent = js.native
  
  /* standard dom */
  var gamepadconnected: org.scalajs.dom.GamepadEvent = js.native
  
  /* standard dom */
  var gamepaddisconnected: org.scalajs.dom.GamepadEvent = js.native
  
  /* standard dom */
  var mousewheel: org.scalajs.dom.Event = js.native
  
  /* standard dom */
  var orientationchange: org.scalajs.dom.Event = js.native
  
  /* standard dom */
  var readystatechange: org.scalajs.dom.ProgressEvent = js.native
  
  /* standard dom */
  var vrdisplayactivate: org.scalajs.dom.Event = js.native
  
  /* standard dom */
  var vrdisplayblur: org.scalajs.dom.Event = js.native
  
  /* standard dom */
  var vrdisplayconnect: org.scalajs.dom.Event = js.native
  
  /* standard dom */
  var vrdisplaydeactivate: org.scalajs.dom.Event = js.native
  
  /* standard dom */
  var vrdisplaydisconnect: org.scalajs.dom.Event = js.native
  
  /* standard dom */
  var vrdisplaypresentchange: org.scalajs.dom.Event = js.native
}
object WindowEventMap {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: WindowEventMap] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setCompassneedscalibration(value: org.scalajs.dom.Event): Self = StObject.set(x, "compassneedscalibration", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDevicemotion(value: org.scalajs.dom.DeviceMotionEvent): Self = StObject.set(x, "devicemotion", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDeviceorientation(value: org.scalajs.dom.DeviceOrientationEvent): Self = StObject.set(x, "deviceorientation", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDeviceorientationabsolute(value: org.scalajs.dom.DeviceOrientationEvent): Self = StObject.set(x, "deviceorientationabsolute", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMousewheel(value: org.scalajs.dom.Event): Self = StObject.set(x, "mousewheel", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOrientationchange(value: org.scalajs.dom.Event): Self = StObject.set(x, "orientationchange", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setReadystatechange(value: org.scalajs.dom.ProgressEvent): Self = StObject.set(x, "readystatechange", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setVrdisplayactivate(value: org.scalajs.dom.Event): Self = StObject.set(x, "vrdisplayactivate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setVrdisplayblur(value: org.scalajs.dom.Event): Self = StObject.set(x, "vrdisplayblur", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setVrdisplayconnect(value: org.scalajs.dom.Event): Self = StObject.set(x, "vrdisplayconnect", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setVrdisplaydeactivate(value: org.scalajs.dom.Event): Self = StObject.set(x, "vrdisplaydeactivate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setVrdisplaydisconnect(value: org.scalajs.dom.Event): Self = StObject.set(x, "vrdisplaydisconnect", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setVrdisplaypresentchange(value: org.scalajs.dom.Event): Self = StObject.set(x, "vrdisplaypresentchange", value.asInstanceOf[js.Any])
  }
}
