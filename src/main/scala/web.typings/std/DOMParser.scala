...
trait DOMParser extends StObject {
  ...
  /**
    ...
    */
  /* standard dom */
  def parseFromString(string: java.lang.String, `type`: DOMParserSupportedType): org.scalajs.dom.Document = js.native
}
object DOMParser {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: DOMParser] (val x: Self) extends AnyVal {
