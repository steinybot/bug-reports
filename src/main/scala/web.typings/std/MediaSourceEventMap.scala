...
trait MediaSourceEventMap extends StObject {
  ...
  /* standard dom */
  var sourceclose: org.scalajs.dom.Event = js.native
  
  /* standard dom */
  var sourceended: org.scalajs.dom.Event = js.native
  
  /* standard dom */
  var sourceopen: org.scalajs.dom.Event = js.native
}
object MediaSourceEventMap {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: MediaSourceEventMap] (val x: Self) extends AnyVal {
