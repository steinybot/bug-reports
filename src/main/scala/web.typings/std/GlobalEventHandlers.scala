...
import web.typings.std.stdStrings.animationcancel
import web.typings.std.stdStrings.animationend
import web.typings.std.stdStrings.animationiteration
import web.typings.std.stdStrings.animationstart
import web.typings.std.stdStrings.auxclick
import web.typings.std.stdStrings.beforeinput
import web.typings.std.stdStrings.blur
import web.typings.std.stdStrings.cancel
import web.typings.std.stdStrings.canplay
import web.typings.std.stdStrings.canplaythrough
import web.typings.std.stdStrings.change
import web.typings.std.stdStrings.click
import web.typings.std.stdStrings.close
import web.typings.std.stdStrings.compositionend
import web.typings.std.stdStrings.compositionstart
import web.typings.std.stdStrings.compositionupdate
import web.typings.std.stdStrings.contextmenu
import web.typings.std.stdStrings.cuechange
import web.typings.std.stdStrings.dblclick
import web.typings.std.stdStrings.drag
import web.typings.std.stdStrings.dragend
import web.typings.std.stdStrings.dragenter
import web.typings.std.stdStrings.dragexit
import web.typings.std.stdStrings.dragleave
import web.typings.std.stdStrings.dragover
import web.typings.std.stdStrings.dragstart
import web.typings.std.stdStrings.drop
import web.typings.std.stdStrings.durationchange
import web.typings.std.stdStrings.emptied
import web.typings.std.stdStrings.ended
import web.typings.std.stdStrings.error
import web.typings.std.stdStrings.focus
import web.typings.std.stdStrings.focusin
import web.typings.std.stdStrings.focusout
import web.typings.std.stdStrings.gotpointercapture
import web.typings.std.stdStrings.input
import web.typings.std.stdStrings.invalid
import web.typings.std.stdStrings.keydown
import web.typings.std.stdStrings.keypress
import web.typings.std.stdStrings.keyup
import web.typings.std.stdStrings.load
import web.typings.std.stdStrings.loadeddata
import web.typings.std.stdStrings.loadedmetadata
import web.typings.std.stdStrings.loadstart
import web.typings.std.stdStrings.lostpointercapture
import web.typings.std.stdStrings.mousedown
import web.typings.std.stdStrings.mouseenter
import web.typings.std.stdStrings.mouseleave
import web.typings.std.stdStrings.mousemove
import web.typings.std.stdStrings.mouseout
import web.typings.std.stdStrings.mouseover
import web.typings.std.stdStrings.mouseup
import web.typings.std.stdStrings.pause
import web.typings.std.stdStrings.play
import web.typings.std.stdStrings.playing
import web.typings.std.stdStrings.pointercancel
import web.typings.std.stdStrings.pointerdown
import web.typings.std.stdStrings.pointerenter
import web.typings.std.stdStrings.pointerleave
import web.typings.std.stdStrings.pointermove
import web.typings.std.stdStrings.pointerout
import web.typings.std.stdStrings.pointerover
import web.typings.std.stdStrings.pointerup
import web.typings.std.stdStrings.progress
import web.typings.std.stdStrings.ratechange
import web.typings.std.stdStrings.reset
import web.typings.std.stdStrings.resize
import web.typings.std.stdStrings.scroll
import web.typings.std.stdStrings.securitypolicyviolation
import web.typings.std.stdStrings.seeked
import web.typings.std.stdStrings.seeking
import web.typings.std.stdStrings.select
import web.typings.std.stdStrings.selectionchange
import web.typings.std.stdStrings.selectstart
import web.typings.std.stdStrings.stalled
import web.typings.std.stdStrings.submit
import web.typings.std.stdStrings.suspend
import web.typings.std.stdStrings.timeupdate
import web.typings.std.stdStrings.toggle
import web.typings.std.stdStrings.touchcancel
import web.typings.std.stdStrings.touchend
import web.typings.std.stdStrings.touchmove
import web.typings.std.stdStrings.touchstart
import web.typings.std.stdStrings.transitioncancel
import web.typings.std.stdStrings.transitionend
import web.typings.std.stdStrings.transitionrun
import web.typings.std.stdStrings.transitionstart
import web.typings.std.stdStrings.volumechange
import web.typings.std.stdStrings.waiting
import web.typings.std.stdStrings.wheel
