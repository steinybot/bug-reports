...
trait SVGSVGElementEventMap
  ...
  /* standard dom */
  var SVGUnload: org.scalajs.dom.Event = js.native
...
object SVGSVGElementEventMap {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: SVGSVGElementEventMap] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setSVGUnload(value: org.scalajs.dom.Event): Self = StObject.set(x, "SVGUnload", value.asInstanceOf[js.Any])
