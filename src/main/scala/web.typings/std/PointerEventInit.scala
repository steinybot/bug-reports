...
trait PointerEventInit
  ...
  /* standard dom */
  var coalescedEvents: js.UndefOr[js.Array[org.scalajs.dom.PointerEvent]] = js.native
  ...
  /* standard dom */
  var predictedEvents: js.UndefOr[js.Array[org.scalajs.dom.PointerEvent]] = js.native
...
object PointerEventInit {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: PointerEventInit] (val x: Self) extends AnyVal {
