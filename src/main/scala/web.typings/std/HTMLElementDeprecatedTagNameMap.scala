...
trait HTMLElementDeprecatedTagNameMap extends StObject {
  ...
  /* standard dom */
  var listing: org.scalajs.dom.HTMLPreElement = js.native
  
  /* standard dom */
  var xmp: org.scalajs.dom.HTMLPreElement = js.native
}
object HTMLElementDeprecatedTagNameMap {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: HTMLElementDeprecatedTagNameMap] (val x: Self) extends AnyVal {
