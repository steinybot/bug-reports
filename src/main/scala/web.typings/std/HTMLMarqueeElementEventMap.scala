...
trait HTMLMarqueeElementEventMap
  ...
  /* standard dom */
  var bounce: org.scalajs.dom.Event = js.native
  
  /* standard dom */
  var finish: org.scalajs.dom.Event = js.native
...
object HTMLMarqueeElementEventMap {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: HTMLMarqueeElementEventMap] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setBounce(value: org.scalajs.dom.Event): Self = StObject.set(x, "bounce", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFinish(value: org.scalajs.dom.Event): Self = StObject.set(x, "finish", value.asInstanceOf[js.Any])
