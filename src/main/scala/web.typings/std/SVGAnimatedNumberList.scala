...
trait SVGAnimatedNumberList extends StObject {
  ...
  /* standard dom */
  val animVal: org.scalajs.dom.SVGNumberList = js.native
  
  /* standard dom */
  val baseVal: org.scalajs.dom.SVGNumberList = js.native
}
object SVGAnimatedNumberList {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: SVGAnimatedNumberList] (val x: Self) extends AnyVal {
