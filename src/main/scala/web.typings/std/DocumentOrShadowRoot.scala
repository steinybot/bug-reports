...
trait DocumentOrShadowRoot extends StObject {
  ...
  /** @deprecated */
  /* standard dom */
  def caretRangeFromPoint(x: Double, y: Double): org.scalajs.dom.Range = js.native
  ...
  /**
    ...
    */
  /* standard dom */
  val styleSheets: org.scalajs.dom.StyleSheetList = js.native
}
object DocumentOrShadowRoot {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: DocumentOrShadowRoot] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCaretRangeFromPoint(value: (Double, Double) => org.scalajs.dom.Range): Self = StObject.set(x, "caretRangeFromPoint", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setGetSelection(value: () => org.scalajs.dom.Selection | Null): Self = StObject.set(x, "getSelection", js.Any.fromFunction0(value))
