...
trait CryptoKey extends StObject {
  ...
  /* standard dom */
  val algorithm: org.scalajs.dom.KeyAlgorithm = js.native
  
  /* standard dom */
  val extractable: scala.Boolean = js.native
  
  /* standard dom */
  val `type`: org.scalajs.dom.KeyType = js.native
  
  /* standard dom */
  val usages: js.Array[org.scalajs.dom.KeyUsage] = js.native
}
object CryptoKey {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: CryptoKey] (val x: Self) extends AnyVal {
