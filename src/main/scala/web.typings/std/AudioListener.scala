...
trait AudioListener extends StObject {
  ...
  /* standard dom */
  val forwardX: org.scalajs.dom.AudioParam = js.native
  
  /* standard dom */
  val forwardY: org.scalajs.dom.AudioParam = js.native
  
  /* standard dom */
  val forwardZ: org.scalajs.dom.AudioParam = js.native
  ...
  /* standard dom */
  val upX: org.scalajs.dom.AudioParam = js.native
  
  /* standard dom */
  val upY: org.scalajs.dom.AudioParam = js.native
  
  /* standard dom */
  val upZ: org.scalajs.dom.AudioParam = js.native
}
object AudioListener {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: AudioListener] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setForwardX(value: org.scalajs.dom.AudioParam): Self = StObject.set(x, "forwardX", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setForwardY(value: org.scalajs.dom.AudioParam): Self = StObject.set(x, "forwardY", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setForwardZ(value: org.scalajs.dom.AudioParam): Self = StObject.set(x, "forwardZ", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPositionX(value: org.scalajs.dom.AudioParam): Self = StObject.set(x, "positionX", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPositionY(value: org.scalajs.dom.AudioParam): Self = StObject.set(x, "positionY", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPositionZ(value: org.scalajs.dom.AudioParam): Self = StObject.set(x, "positionZ", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUpX(value: org.scalajs.dom.AudioParam): Self = StObject.set(x, "upX", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUpY(value: org.scalajs.dom.AudioParam): Self = StObject.set(x, "upY", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUpZ(value: org.scalajs.dom.AudioParam): Self = StObject.set(x, "upZ", value.asInstanceOf[js.Any])
  }
}
