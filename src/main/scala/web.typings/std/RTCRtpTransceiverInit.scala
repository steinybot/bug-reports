...
trait RTCRtpTransceiverInit extends StObject {
  ...
  /* standard dom */
  var streams: js.UndefOr[js.Array[org.scalajs.dom.MediaStream]] = js.native
}
object RTCRtpTransceiverInit {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: RTCRtpTransceiverInit] (val x: Self) extends AnyVal {
