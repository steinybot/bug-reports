...
import web.typings.std.stdStrings.ANGLE_instanced_arrays
import web.typings.std.stdStrings.EXT_blend_minmax
import web.typings.std.stdStrings.EXT_frag_depth
import web.typings.std.stdStrings.EXT_sRGB
import web.typings.std.stdStrings.EXT_shader_texture_lod
import web.typings.std.stdStrings.EXT_texture_filter_anisotropic
import web.typings.std.stdStrings.OES_element_index_uint
import web.typings.std.stdStrings.OES_standard_derivatives
import web.typings.std.stdStrings.OES_texture_float
import web.typings.std.stdStrings.OES_texture_float_linear
import web.typings.std.stdStrings.OES_texture_half_float
import web.typings.std.stdStrings.OES_texture_half_float_linear
import web.typings.std.stdStrings.OES_vertex_array_object
import web.typings.std.stdStrings.WEBGL_color_buffer_float
import web.typings.std.stdStrings.WEBGL_compressed_texture_astc
import web.typings.std.stdStrings.WEBGL_compressed_texture_s3tc
import web.typings.std.stdStrings.WEBGL_compressed_texture_s3tc_srgb
import web.typings.std.stdStrings.WEBGL_debug_renderer_info
import web.typings.std.stdStrings.WEBGL_debug_shaders
import web.typings.std.stdStrings.WEBGL_depth_texture
import web.typings.std.stdStrings.WEBGL_draw_buffers
import web.typings.std.stdStrings.WEBGL_lose_context
