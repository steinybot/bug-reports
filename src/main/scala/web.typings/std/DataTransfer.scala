...
import web.typings.std.stdStrings.all
import web.typings.std.stdStrings.copy
import web.typings.std.stdStrings.copyLink
import web.typings.std.stdStrings.copyMove
import web.typings.std.stdStrings.link
import web.typings.std.stdStrings.linkMove
import web.typings.std.stdStrings.move
import web.typings.std.stdStrings.none
import web.typings.std.stdStrings.uninitialized
