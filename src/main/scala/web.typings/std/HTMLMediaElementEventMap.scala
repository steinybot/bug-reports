...
trait HTMLMediaElementEventMap
  ...
  /* standard dom */
  var waitingforkey: org.scalajs.dom.Event = js.native
}
object HTMLMediaElementEventMap {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: HTMLMediaElementEventMap] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setEncrypted(value: MediaEncryptedEvent): Self = StObject.set(x, "encrypted", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setWaitingforkey(value: org.scalajs.dom.Event): Self = StObject.set(x, "waitingforkey", value.asInstanceOf[js.Any])
  }
}
