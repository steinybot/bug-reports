...
object VRStageParameters {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: VRStageParameters] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setSittingToStandingTransform(value: js.typedarray.Float32Array): Self = StObject.set(x, "sittingToStandingTransform", value.asInstanceOf[js.Any])
