...
trait TreeWalker extends StObject {
  ...
  /* standard dom */
  def firstChild(): org.scalajs.dom.Node | Null = js.native
  
  /* standard dom */
  def lastChild(): org.scalajs.dom.Node | Null = js.native
  
  /* standard dom */
  def nextNode(): org.scalajs.dom.Node | Null = js.native
  
  /* standard dom */
  def nextSibling(): org.scalajs.dom.Node | Null = js.native
  
  /* standard dom */
  def parentNode(): org.scalajs.dom.Node | Null = js.native
  
  /* standard dom */
  def previousNode(): org.scalajs.dom.Node | Null = js.native
  
  /* standard dom */
  def previousSibling(): org.scalajs.dom.Node | Null = js.native
...
object TreeWalker {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: TreeWalker] (val x: Self) extends AnyVal {
