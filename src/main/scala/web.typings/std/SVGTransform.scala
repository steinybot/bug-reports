...
trait SVGTransform extends StObject {
  ...
  /* standard dom */
  val matrix: org.scalajs.dom.SVGMatrix = js.native
  
  /* standard dom */
  def setMatrix(matrix: org.scalajs.dom.SVGMatrix): Unit = js.native
...
object SVGTransform {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: SVGTransform] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setAngle(value: Double): Self = StObject.set(x, "angle", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMatrix(value: org.scalajs.dom.SVGMatrix): Self = StObject.set(x, "matrix", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSetMatrix(value: org.scalajs.dom.SVGMatrix => Unit): Self = StObject.set(x, "setMatrix", js.Any.fromFunction1(value))
