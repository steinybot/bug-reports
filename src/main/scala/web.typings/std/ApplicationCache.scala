...
import web.typings.std.stdStrings.cached
import web.typings.std.stdStrings.checking
import web.typings.std.stdStrings.downloading
import web.typings.std.stdStrings.error
import web.typings.std.stdStrings.noupdate
import web.typings.std.stdStrings.obsolete
import web.typings.std.stdStrings.progress
import web.typings.std.stdStrings.updateready
...
trait ApplicationCache
  ...
  /** @deprecated */
  /* standard dom */
  var oncached: (js.ThisFunction1[/* this */ this.type, /* ev */ org.scalajs.dom.Event, Any]) | Null = js.native
  
  /** @deprecated */
  /* standard dom */
  var onchecking: (js.ThisFunction1[/* this */ this.type, /* ev */ org.scalajs.dom.Event, Any]) | Null = js.native
  
  /** @deprecated */
  /* standard dom */
  var ondownloading: (js.ThisFunction1[/* this */ this.type, /* ev */ org.scalajs.dom.Event, Any]) | Null = js.native
  ...
  /** @deprecated */
  /* standard dom */
  var onnoupdate: (js.ThisFunction1[/* this */ this.type, /* ev */ org.scalajs.dom.Event, Any]) | Null = js.native
  
  /** @deprecated */
  /* standard dom */
  var onobsolete: (js.ThisFunction1[/* this */ this.type, /* ev */ org.scalajs.dom.Event, Any]) | Null = js.native
  ...
  /** @deprecated */
  /* standard dom */
  var onupdateready: (js.ThisFunction1[/* this */ this.type, /* ev */ org.scalajs.dom.Event, Any]) | Null = js.native
