...
trait OfflineAudioContextEventMap
  ...
  /* standard dom */
  var complete: org.scalajs.dom.OfflineAudioCompletionEvent = js.native
}
object OfflineAudioContextEventMap {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: OfflineAudioContextEventMap] (val x: Self) extends AnyVal {
