...
object RcCheckbox {
  ...
  implicit def make(companion: RcCheckbox.type): SharedBuilder_CheckboxPropsRefAttributes569128606[CheckboxRef] = new SharedBuilder_CheckboxPropsRefAttributes569128606[CheckboxRef](js.Array(this.component, js.Dictionary.empty))()
