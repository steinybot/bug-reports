...
import web.typings.rcCheckbox.mod.CheckboxChangeEvent
...
@scala.inline
class SharedBuilder_CheckboxPropsRefAttributes569128606[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  @scala.inline
  def onChange(value: /* e */ CheckboxChangeEvent => Unit): this.type = set("onChange", js.Any.fromFunction1(value))
