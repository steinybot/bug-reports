...
import web.typings.rcPicker.esPickerMod.default
...
object Picker {
  ...
  object PickerBaseProps {
    ...
    def apply[DateType](generateConfig: GenerateConfig[DateType], locale: Locale, picker: Exclude[PickerMode, date | time]): Builder[DateType] = {
      ...
      new Builder[DateType](js.Array(this.component, __props.asInstanceOf[web.typings.rcPicker.esPickerMod.PickerBaseProps[DateType]]))
    }
    ...
    type Props[DateType] = web.typings.rcPicker.esPickerMod.PickerBaseProps[DateType]
    
    def withProps[DateType](p: web.typings.rcPicker.esPickerMod.PickerBaseProps[DateType]): Builder[DateType] = new Builder[DateType](js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object PickerDateProps {
    ...
    def apply[DateType](generateConfig: GenerateConfig[DateType], locale: Locale): Builder[DateType] = {
      ...
      new Builder[DateType](js.Array(this.component, __props.asInstanceOf[web.typings.rcPicker.esPickerMod.PickerDateProps[DateType]]))
    }
    ...
    type Props[DateType] = web.typings.rcPicker.esPickerMod.PickerDateProps[DateType]
    
    def withProps[DateType](p: web.typings.rcPicker.esPickerMod.PickerDateProps[DateType]): Builder[DateType] = new Builder[DateType](js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object PickerTimeProps {
    ...
    def apply[DateType](generateConfig: GenerateConfig[DateType], locale: Locale): Builder[DateType] = {
      ...
      new Builder[DateType](js.Array(this.component, __props.asInstanceOf[web.typings.rcPicker.esPickerMod.PickerTimeProps[DateType]]))
    }
    ...
    type Props[DateType] = web.typings.rcPicker.esPickerMod.PickerTimeProps[DateType]
    
    def withProps[DateType](p: web.typings.rcPicker.esPickerMod.PickerTimeProps[DateType]): Builder[DateType] = new Builder[DateType](js.Array(this.component, p.asInstanceOf[js.Any]))
  }
}
