...
import web.typings.rcPicker.esHooksUseRangeOpenMod.SourceType
import web.typings.rcPicker.esInterfaceMod.PanelMode
import web.typings.rcPicker.esInterfaceMod.PickerMode
import web.typings.rcPicker.esPickerTriggerMod.Placement
...
object rcPickerStrings {
  ...
  @scala.inline
  def cellRender: cellRender = "cellRender".asInstanceOf[cellRender]
  ...
  @scala.inline
  def meridiem: meridiem = "meridiem".asInstanceOf[meridiem]
  ...
  @scala.inline
  def presets: presets = "presets".asInstanceOf[presets]
