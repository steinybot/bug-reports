...
object esPanelsPanelBodyMod {
  ...
  @scala.inline
  def default[DateType](param0: PanelBodyProps[DateType]): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(param0.asInstanceOf[js.Any]).asInstanceOf[Element]
  ...
  trait PanelBodyProps[DateType] extends StObject {
    ...
    var getCellNode: js.UndefOr[js.Function2[/* date */ DateType, /* wrapperNode */ ReactElement, ReactElement]] = js.native
  ...
  object PanelBodyProps {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: PanelBodyProps[_], DateType] (val x: Self with PanelBodyProps[DateType]) extends AnyVal {
      ...
      @scala.inline
      def setGetCellNode(value: (/* date */ DateType, /* wrapperNode */ ReactElement) => ReactElement): Self = StObject.set(x, "getCellNode", js.Any.fromFunction2(value))
