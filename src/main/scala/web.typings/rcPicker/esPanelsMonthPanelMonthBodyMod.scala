...
object esPanelsMonthPanelMonthBodyMod {
  ...
  object MonthBodyProps {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: MonthBodyProps[_], DateType] (val x: Self with MonthBodyProps[DateType]) extends AnyVal {
  ...
  type MonthCellRender[DateType] = js.Function2[/* currentDate */ DateType, /* locale */ Locale, ReactElement]
}
