...
object esPanelsHeaderMod {
  ...
  @scala.inline
  def default(param0: HeaderProps): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(param0.asInstanceOf[js.Any]).asInstanceOf[Element]
  ...
  object HeaderProps {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: HeaderProps] (val x: Self) extends AnyVal {
