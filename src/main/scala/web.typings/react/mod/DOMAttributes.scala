...
trait DOMAttributes[T] extends StObject {
  ...
  var onResize: js.UndefOr[ReactEventHandler[T]] = js.native
...
object DOMAttributes {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: DOMAttributes[_], T] (val x: Self with DOMAttributes[T]) extends AnyVal {
    ...
    @scala.inline
    def setOnResize(value: slinky.core.SyntheticEvent[Event, T] => Unit): Self = StObject.set(x, "onResize", js.Any.fromFunction1(value))
