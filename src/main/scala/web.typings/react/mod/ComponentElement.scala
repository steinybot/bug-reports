...
object ComponentElement {
  ...
  @scala.inline
  def apply[P, T /* <: ReactComponentClass[P] */](props: Any, `type`: Any): ComponentElement[P, T] = {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: ComponentElement[_, _], P, T /* <: ReactComponentClass[P] */] (val x: Self with (ComponentElement[P, T])) extends AnyVal {
