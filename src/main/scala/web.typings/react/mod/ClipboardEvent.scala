...
trait ClipboardEvent[T]
  extends StObject
     with BaseSyntheticEvent[org.scalajs.dom.ClipboardEvent, EventTarget with T, EventTarget] {
...
object ClipboardEvent {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: ClipboardEvent[_], T] (val x: Self with ClipboardEvent[T]) extends AnyVal {
