...
trait AnimationEvent[T]
  extends StObject
     with BaseSyntheticEvent[org.scalajs.dom.AnimationEvent, EventTarget with T, EventTarget] {
...
object AnimationEvent {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: AnimationEvent[_], T] (val x: Self with AnimationEvent[T]) extends AnyVal {
