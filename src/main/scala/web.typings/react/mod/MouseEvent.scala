...
trait MouseEvent[T, E]
  ...
  /**
    ...
    */
  def getModifierState(key: ModifierKey): Boolean = js.native
...
object MouseEvent {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: MouseEvent[_, _], T, E] (val x: Self with (MouseEvent[T, E])) extends AnyVal {
    ...
    @scala.inline
    def setGetModifierState(value: ModifierKey => Boolean): Self = StObject.set(x, "getModifierState", js.Any.fromFunction1(value))
