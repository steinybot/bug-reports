...
object DetailsHTMLAttributes {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: DetailsHTMLAttributes[_], T] (val x: Self with DetailsHTMLAttributes[T]) extends AnyVal {
    
    @scala.inline
    def setOnToggle(value: slinky.core.SyntheticEvent[Event, T] => Unit): Self = StObject.set(x, "onToggle", js.Any.fromFunction1(value))
