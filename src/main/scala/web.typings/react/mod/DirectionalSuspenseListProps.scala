...
trait DirectionalSuspenseListProps
  ...
  /**
    ...
    */
  var tail: js.UndefOr[web.typings.react.experimentalMod.reactAugmentingMod.SuspenseListTailMode] = js.native
}
object DirectionalSuspenseListProps {
  ...
  implicit class MutableBuilder[Self <: DirectionalSuspenseListProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTail(value: web.typings.react.experimentalMod.reactAugmentingMod.SuspenseListTailMode): Self = StObject.set(x, "tail", value.asInstanceOf[js.Any])
