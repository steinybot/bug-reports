...
import web.typings.react.reactStrings.mouse
import web.typings.react.reactStrings.pen
import web.typings.react.reactStrings.touch
...
object PointerEvent {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: PointerEvent[_], T] (val x: Self with PointerEvent[T]) extends AnyVal {
