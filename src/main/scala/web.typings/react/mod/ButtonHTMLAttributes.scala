...
import web.typings.react.reactStrings.button
...
object ButtonHTMLAttributes {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: ButtonHTMLAttributes[_], T] (val x: Self with ButtonHTMLAttributes[T]) extends AnyVal {
