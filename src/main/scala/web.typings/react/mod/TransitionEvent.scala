...
trait TransitionEvent[T]
  extends StObject
     with BaseSyntheticEvent[org.scalajs.dom.TransitionEvent, EventTarget with T, EventTarget] {
...
object TransitionEvent {
  ...
  def apply[T](
    ...
    isTrusted: Boolean,
    nativeEvent: org.scalajs.dom.TransitionEvent,
    persist: () => Unit,
    preventDefault: () => Unit,
    propertyName: String,
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: TransitionEvent[_], T] (val x: Self with TransitionEvent[T]) extends AnyVal {
