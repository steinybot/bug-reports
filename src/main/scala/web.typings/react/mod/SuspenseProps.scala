...
trait SuspenseProps extends StObject {
  ...
  var fallback: js.UndefOr[slinky.core.facade.ReactElement] = js.native
...
object SuspenseProps {
  ...
  implicit class MutableBuilder[Self <: SuspenseProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFallback(value: slinky.core.facade.ReactElement): Self = StObject.set(x, "fallback", value.asInstanceOf[js.Any])
