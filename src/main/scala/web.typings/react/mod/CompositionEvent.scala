...
trait CompositionEvent[T]
  extends StObject
     with BaseSyntheticEvent[org.scalajs.dom.CompositionEvent, EventTarget with T, EventTarget] {
...
object CompositionEvent {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: CompositionEvent[_], T] (val x: Self with CompositionEvent[T]) extends AnyVal {
