...
trait ImgHTMLAttributes[T]
  ...
  var loading: js.UndefOr[eager | web.typings.react.reactStrings.`lazy`] = js.native
...
object ImgHTMLAttributes {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: ImgHTMLAttributes[_], T] (val x: Self with ImgHTMLAttributes[T]) extends AnyVal {
    ...
    @scala.inline
    def setLoading(value: eager | web.typings.react.reactStrings.`lazy`): Self = StObject.set(x, "loading", value.asInstanceOf[js.Any])
