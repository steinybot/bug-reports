...
object h2 {
  ...
  implicit def make(companion: h2.type): SharedBuilder_DetailedHTMLProps_1549102952[HTMLHeadingElement] = new SharedBuilder_DetailedHTMLProps_1549102952[HTMLHeadingElement](js.Array(this.component, js.Dictionary.empty))()
