...
import web.typings.react.mod.SelectHTMLAttributes
...
object select {
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def onResize(value: SyntheticEvent[Event, HTMLSelectElement] => Unit): this.type = set("onResize", js.Any.fromFunction1(value))
