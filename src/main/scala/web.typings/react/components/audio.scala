...
import web.typings.react.mod.AudioHTMLAttributes
...
object audio {
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def onResize(value: SyntheticEvent[Event, HTMLAudioElement] => Unit): this.type = set("onResize", js.Any.fromFunction1(value))
