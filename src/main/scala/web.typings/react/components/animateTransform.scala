...
object animateTransform {
  ...
  implicit def make(companion: animateTransform.type): SharedBuilder_SVGProps1369103499[SVGElement] = new SharedBuilder_SVGProps1369103499[SVGElement](js.Array(this.component, js.Dictionary.empty))()
