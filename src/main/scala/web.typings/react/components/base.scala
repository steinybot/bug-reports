...
import web.typings.react.mod.BaseHTMLAttributes
...
object base {
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def onResize(value: SyntheticEvent[Event, HTMLBaseElement] => Unit): this.type = set("onResize", js.Any.fromFunction1(value))
