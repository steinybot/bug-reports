...
import web.typings.react.mod.TableHTMLAttributes
...
object table {
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def align(value: left | web.typings.react.reactStrings.center | right): this.type = set("align", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def border(value: Double): this.type = set("border", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def onResize(value: SyntheticEvent[Event, HTMLTableElement] => Unit): this.type = set("onResize", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def rules(value: none | groups | rows | columns | all): this.type = set("rules", value.asInstanceOf[js.Any])
