...
import web.typings.react.mod.AreaHTMLAttributes
...
object area {
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def onResize(value: SyntheticEvent[Event, HTMLAreaElement] => Unit): this.type = set("onResize", js.Any.fromFunction1(value))
