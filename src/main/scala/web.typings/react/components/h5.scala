...
object h5 {
  ...
  implicit def make(companion: h5.type): SharedBuilder_DetailedHTMLProps_1549102952[HTMLHeadingElement] = new SharedBuilder_DetailedHTMLProps_1549102952[HTMLHeadingElement](js.Array(this.component, js.Dictionary.empty))()
