...
import web.typings.react.reactStrings.done
import web.typings.react.reactStrings.email
import web.typings.react.reactStrings.enter
import web.typings.react.reactStrings.environment
import web.typings.react.reactStrings.execute
import web.typings.react.reactStrings.go
...
import web.typings.react.reactStrings.next
...
import web.typings.react.reactStrings.previous
import web.typings.react.reactStrings.removals
import web.typings.react.reactStrings.send
...
import web.typings.react.reactStrings.user
...
object input {
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def enterKeyHint(value: enter | done | go | next | previous | web.typings.react.reactStrings.search | send): this.type = set("enterKeyHint", value.asInstanceOf[js.Any])
