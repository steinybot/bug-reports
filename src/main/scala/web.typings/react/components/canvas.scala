...
import web.typings.react.mod.CanvasHTMLAttributes
...
object canvas {
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def onResize(value: SyntheticEvent[Event, HTMLCanvasElement] => Unit): this.type = set("onResize", js.Any.fromFunction1(value))
