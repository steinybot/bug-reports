...
object main {
  ...
  implicit def make(companion: main.type): SharedBuilder_DetailedHTMLProps_1224590439[HTMLElement] = new SharedBuilder_DetailedHTMLProps_1224590439[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
