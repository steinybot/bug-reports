...
object tbody {
  ...
  implicit def make(companion: tbody.type): SharedBuilder_DetailedHTMLProps_1876849174[HTMLTableSectionElement] = new SharedBuilder_DetailedHTMLProps_1876849174[HTMLTableSectionElement](js.Array(this.component, js.Dictionary.empty))()
