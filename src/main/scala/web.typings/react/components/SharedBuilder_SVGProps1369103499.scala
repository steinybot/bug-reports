...
@scala.inline
class SharedBuilder_SVGProps1369103499[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  @scala.inline
  def onResize(value: SyntheticEvent[Event, SVGElement] => Unit): this.type = set("onResize", js.Any.fromFunction1(value))
