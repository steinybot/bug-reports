...
import web.typings.react.mod.ButtonHTMLAttributes
...
object button {
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def onResize(value: SyntheticEvent[Event, HTMLButtonElement] => Unit): this.type = set("onResize", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def `type`(value: submit | reset | web.typings.react.reactStrings.button): this.type = set("type", value.asInstanceOf[js.Any])
