...
object esTourMod extends Shortcut {
  
  @JSImport("@rc-component/tour/es/Tour", JSImport.Default)
  @js.native
  ...
  trait TourProps extends StObject {
    ...
    var renderPanel: js.UndefOr[js.Function2[/* props */ TourStepProps, /* current */ Double, ReactElement]] = js.native
    
    var rootClassName: js.UndefOr[String] = js.native
    
    var scrollIntoViewOptions: js.UndefOr[Boolean | ScrollIntoViewOptions] = js.native
    
    var steps: js.UndefOr[js.Array[TourStepInfo]] = js.native
  ...
  object TourProps {
    ...
    implicit class MutableBuilder[Self <: TourProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRenderPanel(value: (/* props */ TourStepProps, /* current */ Double) => ReactElement): Self = StObject.set(x, "renderPanel", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setSteps(value: js.Array[TourStepInfo]): Self = StObject.set(x, "steps", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setStepsUndefined: Self = StObject.set(x, "steps", js.undefined)
      
      @scala.inline
      def setStepsVarargs(value: TourStepInfo*): Self = StObject.set(x, "steps", js.Array(value :_*))
  ...
  /* This means you don't have to write `default`, but can instead just say `esTourMod.foo` */
