...
object RcTreeSelect {
  ...
  implicit def make(companion: RcTreeSelect.type): SharedBuilder_ChildrenTreeSelectProps1034538622[BaseSelectRef] = new SharedBuilder_ChildrenTreeSelectProps1034538622[BaseSelectRef](js.Array(this.component, js.Dictionary.empty))()
