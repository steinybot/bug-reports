...
object esTreeSelectMod extends Shortcut {
  ...
  /* prop */ StringDictionary[Any] {
    ...
    var children: js.UndefOr[js.Array[BaseOptionType]] = js.native
  ...
  object BaseOptionType {
    ...
    implicit class MutableBuilder[Self <: BaseOptionType] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: js.Array[BaseOptionType]): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setChildrenUndefined: Self = StObject.set(x, "children", js.undefined)
      
      @scala.inline
      def setChildrenVarargs(value: BaseOptionType*): Self = StObject.set(x, "children", js.Array(value :_*))
  ...
  trait ChangeEventExtra extends StObject {
    ...
    var preValue: js.Array[LabeledValueType] = js.native
  ...
  object ChangeEventExtra {
    ...
    implicit class MutableBuilder[Self <: ChangeEventExtra] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPreValue(value: js.Array[LabeledValueType]): Self = StObject.set(x, "preValue", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPreValueVarargs(value: LabeledValueType*): Self = StObject.set(x, "preValue", js.Array(value :_*))
  ...
  trait DefaultOptionType
    ...
    @JSName("children")
    var children_DefaultOptionType: js.UndefOr[js.Array[DefaultOptionType]] = js.native
  ...
  object InternalFieldName {
    ...
    @scala.inline
    def apply(_title: js.Array[String]): InternalFieldName = {
      val __obj = js.Dynamic.literal(_title = _title.asInstanceOf[js.Any])
      __obj.asInstanceOf[InternalFieldName]
    }
    
    @scala.inline
    implicit class MutableBuilder[Self <: InternalFieldName] (val x: Self) extends AnyVal {
  ...
  object LabeledValueType {
    ...
    @scala.inline
    def apply(): LabeledValueType = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[LabeledValueType]
    }
    
    @scala.inline
    implicit class MutableBuilder[Self <: LabeledValueType] (val x: Self) extends AnyVal {
  ...
  */
  ...
  object TreeSelectProps {
    ...
    @scala.inline
    def apply[ValueType, OptionType /* <: BaseOptionType */](): TreeSelectProps[ValueType, OptionType] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[TreeSelectProps[ValueType, OptionType]]
    }
    
    @scala.inline
    implicit class MutableBuilder[Self <: TreeSelectProps[_, _], ValueType, OptionType /* <: BaseOptionType */] (val x: Self with (TreeSelectProps[ValueType, OptionType])) extends AnyVal {
