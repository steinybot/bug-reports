package web.typings.rcSegmented.components
...
object RcSegmented {
  ...
  @scala.inline
  def apply(options: SegmentedOptions): Builder = {
    val __props = js.Dynamic.literal(options = options.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[PickSegmentedPropsprefixC]))
  }
  ...
  type Props = PickSegmentedPropsprefixC
  
  def withProps(p: PickSegmentedPropsprefixC): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
