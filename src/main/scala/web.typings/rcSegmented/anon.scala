...
import web.typings.rcSegmented.mod.SegmentedLabeledOption
import web.typings.rcSegmented.mod.SegmentedOptions
import web.typings.rcSegmented.mod.SegmentedRawOption
import web.typings.rcSegmented.mod.SegmentedValue
import web.typings.rcSegmented.rcSegmentedStrings._empty
import web.typings.rcSegmented.rcSegmentedStrings.`additions removals`
import web.typings.rcSegmented.rcSegmentedStrings.`additions text`
import web.typings.rcSegmented.rcSegmentedStrings.`inline`
import web.typings.rcSegmented.rcSegmentedStrings.`removals additions`
import web.typings.rcSegmented.rcSegmentedStrings.`removals text`
import web.typings.rcSegmented.rcSegmentedStrings.`text additions`
import web.typings.rcSegmented.rcSegmentedStrings.`text removals`
import web.typings.rcSegmented.rcSegmentedStrings.`use-credentials`
import web.typings.rcSegmented.rcSegmentedStrings.additions
import web.typings.rcSegmented.rcSegmentedStrings.all
import web.typings.rcSegmented.rcSegmentedStrings.anonymous
import web.typings.rcSegmented.rcSegmentedStrings.ascending
import web.typings.rcSegmented.rcSegmentedStrings.assertive
import web.typings.rcSegmented.rcSegmentedStrings.both
import web.typings.rcSegmented.rcSegmentedStrings.copy
import web.typings.rcSegmented.rcSegmentedStrings.date
import web.typings.rcSegmented.rcSegmentedStrings.decimal
import web.typings.rcSegmented.rcSegmentedStrings.descending
import web.typings.rcSegmented.rcSegmentedStrings.dialog
import web.typings.rcSegmented.rcSegmentedStrings.email
import web.typings.rcSegmented.rcSegmentedStrings.environment
import web.typings.rcSegmented.rcSegmentedStrings.execute
import web.typings.rcSegmented.rcSegmentedStrings.grammar
import web.typings.rcSegmented.rcSegmentedStrings.grid
import web.typings.rcSegmented.rcSegmentedStrings.horizontal
import web.typings.rcSegmented.rcSegmentedStrings.inherit
import web.typings.rcSegmented.rcSegmentedStrings.link
import web.typings.rcSegmented.rcSegmentedStrings.list
import web.typings.rcSegmented.rcSegmentedStrings.listbox
import web.typings.rcSegmented.rcSegmentedStrings.location
import web.typings.rcSegmented.rcSegmentedStrings.ltr
import web.typings.rcSegmented.rcSegmentedStrings.menu
import web.typings.rcSegmented.rcSegmentedStrings.mixed
import web.typings.rcSegmented.rcSegmentedStrings.move
import web.typings.rcSegmented.rcSegmentedStrings.no
import web.typings.rcSegmented.rcSegmentedStrings.none
import web.typings.rcSegmented.rcSegmentedStrings.numeric
import web.typings.rcSegmented.rcSegmentedStrings.off
import web.typings.rcSegmented.rcSegmentedStrings.on
import web.typings.rcSegmented.rcSegmentedStrings.other
import web.typings.rcSegmented.rcSegmentedStrings.page
import web.typings.rcSegmented.rcSegmentedStrings.polite
import web.typings.rcSegmented.rcSegmentedStrings.popup
import web.typings.rcSegmented.rcSegmentedStrings.removals
import web.typings.rcSegmented.rcSegmentedStrings.rtl
import web.typings.rcSegmented.rcSegmentedStrings.search
import web.typings.rcSegmented.rcSegmentedStrings.spelling
import web.typings.rcSegmented.rcSegmentedStrings.step
import web.typings.rcSegmented.rcSegmentedStrings.tel
import web.typings.rcSegmented.rcSegmentedStrings.text
import web.typings.rcSegmented.rcSegmentedStrings.time
import web.typings.rcSegmented.rcSegmentedStrings.tree
import web.typings.rcSegmented.rcSegmentedStrings.url
import web.typings.rcSegmented.rcSegmentedStrings.user
import web.typings.rcSegmented.rcSegmentedStrings.vertical
import web.typings.rcSegmented.rcSegmentedStrings.yes
...
object anon {
  ...
  trait PickSegmentedPropsprefixC extends StObject {
    ...
    var defaultValue: js.UndefOr[SegmentedValue] = js.native
    ...
    var onChange: js.UndefOr[js.Function1[/* value */ SegmentedValue, Unit]] = js.native
    ...
    var options: SegmentedOptions = js.native
    ...
    var value: js.UndefOr[SegmentedValue] = js.native
  ...
  object PickSegmentedPropsprefixC {
    
    @scala.inline
    def apply(options: SegmentedOptions): PickSegmentedPropsprefixC = {
      val __obj = js.Dynamic.literal(options = options.asInstanceOf[js.Any])
      __obj.asInstanceOf[PickSegmentedPropsprefixC]
    }
    
    @scala.inline
    implicit class MutableBuilder[Self <: PickSegmentedPropsprefixC] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDefaultValue(value: SegmentedValue): Self = StObject.set(x, "defaultValue", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnChange(value: /* value */ SegmentedValue => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOptions(value: SegmentedOptions): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOptionsVarargs(value: (SegmentedRawOption | SegmentedLabeledOption)*): Self = StObject.set(x, "options", js.Array(value :_*))
