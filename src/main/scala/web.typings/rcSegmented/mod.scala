...
import web.typings.rcSegmented.anon.PickSegmentedPropsprefixC
...
import web.typings.react.mod.LegacyRef
...
object mod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[PickSegmentedPropsprefixC] = js.native
  ...
  trait SegmentedLabeledOption extends StObject {
    ...
    var value: SegmentedRawOption = js.native
  }
  object SegmentedLabeledOption {
    
    @scala.inline
    def apply(label: ReactElement, value: SegmentedRawOption): SegmentedLabeledOption = {
      val __obj = js.Dynamic.literal(label = label.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[SegmentedLabeledOption]
    }
    
    @scala.inline
    implicit class MutableBuilder[Self <: SegmentedLabeledOption] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setValue(value: SegmentedRawOption): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
    }
  }
  ...
  object SegmentedProps {
    ...
    @scala.inline
    def apply(options: SegmentedOptions): SegmentedProps = {
      val __obj = js.Dynamic.literal(options = options.asInstanceOf[js.Any])
      __obj.asInstanceOf[SegmentedProps]
    }
    
    @scala.inline
    implicit class MutableBuilder[Self <: SegmentedProps] (val x: Self) extends AnyVal {
  ...
  type _To = ReactComponentClass[PickSegmentedPropsprefixC]
  
  /* This means you don't have to write `default`, but can instead just say `mod.foo` */
  override def _to: ReactComponentClass[PickSegmentedPropsprefixC] = default
}
