...
object RawList {
  ...
  def apply[T](
    ...
    data: js.Array[T],
    itemKey: Key | (js.Function1[T, Key])
  ): Builder[T] = {
  ...
  class Builder[T] (val args: js.Array[Any])
    ...
    @scala.inline
    def onVisibleChange(value: (/* visibleList */ js.Array[T], /* fullList */ js.Array[T]) => Unit): this.type = set("onVisibleChange", js.Any.fromFunction2(value))
