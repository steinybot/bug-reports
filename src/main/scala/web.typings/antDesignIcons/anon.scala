...
object anon {
  ...
  object Nonce {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: Nonce] (val x: Self) extends AnyVal {
  ...
  object PickIconComponentPropssta {
    
    @scala.inline
    def apply(): PickIconComponentPropssta = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[PickIconComponentPropssta]
    }
    
    @scala.inline
    implicit class MutableBuilder[Self <: PickIconComponentPropssta] (val x: Self) extends AnyVal {
