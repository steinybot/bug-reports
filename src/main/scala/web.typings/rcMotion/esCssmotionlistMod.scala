...
import web.typings.rcMotion.esUtilDiffMod.KeyObject
...
object esCssmotionlistMod {
  ...
  @js.native
  class default protected () extends Component[CSSMotionListProps, Any, Any] {
  ...
  @scala.inline
  def genCSSMotionList(transitionSupport: Boolean): ReactComponentClass[CSSMotionListProps] = ^.asInstanceOf[js.Dynamic].applyDynamic("genCSSMotionList")(transitionSupport.asInstanceOf[js.Any]).asInstanceOf[ReactComponentClass[CSSMotionListProps]]
  @scala.inline
  def genCSSMotionList(transitionSupport: Boolean, CSSMotion: ReactComponentClass[CSSMotionPropsrefRefanyun]): ReactComponentClass[CSSMotionListProps] = (^.asInstanceOf[js.Dynamic].applyDynamic("genCSSMotionList")(transitionSupport.asInstanceOf[js.Any], CSSMotion.asInstanceOf[js.Any])).asInstanceOf[ReactComponentClass[CSSMotionListProps]]
  
  /* Inlined parent std.Omit<rc-motion.rc-motion/es/CSSMotion.CSSMotionProps, 'onVisibleChanged' | 'children'> */
  ...
  trait CSSMotionListProps extends StObject {
    ...
    var children: js.UndefOr[
        js.Function2[/* props */ ClassName, /* ref */ js.Function1[/* node */ Any, Unit], ReactElement]
      ] = js.native
    ...
    var onAllRemoved: js.UndefOr[js.Function0[Unit]] = js.native
    ...
    var onScroll: js.UndefOr[UIEventHandler[Any]] = js.native
    ...
    var onVisibleChanged: js.UndefOr[
        js.Function2[/* visible */ Boolean, /* info */ web.typings.rcMotion.anon.Key, Unit]
      ] = js.native
  ...
  object CSSMotionListProps {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: CSSMotionListProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: (/* props */ ClassName, /* ref */ js.Function1[/* node */ Any, Unit]) => ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setComponentReactComponentClass(value: ReactComponentClass[js.Object]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnScroll(value: SyntheticUIEvent[Any] => Unit): Self = StObject.set(x, "onScroll", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnVisibleChanged(value: (/* visible */ Boolean, /* info */ web.typings.rcMotion.anon.Key) => Unit): Self = StObject.set(x, "onVisibleChanged", js.Any.fromFunction2(value))
  ...
  object CSSMotionListState {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: CSSMotionListState] (val x: Self) extends AnyVal {
