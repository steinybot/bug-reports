...
import web.typings.rcMotion.anon.Animationend
...
object esUtilMotionMod {
  ...
  @scala.inline
  def getTransitionName(transitionName: MotionName, transitionType: String): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("getTransitionName")(transitionName.asInstanceOf[js.Any], transitionType.asInstanceOf[js.Any])).asInstanceOf[Any]
  
  @scala.inline
  def getVendorPrefixedEventName(eventName: String): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("getVendorPrefixedEventName")(eventName.asInstanceOf[js.Any]).asInstanceOf[Any]
