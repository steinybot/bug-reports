...
object esCssmotionMod {
  ...
  @scala.inline
  def genCSSMotion(config: CSSMotionConfig): ReactComponentClass[CSSMotionPropsrefRefanyun] = ^.asInstanceOf[js.Dynamic].applyDynamic("genCSSMotion")(config.asInstanceOf[js.Any]).asInstanceOf[ReactComponentClass[CSSMotionPropsrefRefanyun]]
  ...
  object CSSMotionProps {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: CSSMotionProps] (val x: Self) extends AnyVal {
  ...
  object CSSMotionState {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: CSSMotionState] (val x: Self) extends AnyVal {
