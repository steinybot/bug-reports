...
object esSegmentedMod extends Shortcut {
  
  @JSImport("antd/es/segmented", JSImport.Default)
  @js.native
  val default: ReactComponentClass[OmitSegmentedPropsrefRefA] = js.native
  
  /* Rewritten from type alias, can be one of: 
    - `web.typings`.antd.esSegmentedMod.SegmentedLabeledOptionWithIcon
    - `web.typings`.antd.esSegmentedMod.SegmentedLabeledOptionWithoutIcon
  */
  trait SegmentedLabeledOption extends StObject
  object SegmentedLabeledOption {
    
    @scala.inline
    def SegmentedLabeledOptionWithIcon(icon: ReactElement, value: SegmentedRawOption): web.typings.antd.esSegmentedMod.SegmentedLabeledOptionWithIcon = {
      val __obj = js.Dynamic.literal(icon = icon.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[web.typings.antd.esSegmentedMod.SegmentedLabeledOptionWithIcon]
    }
    
    @scala.inline
    def SegmentedLabeledOptionWithoutIcon(label: ReactElement, value: SegmentedRawOption): web.typings.antd.esSegmentedMod.SegmentedLabeledOptionWithoutIcon = {
      val __obj = js.Dynamic.literal(label = label.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[web.typings.antd.esSegmentedMod.SegmentedLabeledOptionWithoutIcon]
    }
  }
  ...
  object SegmentedLabeledOptionWithIcon {
    ...
    @scala.inline
    def apply(icon: ReactElement, value: SegmentedRawOption): SegmentedLabeledOptionWithIcon = {
      val __obj = js.Dynamic.literal(icon = icon.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[SegmentedLabeledOptionWithIcon]
    }
    
    @scala.inline
    implicit class MutableBuilder[Self <: SegmentedLabeledOptionWithIcon] (val x: Self) extends AnyVal {
  ...
  trait SegmentedLabeledOptionWithoutIcon
    extends StObject
       with web.typings.rcSegmented.mod.SegmentedLabeledOption
       with SegmentedLabeledOption
  object SegmentedLabeledOptionWithoutIcon {
    
    @scala.inline
    def apply(label: ReactElement, value: SegmentedRawOption): SegmentedLabeledOptionWithoutIcon = {
      val __obj = js.Dynamic.literal(label = label.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
  ...
  trait SegmentedProps extends StObject {
    ...
    var options: js.Array[SegmentedRawOption | SegmentedLabeledOption] = js.native
  ...
  object SegmentedProps {
    ...
    @scala.inline
    def apply(options: js.Array[SegmentedRawOption | SegmentedLabeledOption]): SegmentedProps = {
    ...
    implicit class MutableBuilder[Self <: SegmentedProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOptions(value: js.Array[SegmentedRawOption | SegmentedLabeledOption]): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
  ...
  type _To = ReactComponentClass[OmitSegmentedPropsrefRefA]
  
  /* This means you don't have to write `default`, but can instead just say `esSegmentedMod.foo` */
  override def _to: ReactComponentClass[OmitSegmentedPropsrefRefA] = default
}
