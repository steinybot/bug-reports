...
import web.typings.antd.esInputInputMod.InputFocusOptions
...
object esInputTextAreaMod extends Shortcut {
  
  @JSImport("antd/es/input/TextArea", JSImport.Default)
  @js.native
  val default: ReactComponentClass[TextAreaProps with RefAttributes[TextAreaRef]] = js.native
  
  /* Inlined parent std.Omit<rc-textarea.rc-textarea/es/interface.TextAreaProps, 'suffix'> */
  @js.native
  ...
  type _To = ReactComponentClass[TextAreaProps with RefAttributes[TextAreaRef]]
  
  /* This means you don't have to write `default`, but can instead just say `esInputTextAreaMod.foo` */
  override def _to: ReactComponentClass[TextAreaProps with RefAttributes[TextAreaRef]] = default
}
