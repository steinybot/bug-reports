...
import web.typings.antDesignReactSlick.mod.Slider
import web.typings.antDesignReactSlick.mod.SwipeDirection
import web.typings.antd.anon.`1`
import web.typings.antd.antdStrings.blur
import web.typings.antd.antdStrings.leave
import web.typings.antd.antdStrings.update
...
object esCarouselMod extends Shortcut {
  
  @JSImport("antd/es/carousel", JSImport.Default)
  @js.native
  val default: ReactComponentClass[CarouselProps with RefAttributes[CarouselRef]] = js.native
  
  /* Rewritten from type alias, can be one of: 
    - `web.typings`.antd.antdStrings.scrollx
    - `web.typings`.antd.antdStrings.fade
  */
  trait CarouselEffect extends StObject
  object CarouselEffect {
    
    @scala.inline
    def fade: web.typings.antd.antdStrings.fade = "fade".asInstanceOf[web.typings.antd.antdStrings.fade]
    
    @scala.inline
    def scrollx: web.typings.antd.antdStrings.scrollx = "scrollx".asInstanceOf[web.typings.antd.antdStrings.scrollx]
  }
  ...
  trait CarouselProps extends StObject {
    ...
    var dots: js.UndefOr[Boolean | `1`] = js.native
  ...
  object CarouselProps {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: CarouselProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDots(value: Boolean | `1`): Self = StObject.set(x, "dots", value.asInstanceOf[js.Any])
  ...
  */
  ...
  type _To = ReactComponentClass[CarouselProps with RefAttributes[CarouselRef]]
  
  /* This means you don't have to write `default`, but can instead just say `esCarouselMod.foo` */
  override def _to: ReactComponentClass[CarouselProps with RefAttributes[CarouselRef]] = default
}
