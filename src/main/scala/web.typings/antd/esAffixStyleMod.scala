...
object esAffixStyleMod {
  
  @JSImport("antd/es/affix/style", JSImport.Namespace)
  @js.native
  ...
  @JSImport("antd/es/affix/style", "prepareComponentToken")
  @js.native
  val prepareComponentToken: GetDefaultToken[Affix] = js.native
