...
import web.typings.antd.anon.MenuPropsSiderContextProp
...
object esMenuMenuMod extends Shortcut {
  
  @JSImport("antd/es/menu/menu", JSImport.Default)
  @js.native
  val default: ReactComponentClass[MenuPropsSiderContextProp] = js.native
  ...
  type _To = ReactComponentClass[MenuPropsSiderContextProp]
  
  /* This means you don't have to write `default`, but can instead just say `esMenuMenuMod.foo` */
  override def _to: ReactComponentClass[MenuPropsSiderContextProp] = default
}
