...
object esTimePickerMod extends Shortcut {
  ...
  trait MergedTimePicker
    extends StObject
       with ForwardRefExoticComponent[TimePickerProps with RefAttributes[Any]] {
    
    var RangePicker: ReactComponentClass[TimeRangePickerProps with RefAttributes[Any]] = js.native
  ...
  object TimePickerLocale {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: TimePickerLocale] (val x: Self) extends AnyVal {
  ...
  /* Inlined parent std.Omit<antd.antd/es/date-picker/generatePicker.PickerTimeProps<dayjs.dayjs.Dayjs>, 'picker'> */
  @js.native
  trait TimePickerProps extends StObject {
    
    var addon: js.UndefOr[js.Function0[ReactElement]] = js.native
    ...
    var onChange: js.UndefOr[js.Function2[/* value */ Dayjs | Null, /* dateString */ String, Unit]] = js.native
    ...
    var onOk: js.UndefOr[js.Function1[/* date */ Dayjs, Unit]] = js.native
    ...
    var onSelect: js.UndefOr[js.Function1[/* value */ Dayjs, Unit]] = js.native
  ...
  object TimePickerProps {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: TimePickerProps] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setAddon(value: () => ReactElement): Self = StObject.set(x, "addon", js.Any.fromFunction0(value))
      ...
      @scala.inline
      def setMonthCellRender(value: (Dayjs, /* locale */ Locale) => ReactElement): Self = StObject.set(x, "monthCellRender", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setOnChange(value: (/* value */ Dayjs | Null, /* dateString */ String) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setOnOk(value: /* date */ Dayjs => Unit): Self = StObject.set(x, "onOk", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnPanelChange(value: (Dayjs, /* mode */ PanelMode) => Unit): Self = StObject.set(x, "onPanelChange", js.Any.fromFunction2(value))
      
      @scala.inline
      def setOnPanelChangeUndefined: Self = StObject.set(x, "onPanelChange", js.undefined)
      
      @scala.inline
      def setOnSelect(value: /* value */ Dayjs => Unit): Self = StObject.set(x, "onSelect", js.Any.fromFunction1(value))
  ...
  /* Inlined parent std.Omit<antd.antd/es/date-picker/generatePicker.RangePickerTimeProps<dayjs.dayjs.Dayjs>, 'picker'> */
  @js.native
  trait TimeRangePickerProps extends StObject {
    ...
    var cellRender: js.UndefOr[CellRender[Dayjs, Dayjs | Double]] = js.native
    ...
    var dateRender: js.UndefOr[RangeDateRender[Dayjs]] = js.native
    
    var defaultOpen: js.UndefOr[Boolean] = js.native
    
    var defaultOpenValue: js.UndefOr[Dayjs] = js.native
    
    var defaultPickerValue: js.UndefOr[js.Tuple2[Dayjs, Dayjs]] = js.native
    
    var defaultValue: js.UndefOr[RangeValue[Dayjs]] = js.native
    ...
    var disabledTime: js.UndefOr[js.Function2[/* date */ EventValue[Dayjs], /* type */ RangeType, DisabledTimes]] = js.native
    ...
    var onChange: js.UndefOr[
        js.Function2[/* values */ RangeValue[Dayjs], /* formatString */ js.Tuple2[String, String], Unit]
      ] = js.native
    ...
    var onOk: js.UndefOr[js.Function1[/* dates */ RangeValue[Dayjs], Unit]] = js.native
    
    var onOpenChange: js.UndefOr[js.Function1[/* open */ Boolean, Unit]] = js.native
    
    var onPanelChange: js.UndefOr[
        js.Function2[/* values */ RangeValue[Dayjs], /* modes */ js.Tuple2[PanelMode, PanelMode], Unit]
      ] = js.native
    ...
    var presets: js.UndefOr[js.Array[PresetDate[Exclude[RangeValue[Dayjs], Null]]]] = js.native
    ...
    var value: js.UndefOr[RangeValue[Dayjs]] = js.native
  }
  object TimeRangePickerProps {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: TimeRangePickerProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCellRender(value: (Dayjs | Double, /* info */ CellRenderInfo[Dayjs]) => ReactElement): Self = StObject.set(x, "cellRender", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setDateRender(value: (Dayjs, Dayjs, /* info */ RangeInfo) => ReactElement): Self = StObject.set(x, "dateRender", js.Any.fromFunction3(value))
      ...
      @scala.inline
      def setDefaultPickerValue(value: js.Tuple2[Dayjs, Dayjs]): Self = StObject.set(x, "defaultPickerValue", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDefaultPickerValueUndefined: Self = StObject.set(x, "defaultPickerValue", js.undefined)
      
      @scala.inline
      def setDefaultValue(value: RangeValue[Dayjs]): Self = StObject.set(x, "defaultValue", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setDisabledTime(value: (/* date */ EventValue[Dayjs], /* type */ RangeType) => DisabledTimes): Self = StObject.set(x, "disabledTime", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setOnChange(value: (/* values */ RangeValue[Dayjs], /* formatString */ js.Tuple2[String, String]) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setOnOk(value: /* dates */ RangeValue[Dayjs] => Unit): Self = StObject.set(x, "onOk", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnPanelChange(value: (/* values */ RangeValue[Dayjs], /* modes */ js.Tuple2[PanelMode, PanelMode]) => Unit): Self = StObject.set(x, "onPanelChange", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setPresets(value: js.Array[PresetDate[Exclude[RangeValue[Dayjs], Null]]]): Self = StObject.set(x, "presets", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPresetsUndefined: Self = StObject.set(x, "presets", js.undefined)
      
      @scala.inline
      def setPresetsVarargs(value: (PresetDate[Exclude[RangeValue[Dayjs], Null]])*): Self = StObject.set(x, "presets", js.Array(value :_*))
      ...
      @scala.inline
      def setValue(value: RangeValue[Dayjs]): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
  ...
  /* This means you don't have to write `default`, but can instead just say `esTimePickerMod.foo` */
