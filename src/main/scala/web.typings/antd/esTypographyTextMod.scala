...
import web.typings.antd.anon.OmitEllipsisConfigexpanda
...
object esTypographyTextMod extends Shortcut {
  
  @JSImport("antd/es/typography/Text", JSImport.Default)
  @js.native
  val default: ReactComponentClass[TextProps with RefAttributes[HTMLSpanElement]] = js.native
  
  /* Inlined parent antd.antd/es/typography/Base.BlockProps<'span'> */
  /* Inlined parent std.Omit<react.react.HTMLAttributes<std.HTMLSpanElement>, 'type' | keyof antd.antd/es/typography/Base.BlockProps<'span'>> */
  @js.native
  trait TextProps extends StObject {
    ...
    var ellipsis: js.UndefOr[Boolean | OmitEllipsisConfigexpanda] = js.native
  ...
  object TextProps {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: TextProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEllipsis(value: Boolean | OmitEllipsisConfigexpanda): Self = StObject.set(x, "ellipsis", value.asInstanceOf[js.Any])
  ...
  type _To = ReactComponentClass[TextProps with RefAttributes[HTMLSpanElement]]
  
  /* This means you don't have to write `default`, but can instead just say `esTypographyTextMod.foo` */
  override def _to: ReactComponentClass[TextProps with RefAttributes[HTMLSpanElement]] = default
}
