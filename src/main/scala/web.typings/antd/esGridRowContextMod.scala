...
object esGridRowContextMod extends Shortcut {
  
  @JSImport("antd/es/grid/RowContext", JSImport.Default)
  @js.native
  ...
  object RowContextState {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: RowContextState] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `esGridRowContextMod.foo` */
