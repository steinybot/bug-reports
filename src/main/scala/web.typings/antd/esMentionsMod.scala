...
object esMentionsMod extends Shortcut {
  
  @JSImport("antd/es/mentions", JSImport.Default)
  @js.native
  val default: CompoundedComponent = js.native
  
  @JSImport("antd/es/mentions", "Option")
  @js.native
  val Option: ReactComponentClass[web.typings.rcSelect.libOptionMod.OptionProps] = js.native
  
  @js.native
  trait CompoundedComponent
    extends StObject
       with ForwardRefExoticComponent[MentionProps with RefAttributes[MentionsRef]] {
    
    var Option: ReactComponentClass[web.typings.rcSelect.libOptionMod.OptionProps] = js.native
  ...
  */
  ...
  /* Inlined parent std.Omit<rc-mentions.rc-mentions/es/Mentions.MentionsProps, 'suffix'> */
  @js.native
  trait MentionProps extends StObject {
    ...
    var onSelect: js.UndefOr[
        js.Function2[
          /* option */ web.typings.rcMentions.esOptionMod.OptionProps, 
          /* prefix */ String, 
          Unit
        ]
      ] = js.native
  ...
  object MentionProps {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: MentionProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnSelect(value: (/* option */ web.typings.rcMentions.esOptionMod.OptionProps, /* prefix */ String) => Unit): Self = StObject.set(x, "onSelect", js.Any.fromFunction2(value))
  ...
  object MentionsConfig {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: MentionsConfig] (val x: Self) extends AnyVal {
  ...
  object MentionsEntity {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: MentionsEntity] (val x: Self) extends AnyVal {
  ...
  type MentionsRef = web.typings.rcMentions.esMentionsMod.MentionsRef
  ...
  object OptionProps {
    ...
    @scala.inline
    def apply(children: ReactElement, value: String): OptionProps = {
  ...
  /* This means you don't have to write `default`, but can instead just say `esMentionsMod.foo` */
