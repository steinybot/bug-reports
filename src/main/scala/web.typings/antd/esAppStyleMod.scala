...
object esAppStyleMod {
  
  @JSImport("antd/es/app/style", JSImport.Namespace)
  @js.native
  ...
  @JSImport("antd/es/app/style", "prepareComponentToken")
  @js.native
  val prepareComponentToken: GetDefaultToken[App] = js.native
  
  type ComponentToken = js.Object
}
