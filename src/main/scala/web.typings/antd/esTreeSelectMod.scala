...
object esTreeSelectMod extends Shortcut {
  ...
  @JSImport("antd/es/tree-select", JSImport.Default)
  @js.native
  val default: CompoundedComponent = js.native
  
  /** This is a placeholder, not real render in dom */
  @JSImport("antd/es/tree-select", "TreeNode")
  @js.native
  ...
  trait InternalTreeSelectType extends StObject {
    ...
    def apply[ValueType, OptionType /* <: BaseOptionType | DefaultOptionType */](props: Children with (TreeSelectProps[ValueType, OptionType])): ReactElement = js.native
  }
  ...
  object LabeledValue {
    ...
    @scala.inline
    def apply(label: ReactElement, value: RawValue): LabeledValue = {
      val __obj = js.Dynamic.literal(label = label.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[LabeledValue]
    }
    
    @scala.inline
    implicit class MutableBuilder[Self <: LabeledValue] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setValue(value: RawValue): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
    }
  }
  ...
  /* Inlined parent std.Omit<rc-tree-select.rc-tree-select.TreeSelectProps<ValueType, OptionType>, 'showTreeIcon' | 'treeMotion' | 'mode' | 'getInputElement' | 'backfill' | 'treeLine' | 'switcherIcon'> */
  @js.native
  trait TreeSelectProps[ValueType, OptionType /* <: BaseOptionType | DefaultOptionType */]
    extends StObject
       with /* key */ StringDictionary[
          js.UndefOr[
            horizontal | vertical | Boolean | page | step | location | date | time | Double | mixed | Booleanish | none | `inline` | list_ | both | menu_ | listbox | tree_ | grid_ | dialog | off | assertive | polite | String | ascending | descending | other | additions | (`additions removals`) | (`additions text`) | all | removals | (`removals additions`) | (`removals text`) | text_ | (`text additions`) | (`text removals`) | grammar | spelling | copy | execute | link | move | popup
          ]
        ] {
    ...
    var getRawInputElement: js.UndefOr[js.Function0[web.typings.react.mod.global.JSX.Element]] = js.native
    ...
    var popupMatchSelectWidth: js.UndefOr[Boolean | Double] = js.native
    ...
    var treeData: js.UndefOr[js.Array[OptionType]] = js.native
    ...
    var treeLine: js.UndefOr[Boolean | ShowLeafIcon] = js.native
  ...
  object TreeSelectProps {
    ...
    @scala.inline
    def apply[ValueType, OptionType /* <: BaseOptionType | DefaultOptionType */](): TreeSelectProps[ValueType, OptionType] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[TreeSelectProps[ValueType, OptionType]]
    }
    
    @scala.inline
    implicit class MutableBuilder[Self <: TreeSelectProps[_, _], ValueType, OptionType /* <: BaseOptionType | DefaultOptionType */] (val x: Self with (TreeSelectProps[ValueType, OptionType])) extends AnyVal {
      ...
      @scala.inline
      def setGetRawInputElement(value: () => web.typings.react.mod.global.JSX.Element): Self = StObject.set(x, "getRawInputElement", js.Any.fromFunction0(value))
      ...
      @scala.inline
      def setPopupMatchSelectWidth(value: Boolean | Double): Self = StObject.set(x, "popupMatchSelectWidth", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTreeData(value: js.Array[OptionType]): Self = StObject.set(x, "treeData", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTreeDataVarargs(value: OptionType*): Self = StObject.set(x, "treeData", js.Array(value :_*))
      ...
      @scala.inline
      def setTreeLine(value: Boolean | ShowLeafIcon): Self = StObject.set(x, "treeLine", value.asInstanceOf[js.Any])
