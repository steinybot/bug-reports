...
object esCheckboxCheckboxMod extends Shortcut {
  ...
  trait AbstractCheckboxProps[T] extends StObject {
    ...
    var skipGroup: js.UndefOr[Boolean] = js.native
  ...
  object AbstractCheckboxProps {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: AbstractCheckboxProps[_], T] (val x: Self with AbstractCheckboxProps[T]) extends AnyVal {
      ...
      @scala.inline
      def setSkipGroup(value: Boolean): Self = StObject.set(x, "skipGroup", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSkipGroupUndefined: Self = StObject.set(x, "skipGroup", js.undefined)
  ...
  /* This means you don't have to write `default`, but can instead just say `esCheckboxCheckboxMod.foo` */
