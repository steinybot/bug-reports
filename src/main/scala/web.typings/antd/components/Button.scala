...
object Button {
  ...
  object Group {
    ...
    implicit def make(companion: Group.type): SharedBuilder_ButtonGroupProps_7728502 = new SharedBuilder_ButtonGroupProps_7728502(js.Array(this.component, js.Dictionary.empty))()
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def classNames(value: web.typings.antd.anon.Icon): this.type = set("classNames", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def styles(value: IconCSSProperties): this.type = set("styles", value.asInstanceOf[js.Any])
  ...
  type Props = ButtonProps with RefAttributes[HTMLElement]
