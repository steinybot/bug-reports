...
object Presets {
  ...
  type Props = ColorPickerToken
  
  def withProps(p: ColorPickerToken): SharedBuilder_ColorPickerToken1133449112 = new SharedBuilder_ColorPickerToken1133449112(js.Array(this.component, p.asInstanceOf[js.Any]))
}
