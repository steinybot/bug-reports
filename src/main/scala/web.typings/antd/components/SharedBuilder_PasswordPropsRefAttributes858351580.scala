...
import web.typings.antd.esInputPasswordMod.VisibilityToggle
...
@scala.inline
class SharedBuilder_PasswordPropsRefAttributes858351580[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  @scala.inline
  def iconRender(value: /* visible */ Boolean => ReactElement): this.type = set("iconRender", js.Any.fromFunction1(value))
  ...
  @scala.inline
  def visibilityToggle(value: Boolean | VisibilityToggle): this.type = set("visibilityToggle", value.asInstanceOf[js.Any])
