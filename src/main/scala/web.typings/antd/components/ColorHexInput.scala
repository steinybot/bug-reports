...
import web.typings.antd.esColorPickerComponentsColorHexInputMod.ColorHexInputProps
...
object ColorHexInput {
  ...
  def apply(prefixCls: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[ColorHexInputProps]))
  }
  ...
  type Props = ColorHexInputProps
  
  def withProps(p: ColorHexInputProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
