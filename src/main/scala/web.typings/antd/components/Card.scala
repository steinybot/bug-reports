...
import web.typings.antd.esCardCardMod.CardSize
import web.typings.antd.esCardCardMod.CardTabListType
import web.typings.antd.esCardCardMod.CardType
...
object Card {
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def size(value: CardSize): this.type = set("size", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def `type`(value: CardType): this.type = set("type", value.asInstanceOf[js.Any])
  ...
  type Props = CardProps with RefAttributes[HTMLDivElement]
  
  implicit def make(companion: Card.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CardProps with RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
