...
import web.typings.antd.esGridRowMod.ResponsiveAligns
import web.typings.antd.esGridRowMod.ResponsiveJustify
...
object Row {
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def align(value: top | middle | bottom | stretch | ResponsiveAligns): this.type = set("align", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def gutter(value: Gutter | (js.Tuple2[Gutter, Gutter])): this.type = set("gutter", value.asInstanceOf[js.Any])
    ...
    ): this.type = set("justify", value.asInstanceOf[js.Any])
  ...
  type Props = RowProps with RefAttributes[HTMLDivElement]
  
  implicit def make(companion: Row.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: RowProps with RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
