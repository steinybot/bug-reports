...
import web.typings.antd.esFloatButtonInterfaceMod.FloatButtonContentProps
...
object FloatButtonContent {
  
  @JSImport("antd/es/float-button/FloatButtonContent", JSImport.Default)
  @js.native
  ...
  type Props = FloatButtonContentProps
  
  implicit def make(companion: FloatButtonContent.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FloatButtonContentProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
