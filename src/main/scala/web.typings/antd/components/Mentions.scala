...
import web.typings.antd.esMentionsMod.MentionProps
import web.typings.antd.esMentionsMod.MentionsRef
...
object Mentions {
  ...
  class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[tag.type, MentionsRef with js.Object] {
    ...
    def filterOption(
      value: `false` | (js.Function2[
          /* input */ String, 
          /* param1 */ web.typings.rcMentions.esOptionMod.OptionProps, 
          Boolean
        ])
    ...
    def filterOptionFunction2(
      value: (/* input */ String, /* param1 */ web.typings.rcMentions.esOptionMod.OptionProps) => Boolean
    ...
    @scala.inline
    def onSelect(value: (/* option */ web.typings.rcMentions.esOptionMod.OptionProps, /* prefix */ String) => Unit): this.type = set("onSelect", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def options(value: js.Array[DataDrivenOptionProps]): this.type = set("options", value.asInstanceOf[js.Any])
    
    @scala.inline
    def optionsVarargs(value: DataDrivenOptionProps*): this.type = set("options", js.Array(value :_*))
    
    @scala.inline
    def placeholder(value: String): this.type = set("placeholder", value.asInstanceOf[js.Any])
    
    @scala.inline
    def placement(value: web.typings.rcMentions.esMentionsMod.Placement): this.type = set("placement", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def validateSearch(value: (/* text */ String, /* split */ js.UndefOr[String]) => Boolean): this.type = set("validateSearch", js.Any.fromFunction2(value))
  ...
  type Props = MentionProps with RefAttributes[MentionsRef]
  
  implicit def make(companion: Mentions.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MentionProps with RefAttributes[MentionsRef]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
