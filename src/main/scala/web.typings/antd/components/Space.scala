...
import web.typings.antd.esSpaceMod.SpaceProps
import web.typings.antd.esSpaceMod.SpaceSize
...
object Space {
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def classNames(value: web.typings.antd.anon.Item): this.type = set("classNames", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def direction(value: web.typings.antd.antdStrings.horizontal | web.typings.antd.antdStrings.vertical): this.type = set("direction", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def size(value: SpaceSize | (js.Tuple2[SpaceSize, SpaceSize])): this.type = set("size", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def styles(value: ItemCSSProperties): this.type = set("styles", value.asInstanceOf[js.Any])
  ...
  type Props = SpaceProps with RefAttributes[HTMLDivElement]
  
  implicit def make(companion: Space.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SpaceProps with RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
