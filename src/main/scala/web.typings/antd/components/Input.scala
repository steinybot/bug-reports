...
import web.typings.antd.antdStrings.`datetime-local`
...
import web.typings.antd.antdStrings.checkbox_
import web.typings.antd.antdStrings.color
...
import web.typings.antd.antdStrings.file
...
import web.typings.antd.antdStrings.hidden
import web.typings.antd.antdStrings.horizontal
import web.typings.antd.antdStrings.image_
...
import web.typings.antd.antdStrings.number
...
import web.typings.antd.antdStrings.password
...
import web.typings.antd.antdStrings.radio_
import web.typings.antd.antdStrings.range
import web.typings.antd.antdStrings.removals
import web.typings.antd.antdStrings.reset
...
import web.typings.antd.antdStrings.submit
...
import web.typings.antd.antdStrings.week
...
object Input {
  ...
  object Group {
    ...
    implicit def make(companion: Group.type): web.typings.antd.components.Input.Group.Builder = new web.typings.antd.components.Input.Group.Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: GroupProps): web.typings.antd.components.Input.Group.Builder = new web.typings.antd.components.Input.Group.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[slinky.web.html.input.tag.type, InputRef] {
    ...
    def `type`(
      value: LiteralUnion[
          button_ | checkbox_ | color | date | `datetime-local` | email | file | hidden | image_ | month | number | password | radio_ | range | reset | search | submit | tel | text_ | time | url | week, 
          String
        ]
