...
import web.typings.antd.esUtilTransButtonMod.TransButtonProps
...
object TransButton {
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def onClick(value: /* e */ js.UndefOr[SyntheticMouseEvent[HTMLDivElement]] => Unit): this.type = set("onClick", js.Any.fromFunction1(value))
  ...
  type Props = TransButtonProps with RefAttributes[HTMLDivElement]
  
  implicit def make(companion: TransButton.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TransButtonProps with RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
