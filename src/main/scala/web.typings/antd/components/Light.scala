...
import web.typings.antd.esLayoutStyleMod.LayoutToken
...
object Light {
  ...
  def apply(
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[LayoutToken]))
  }
  
  @JSImport("antd/es/layout/style/light", JSImport.Default)
  @js.native
  ...
  type Props = LayoutToken
  
  def withProps(p: LayoutToken): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
