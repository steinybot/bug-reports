...
@scala.inline
class SharedBuilder_TextPropsRefAttributes1061540711[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  @scala.inline
  def ellipsis(value: Boolean | OmitEllipsisConfigexpanda): this.type = set("ellipsis", value.asInstanceOf[js.Any])
