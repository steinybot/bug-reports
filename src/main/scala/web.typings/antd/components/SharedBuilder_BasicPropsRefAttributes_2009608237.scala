...
@scala.inline
class SharedBuilder_BasicPropsRefAttributes_2009608237[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  @scala.inline
  def suffixCls(value: String): this.type = set("suffixCls", value.asInstanceOf[js.Any])
