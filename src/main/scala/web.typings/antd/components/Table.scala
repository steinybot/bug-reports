...
import web.typings.antd.esTableInternalTableMod.TableProps
...
object Table {
  ...
  object Table {
    ...
    class Builder (val args: js.Array[Any])
      ...
      @scala.inline
      def fixed(value: Boolean | top | bottom): this.type = set("fixed", value.asInstanceOf[js.Any])
    }
    
    type Props = SummaryProps
    
    implicit def make(companion: Table.type): web.typings.antd.components.Table.Table.Builder = new web.typings.antd.components.Table.Table.Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: SummaryProps): web.typings.antd.components.Table.Table.Builder = new web.typings.antd.components.Table.Table.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  @JSImport("antd", "Table")
  @js.native
  val component: js.Object = js.native
  ...
  type Props = /* props */ PropsWithChildren[TableProps[AnyObject]] with `7`
  
  implicit def make(companion: Table.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: /* props */ PropsWithChildren[TableProps[AnyObject]] with `7`): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
