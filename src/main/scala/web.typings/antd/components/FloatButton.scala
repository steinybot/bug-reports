...
import web.typings.antd.esFloatButtonInterfaceMod.BackTopProps
...
import web.typings.antd.esFloatButtonInterfaceMod.FloatButtonProps
import web.typings.antd.esFloatButtonInterfaceMod.FloatButtonRef
...
import web.typings.antd.esFloatButtonPurePanelMod.PureFloatButtonProps
...
object FloatButton {
  ...
  object BackTop {
    ...
    @JSImport("antd", "FloatButton.BackTop")
    @js.native
    ...
    class Builder (val args: js.Array[Any])
      extends AnyVal
         with StBuildingComponent[tag.type, FloatButtonRef] {
    ...
    type Props = BackTopProps with RefAttributes[FloatButtonRef]
    
    implicit def make(companion: BackTop.type): web.typings.antd.components.FloatButton.BackTop.Builder = new web.typings.antd.components.FloatButton.BackTop.Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: BackTopProps with RefAttributes[FloatButtonRef]): web.typings.antd.components.FloatButton.BackTop.Builder = new web.typings.antd.components.FloatButton.BackTop.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  object Group {
    
    @JSImport("antd", "FloatButton.Group")
    @js.native
    val component: js.Object = js.native
    
    type Props = FloatButtonGroupProps
    
    implicit def make(companion: Group.type): SharedBuilder_FloatButtonGroupProps_399423176 = new SharedBuilder_FloatButtonGroupProps_399423176(js.Array(this.component, js.Dictionary.empty))()
  ...
  object InternalPanelDoNotUseOrYouWillBeFired {
    ...
    @JSImport("antd", "FloatButton._InternalPanelDoNotUseOrYouWillBeFired")
    @js.native
    val component: js.Object = js.native
    ...
    class Builder (val args: js.Array[Any])
      ...
      @scala.inline
      def backTop(value: Boolean): this.type = set("backTop", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def items(value: js.Array[PureFloatButtonProps]): this.type = set("items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def itemsVarargs(value: PureFloatButtonProps*): this.type = set("items", js.Array(value :_*))
    ...
    implicit def make(companion: InternalPanelDoNotUseOrYouWillBeFired.type): web.typings.antd.components.FloatButton.InternalPanelDoNotUseOrYouWillBeFired.Builder = new web.typings.antd.components.FloatButton.InternalPanelDoNotUseOrYouWillBeFired.Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: PurePanelProps): web.typings.antd.components.FloatButton.InternalPanelDoNotUseOrYouWillBeFired.Builder = new web.typings.antd.components.FloatButton.InternalPanelDoNotUseOrYouWillBeFired.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  @JSImport("antd", "FloatButton")
  @js.native
  val component: js.Object = js.native
  ...
  class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[tag.type, FloatButtonElement] {
  ...
  type Props = FloatButtonProps with RefAttributes[FloatButtonElement]
  
  implicit def make(companion: FloatButton.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FloatButtonProps with RefAttributes[FloatButtonElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
