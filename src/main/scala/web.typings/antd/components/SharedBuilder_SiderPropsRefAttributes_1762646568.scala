...
import web.typings.antd.esLayoutSiderMod.CollapseType
import web.typings.antd.esLayoutSiderMod.SiderTheme
...
@scala.inline
class SharedBuilder_SiderPropsRefAttributes_1762646568[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
