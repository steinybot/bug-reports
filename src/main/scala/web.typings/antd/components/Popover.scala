...
object Popover {
  ...
  object InternalPanelDoNotUseOrYouWillBeFired {
    ...
    @JSImport("antd", "Popover.InternalPanelDoNotUseOrYouWillBeFired")
    @js.native
    ...
    implicit def make(companion: InternalPanelDoNotUseOrYouWillBeFired.type): web.typings.antd.components.Popover.InternalPanelDoNotUseOrYouWillBeFired.Builder = new web.typings.antd.components.Popover.InternalPanelDoNotUseOrYouWillBeFired.Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: PurePanelProps): web.typings.antd.components.Popover.InternalPanelDoNotUseOrYouWillBeFired.Builder = new web.typings.antd.components.Popover.InternalPanelDoNotUseOrYouWillBeFired.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  type Props = PopoverProps with RefAttributes[Any]
  
  implicit def make(companion: Popover.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PopoverProps with RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
