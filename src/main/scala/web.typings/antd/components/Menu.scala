...
object Menu {
  ...
  class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[tag.type, MenuRef] {
    
    @scala.inline
    def _internalDisableMenuItemTitleTooltip(value: Boolean): this.type = set("_internalDisableMenuItemTitleTooltip", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def items(value: js.Array[ItemType[MenuItemType]]): this.type = set("items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def itemsVarargs(value: ItemType[MenuItemType]*): this.type = set("items", js.Array(value :_*))
  ...
  type Props = MenuPropsSiderContextProp
  
  implicit def make(companion: Menu.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MenuPropsSiderContextProp): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
