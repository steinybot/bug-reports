...
object Flex {
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def component(value: CustomComponent[AnyObject]): this.type = set("component", value.asInstanceOf[js.Any])
  ...
  type Props = FlexProps[AnyObject] with RefAttributes[HTMLElement]
  
  implicit def make(companion: Flex.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FlexProps[AnyObject] with RefAttributes[HTMLElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
