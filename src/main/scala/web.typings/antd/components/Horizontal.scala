...
object Horizontal {
  ...
  type Props = MenuToken
  
  def withProps(p: MenuToken): SharedBuilder_MenuToken_1948129327 = new SharedBuilder_MenuToken_1948129327(js.Array(this.component, p.asInstanceOf[js.Any]))
}
