...
@scala.inline
class SharedBuilder_ListItemPropsRefAttributes1479316469[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  @scala.inline
  def colStyle(value: CSSProperties): this.type = set("colStyle", value.asInstanceOf[js.Any])
