...
object InputNumber {
  ...
  object InternalPanelDoNotUseOrYouWillBeFired {
    ...
    @JSImport("antd", "InputNumber._InternalPanelDoNotUseOrYouWillBeFired")
    @js.native
    ...
    class Builder (val args: js.Array[Any])
      ...
      @scala.inline
      def classNames(value: web.typings.rcInputNumber.anon.Group): this.type = set("classNames", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def controls(value: Boolean | DownIcon): this.type = set("controls", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def formatter(
        value: (/* value */ js.UndefOr[ValueType], /* info */ web.typings.rcInputNumber.anon.Input) => String
    ...
    type Props = InputNumberProps[ValueType]
    
    implicit def make(companion: InternalPanelDoNotUseOrYouWillBeFired.type): web.typings.antd.components.InputNumber.InternalPanelDoNotUseOrYouWillBeFired.Builder = new web.typings.antd.components.InputNumber.InternalPanelDoNotUseOrYouWillBeFired.Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: InputNumberProps[ValueType]): web.typings.antd.components.InputNumber.InternalPanelDoNotUseOrYouWillBeFired.Builder = new web.typings.antd.components.InputNumber.InternalPanelDoNotUseOrYouWillBeFired.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  type Props = /* props */ `5` with InputNumberProps[ValueType]
  
  implicit def make(companion: InputNumber.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: /* props */ `5` with InputNumberProps[ValueType]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
