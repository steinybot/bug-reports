...
import web.typings.antd.esRateMod.RateProps
...
object Rate {
  ...
  class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[tag.type, RateRef] {
  ...
  def withProps(p: RateProps with RefAttributes[RateRef]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
