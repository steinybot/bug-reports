...
import web.typings.antd.esFormStyleMod.FormToken
...
object Explain {
  ...
  type Props = FormToken
  
  def withProps(p: FormToken): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
