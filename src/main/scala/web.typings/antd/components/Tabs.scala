...
object Tabs {
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def onEdit(
      value: (/* e */ SyntheticMouseEvent[org.scalajs.dom.Element] | SyntheticKeyboardEvent[org.scalajs.dom.Element] | String, /* action */ add | remove) => Unit
    ...
    @scala.inline
    def onTabClick(
      value: (/* activeKey */ String, /* e */ SyntheticKeyboardEvent[org.scalajs.dom.Element] | SyntheticMouseEvent[org.scalajs.dom.Element]) => Unit
