...
import web.typings.antd.esCascaderStyleMod.CascaderToken
...
object Columns {
  ...
  def apply(
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[CascaderToken]))
  }
  
  @JSImport("antd/es/cascader/style/columns", JSImport.Default)
  @js.native
  ...
  type Props = CascaderToken
  
  def withProps(p: CascaderToken): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
