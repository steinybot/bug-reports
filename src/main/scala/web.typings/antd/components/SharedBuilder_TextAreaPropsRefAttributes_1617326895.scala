...
@scala.inline
class SharedBuilder_TextAreaPropsRefAttributes_1617326895[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  @scala.inline
  def value(value: String | js.Array[String] | Double | js.BigInt): this.type = set("value", value.asInstanceOf[js.Any])
