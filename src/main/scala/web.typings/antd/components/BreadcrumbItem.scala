...
object BreadcrumbItem {
  ...
  implicit def make(companion: BreadcrumbItem.type): SharedBuilder_BreadcrumbItemProps21342310 = new SharedBuilder_BreadcrumbItemProps21342310(js.Array(this.component, js.Dictionary.empty))()
