...
import web.typings.antd.esGridColMod.ColSize
import web.typings.antd.esGridColMod.ColSpanType
import web.typings.antd.esGridColMod.FlexType
...
object Col {
  ...
  type Props = ColProps with RefAttributes[HTMLDivElement]
