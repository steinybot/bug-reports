...
object Select {
  ...
  object OptGroup {
    ...
    @scala.inline
    def apply(label: ReactElement): web.typings.antd.components.Select.OptGroup.Builder = {
      val __props = js.Dynamic.literal(label = label.asInstanceOf[js.Any])
      new web.typings.antd.components.Select.OptGroup.Builder(js.Array(this.component, __props.asInstanceOf[OptGroupProps]))
    }
    ...
    def withProps(p: OptGroupProps): web.typings.antd.components.Select.OptGroup.Builder = new web.typings.antd.components.Select.OptGroup.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[slinky.web.html.div.tag.type, BaseSelectRef] {
  ...
  def withProps(p: /* props */ Children with (SelectProps[Any, DefaultOptionType])): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
