...
import web.typings.antd.anon.OmitMenuItemComponent
...
object esMenuMenuItemMod extends Shortcut {
  
  @JSImport("antd/es/menu/MenuItem", JSImport.Default)
  @js.native
  val default: GenericComponent = js.native
  
  type GenericComponent = OmitMenuItemComponent with (js.Function2[
    /* props */ GenericProps[MenuItemProps], 
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    * TS definition: {{{
    T extends infer U ? unknown extends U ? antd.antd/es/menu/MenuItem.MenuItemProps : U : antd.antd/es/menu/MenuItem.MenuItemProps
    }}}
    */
  type GenericProps[T] = MenuItemProps
  
  type MenuItemComponent = ReactComponentClass[MenuItemProps]
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  @js.native
  trait RestArgs[T] extends StObject
  
  type _To = GenericComponent
  
  /* This means you don't have to write `default`, but can instead just say `esMenuMenuItemMod.foo` */
