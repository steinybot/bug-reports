...
object esTypographyParagraphMod extends Shortcut {
  
  @JSImport("antd/es/typography/Paragraph", JSImport.Default)
  @js.native
  val default: ReactComponentClass[ParagraphProps with RefAttributes[HTMLElement]] = js.native
  
  /* Inlined parent antd.antd/es/typography/Base.BlockProps<'div'> */
  /* Inlined parent std.Omit<react.react.HTMLAttributes<std.HTMLDivElement>, 'type' | keyof antd.antd/es/typography/Base.BlockProps<'div'>> */
  @js.native
  ...
  object ParagraphProps {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: ParagraphProps] (val x: Self) extends AnyVal {
  ...
  type _To = ReactComponentClass[ParagraphProps with RefAttributes[HTMLElement]]
  
  /* This means you don't have to write `default`, but can instead just say `esTypographyParagraphMod.foo` */
  override def _to: ReactComponentClass[ParagraphProps with RefAttributes[HTMLElement]] = default
}
