...
object esCardMetaMod extends Shortcut {
  ...
  object CardMetaProps {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: CardMetaProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `esCardMetaMod.foo` */
