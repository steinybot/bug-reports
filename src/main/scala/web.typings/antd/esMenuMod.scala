...
import web.typings.antd.anon.PartialGenericComponentPr
import web.typings.antd.anon.WeakValidationMapGenericC
...
import web.typings.antd.esMenuMenuDividerMod.MenuDividerProps
...
object esMenuMod extends Shortcut {
  ...
  @JSImport("antd/es/menu", JSImport.Default)
  @js.native
  val default: GenericComponent = js.native
  
  @js.native
  trait ComponentProps
    extends StObject
       with MenuProps
       with RefAttributes[MenuRef]
  ...
  trait CompoundedComponent
    extends StObject
       with ForwardRefExoticComponent[GenericComponentProps[Any]] {
    
    var Divider: ReactComponentClass[MenuDividerProps] = js.native
    
    var Item: web.typings.antd.esMenuMenuItemMod.GenericComponent = js.native
    
    var ItemGroup: js.Function1[/* param0 */ MenuItemGroupProps, ReactElement] = js.native
    
    var SubMenu: ReactComponentClass[SubMenuProps] = js.native
  }
  
  /* Inlined parent std.Omit<antd.antd/es/menu.CompoundedComponent, ''> */
  @js.native
  trait GenericComponent extends StObject {
    
    def apply[T /* <: MenuItemType */](props: GenericComponentProps[T]): ReturnType[CompoundedComponent] = js.native
    ...
    var defaultProps: js.UndefOr[PartialGenericComponentPr] = js.native
    
    var displayName: js.UndefOr[String] = js.native
    
    var propTypes: js.UndefOr[WeakValidationMapGenericC] = js.native
  }
  
  /* Inlined std.Omit<antd.antd/es/menu.ComponentProps, 'items'> & {  items :std.Array<antd.antd/es/menu.GenericItemType<T>> | undefined} */
  @js.native
  trait GenericComponentProps[T] extends StObject {
    ...
    var items: js.UndefOr[js.Array[GenericItemType[T]]] = js.native
    ...
    var ref: js.UndefOr[Ref[MenuRef]] = js.native
  ...
  object GenericComponentProps {
    
    @scala.inline
    def apply[T](): GenericComponentProps[T] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[GenericComponentProps[T]]
    }
    
    @scala.inline
    implicit class MutableBuilder[Self <: GenericComponentProps[_], T] (val x: Self with GenericComponentProps[T]) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: js.Array[GenericItemType[T]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
      
      @scala.inline
      def setItemsVarargs(value: GenericItemType[T]*): Self = StObject.set(x, "items", js.Array(value :_*))
      ...
      @scala.inline
      def setRef(value: Ref[MenuRef]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRefFunction1(value: /* instance */ MenuRef | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    * TS definition: {{{
    T extends infer U ? unknown extends U ? antd.antd/es/menu/hooks/useItems.ItemType<antd.antd/es/menu/hooks/useItems.MenuItemType> : antd.antd/es/menu/hooks/useItems.ItemType<U> : antd.antd/es/menu/hooks/useItems.ItemType<antd.antd/es/menu/hooks/useItems.MenuItemType>
    }}}
    */
  type GenericItemType[T] = ItemType[MenuItemType]
  ...
  trait MenuRef extends StObject {
    ...
    var menu: web.typings.rcMenu.esInterfaceMod.MenuRef | Null = js.native
  }
  
  type _To = GenericComponent
  
  /* This means you don't have to write `default`, but can instead just say `esMenuMod.foo` */
  override def _to: GenericComponent = default
}
