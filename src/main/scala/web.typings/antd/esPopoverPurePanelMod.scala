...
import web.typings.antd.esPopoverMod.PopoverProps
...
object esPopoverPurePanelMod {
  
  @JSImport("antd/es/popover/PurePanel", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("antd/es/popover/PurePanel", JSImport.Default)
  @js.native
  val default: ReactComponentClass[PurePanelProps] = js.native
  
  @JSImport("antd/es/popover/PurePanel", "RawPurePanel")
  @js.native
  val RawPurePanel: ReactComponentClass[RawPurePanelProps] = js.native
  
  @scala.inline
  def getOverlay(prefixCls: String): js.UndefOr[Element] = ^.asInstanceOf[js.Dynamic].applyDynamic("getOverlay")(prefixCls.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[Element]]
  @scala.inline
  def getOverlay(prefixCls: String, title: js.UndefOr[ReactElement | RenderFunction]): js.UndefOr[Element] = (^.asInstanceOf[js.Dynamic].applyDynamic("getOverlay")(prefixCls.asInstanceOf[js.Any], title.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[Element]]
  @scala.inline
  def getOverlay(
    prefixCls: String,
    title: js.UndefOr[ReactElement | RenderFunction],
    content: js.UndefOr[ReactElement | RenderFunction]
  ): js.UndefOr[Element] = (^.asInstanceOf[js.Dynamic].applyDynamic("getOverlay")(prefixCls.asInstanceOf[js.Any], title.asInstanceOf[js.Any], content.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[Element]]
  @scala.inline
  def getOverlay(prefixCls: String, title: Unit, content: js.UndefOr[ReactElement | RenderFunction]): js.UndefOr[Element] = (^.asInstanceOf[js.Dynamic].applyDynamic("getOverlay")(prefixCls.asInstanceOf[js.Any], title.asInstanceOf[js.Any], content.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[Element]]
  
  /* Inlined parent std.Omit<antd.antd/es/popover.PopoverProps, 'children'> */
  @js.native
  ...
  @js.native
  trait RawPurePanelProps
    extends StObject
       with PopoverProps {
    
    var hashId: String = js.native
  }
  object RawPurePanelProps {
    
    @scala.inline
    def apply(hashId: String): RawPurePanelProps = {
      val __obj = js.Dynamic.literal(hashId = hashId.asInstanceOf[js.Any])
      __obj.asInstanceOf[RawPurePanelProps]
    }
    
    @scala.inline
    implicit class MutableBuilder[Self <: RawPurePanelProps] (val x: Self) extends AnyVal {
