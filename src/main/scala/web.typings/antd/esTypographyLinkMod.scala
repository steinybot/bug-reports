...
object esTypographyLinkMod extends Shortcut {
  
  @JSImport("antd/es/typography/Link", JSImport.Default)
  @js.native
  val default: ReactComponentClass[LinkProps with RefAttributes[HTMLElement]] = js.native
  
  /* Inlined parent antd.antd/es/typography/Base.BlockProps<'a'> */
  /* Inlined parent std.Omit<react.react.AnchorHTMLAttributes<std.HTMLAnchorElement>, 'type' | keyof antd.antd/es/typography/Base.BlockProps<'a'>> */
  @js.native
  ...
  object LinkProps {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: LinkProps] (val x: Self) extends AnyVal {
  ...
  type _To = ReactComponentClass[LinkProps with RefAttributes[HTMLElement]]
  
  /* This means you don't have to write `default`, but can instead just say `esTypographyLinkMod.foo` */
  override def _to: ReactComponentClass[LinkProps with RefAttributes[HTMLElement]] = default
}
