...
import web.typings.antd.anon.OptGroup
import web.typings.antd.antdStrings.SECRET_COMBOBOX_MODE_DO_NOT_USE
...
import web.typings.antd.antdStrings.combobox
...
import web.typings.antd.antdStrings.multiple
...
import web.typings.antd.antdStrings.tags
...
object esSelectMod extends Shortcut {
  ...
  /* Inlined parent std.Omit<rc-select.rc-select.SelectProps<ValueType, OptionType>, 'mode'> */
  @js.native
  trait InternalSelectProps[ValueType, OptionType /* <: BaseOptionType | DefaultOptionType */] extends StObject {
    ...
    var mode: js.UndefOr[multiple | tags | SECRET_COMBOBOX_MODE_DO_NOT_USE | combobox] = js.native
  ...
  object InternalSelectProps {
    ...
    @scala.inline
    def apply[ValueType, OptionType /* <: BaseOptionType | DefaultOptionType */](): InternalSelectProps[ValueType, OptionType] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[InternalSelectProps[ValueType, OptionType]]
    }
    
    @scala.inline
    implicit class MutableBuilder[Self <: InternalSelectProps[_, _], ValueType, OptionType /* <: BaseOptionType | DefaultOptionType */] (val x: Self with (InternalSelectProps[ValueType, OptionType])) extends AnyVal {
      ...
      @scala.inline
      def setMode(value: multiple | tags | SECRET_COMBOBOX_MODE_DO_NOT_USE | combobox): Self = StObject.set(x, "mode", value.asInstanceOf[js.Any])
  ...
  /* Inlined parent std.Omit<antd.antd/es/select.InternalSelectProps<ValueType, OptionType>, 'mode' | 'getInputElement' | 'getRawInputElement' | 'backfill' | 'placement'> */
  @js.native
  trait SelectProps[ValueType, OptionType /* <: BaseOptionType | DefaultOptionType */] extends StObject {
  ...
  object SelectProps {
    ...
    @scala.inline
    def apply[ValueType, OptionType /* <: BaseOptionType | DefaultOptionType */](): SelectProps[ValueType, OptionType] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[SelectProps[ValueType, OptionType]]
    }
    
    @scala.inline
    implicit class MutableBuilder[Self <: SelectProps[_, _], ValueType, OptionType /* <: BaseOptionType | DefaultOptionType */] (val x: Self with (SelectProps[ValueType, OptionType])) extends AnyVal {
      ...
      @scala.inline
      def setMode(value: multiple | tags): Self = StObject.set(x, "mode", value.asInstanceOf[js.Any])
  ...
  type SelectValue = js.UndefOr[RawValue | (js.Array[LabeledValue | RawValue]) | LabeledValue]
  
  type _To = (js.Function1[/* props */ Children with (SelectProps[Any, DefaultOptionType]), ReactElement]) with OptGroup
  
  /* This means you don't have to write `default`, but can instead just say `esSelectMod.foo` */
