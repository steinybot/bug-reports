...
import web.typings.antd.anon.OnClick
...
object esTourInterfaceMod {
  
  @js.native
  trait TourLocale extends StObject {
  ...
  object TourLocale {
    ...
    @scala.inline
    def apply(Finish: String, Next: String, Previous: String): TourLocale = {
      val __obj = js.Dynamic.literal(Finish = Finish.asInstanceOf[js.Any], Next = Next.asInstanceOf[js.Any], Previous = Previous.asInstanceOf[js.Any])
      __obj.asInstanceOf[TourLocale]
    }
    
    @scala.inline
    implicit class MutableBuilder[Self <: TourLocale] (val x: Self) extends AnyVal {
  ...
  /* Inlined parent std.Omit<@rc-component/tour.@rc-component/tour.TourProps, 'renderPanel'> */
  @js.native
  trait TourProps extends StObject {
    ...
    var onClose: js.UndefOr[js.Function1[/* current */ Double, Unit]] = js.native
  ...
  object TourProps {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: TourProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnClose(value: /* current */ Double => Unit): Self = StObject.set(x, "onClose", js.Any.fromFunction1(value))
  ...
  trait TourStepProps
    extends StObject
       with web.typings.rcComponentTour.esTourStepMod.TourStepProps {
    
    var cover: js.UndefOr[ReactElement] = js.native
    
    var indicatorsRender: js.UndefOr[js.Function2[/* current */ Double, /* total */ Double, ReactElement]] = js.native
    
    var nextButtonProps: js.UndefOr[OnClick] = js.native
    
    var prevButtonProps: js.UndefOr[OnClick] = js.native
  ...
  object TourStepProps {
    ...
    implicit class MutableBuilder[Self <: TourStepProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setNextButtonProps(value: OnClick): Self = StObject.set(x, "nextButtonProps", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNextButtonPropsUndefined: Self = StObject.set(x, "nextButtonProps", js.undefined)
      
      @scala.inline
      def setPrevButtonProps(value: OnClick): Self = StObject.set(x, "prevButtonProps", value.asInstanceOf[js.Any])
