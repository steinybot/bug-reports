...
object esFloatButtonStyleMod {
  
  @JSImport("antd/es/float-button/style", JSImport.Namespace)
  @js.native
  ...
  @JSImport("antd/es/float-button/style", "prepareComponentToken")
  @js.native
  val prepareComponentToken: GetDefaultToken[FloatButton] = js.native
