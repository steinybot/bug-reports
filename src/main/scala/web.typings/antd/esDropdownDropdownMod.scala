...
object esDropdownDropdownMod extends Shortcut {
  ...
  trait CompoundedComponent
    ...
    var _InternalPanelDoNotUseOrYouWillBeFired: ReactComponentClass[DropdownProps] = js.native
  }
  ...
  object DropdownArrowOptions {
    ...
    @scala.inline
    def apply(): DropdownArrowOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[DropdownArrowOptions]
    }
    
    @scala.inline
    implicit class MutableBuilder[Self <: DropdownArrowOptions] (val x: Self) extends AnyVal {
  ...
  object DropdownProps {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: DropdownProps] (val x: Self) extends AnyVal {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - `web.typings`.antd.antdStrings.topCenter
    - `web.typings`.antd.antdStrings.topRight
    - `web.typings`.antd.antdStrings.bottomLeft
    - `web.typings`.antd.antdStrings.bottomCenter
  ...
  */
  ...
  /* This means you don't have to write `default`, but can instead just say `esDropdownDropdownMod.foo` */
