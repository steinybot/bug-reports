...
object esColorPickerStylePresetsMod extends Shortcut {
  
  @JSImport("antd/es/color-picker/style/presets", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `esColorPickerStylePresetsMod.foo` */
