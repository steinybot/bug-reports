...
object esFloatButtonPurePanelMod extends Shortcut {
  
  /** @private Internal Component. Do not use in your production. */
  @JSImport("antd/es/float-button/PurePanel", JSImport.Default)
  @js.native
  ...
  @js.native
  trait PureFloatButtonProps extends StObject {
    
    var `aria-label`: js.UndefOr[String] = js.native
    
    var backTop: js.UndefOr[Boolean] = js.native
  ...
  object PureFloatButtonProps {
    
    @scala.inline
    def apply(): PureFloatButtonProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[PureFloatButtonProps]
    }
    
    @scala.inline
    implicit class MutableBuilder[Self <: PureFloatButtonProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setBackTop(value: Boolean): Self = StObject.set(x, "backTop", value.asInstanceOf[js.Any])
  ...
  /* Inlined parent antd.antd/es/float-button/PurePanel.PureFloatButtonProps */
  /* Inlined parent std.Omit<antd.antd/es/float-button/interface.FloatButtonGroupProps, 'children'> */
  @js.native
  trait PurePanelProps extends StObject {
    ...
    var items: js.UndefOr[js.Array[PureFloatButtonProps]] = js.native
  ...
  object PurePanelProps {
    ...
    implicit class MutableBuilder[Self <: PurePanelProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: js.Array[PureFloatButtonProps]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
      
      @scala.inline
      def setItemsVarargs(value: PureFloatButtonProps*): Self = StObject.set(x, "items", js.Array(value :_*))
  ...
  /* This means you don't have to write `default`, but can instead just say `esFloatButtonPurePanelMod.foo` */
