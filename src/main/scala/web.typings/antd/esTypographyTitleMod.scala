...
object esTypographyTitleMod extends Shortcut {
  
  @JSImport("antd/es/typography/Title", JSImport.Default)
  @js.native
  val default: ReactComponentClass[TitleProps with RefAttributes[HTMLElement]] = js.native
  
  /* Inlined parent std.Omit<antd.antd/es/typography/Base.BlockProps<'h1' | 'h2' | 'h3' | 'h4' | 'h5'>, 'strong'> */
  /* Inlined parent std.Omit<react.react.HTMLAttributes<std.HTMLHeadElement>, 'type' | keyof antd.antd/es/typography/Base.BlockProps<'h1' | 'h2' | 'h3' | 'h4' | 'h5'>> */
  @js.native
  ...
  type _To = ReactComponentClass[TitleProps with RefAttributes[HTMLElement]]
  
  /* This means you don't have to write `default`, but can instead just say `esTypographyTitleMod.foo` */
  override def _to: ReactComponentClass[TitleProps with RefAttributes[HTMLElement]] = default
}
