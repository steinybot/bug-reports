...
import web.typings.antd.anon.DisplayNameInternalPanelDoNotUseOrYouWillBeFired
import web.typings.antd.anon.DownIcon
import web.typings.antd.anon.`5`
...
object esInputNumberMod extends Shortcut {
  ...
  @js.native
  val default: (js.Function1[/* props */ `5` with InputNumberProps[ValueType], ReactElement]) with DisplayNameInternalPanelDoNotUseOrYouWillBeFired = js.native
  ...
  trait InputNumberProps[T /* <: ValueType */] extends StObject {
    ...
    var controls: js.UndefOr[Boolean | DownIcon] = js.native
  ...
  object InputNumberProps {
    ...
    implicit class MutableBuilder[Self <: InputNumberProps[_], T /* <: ValueType */] (val x: Self with InputNumberProps[T]) extends AnyVal {
      ...
      @scala.inline
      def setControls(value: Boolean | DownIcon): Self = StObject.set(x, "controls", value.asInstanceOf[js.Any])
  ...
  type _To = (js.Function1[/* props */ `5` with InputNumberProps[ValueType], ReactElement]) with DisplayNameInternalPanelDoNotUseOrYouWillBeFired
  
  /* This means you don't have to write `default`, but can instead just say `esInputNumberMod.foo` */
  override def _to: (js.Function1[/* props */ `5` with InputNumberProps[ValueType], ReactElement]) with DisplayNameInternalPanelDoNotUseOrYouWillBeFired = default
}
