...
import web.typings.antd.anon.AutoClearSearchValue
import web.typings.antd.anon.InternalPanelDoNotUseOrYouWillBeFired
...
import web.typings.rcCascader.esCascaderMod.OnMultipleChange
import web.typings.rcCascader.esCascaderMod.OnSingleChange
...
object esCascaderMod extends Shortcut {
  ...
  val default: (js.Function1[
    ...
    ReactElement
  ]) with InternalPanelDoNotUseOrYouWillBeFired = js.native
  
  type CascaderProps[DataNodeType /* <: BaseOptionType */] = UnionCascaderProps[DataNodeType] with AutoClearSearchValue[DataNodeType]
  ...
  /* Inlined std.Required<antd.antd/es/cascader.FieldNamesType> */
  @js.native
  ...
  object FilledFieldNamesType {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: FilledFieldNamesType] (val x: Self) extends AnyVal {
  ...
  /* Inlined std.Omit<rc-cascader.rc-cascader.MultipleCascaderProps<OptionType>, 'checkable' | 'options'> & {  multiple :true} */
  @js.native
  trait MultipleCascaderProps[OptionType /* <: BaseOptionType */]
    extends StObject
       with UnionCascaderProps[OptionType] {
  ...
  object MultipleCascaderProps {
    ...
    @scala.inline
    def apply[OptionType /* <: BaseOptionType */](): MultipleCascaderProps[OptionType] = {
  ...
  /* Inlined std.Omit<rc-cascader.rc-cascader.SingleCascaderProps<OptionType>, 'checkable' | 'options'> & {  multiple :false | undefined} */
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - `web.typings`.antd.esCascaderMod.SingleCascaderProps[OptionType]
    - `web.typings`.antd.esCascaderMod.MultipleCascaderProps[OptionType]
  */
  trait UnionCascaderProps[OptionType /* <: BaseOptionType */] extends StObject
  object UnionCascaderProps {
    
    @scala.inline
    def MultipleCascaderProps[OptionType /* <: BaseOptionType */](): web.typings.antd.esCascaderMod.MultipleCascaderProps[OptionType] = {
      val __obj = js.Dynamic.literal(multiple = true)
      __obj.asInstanceOf[web.typings.antd.esCascaderMod.MultipleCascaderProps[OptionType]]
    }
    
    @scala.inline
    def SingleCascaderProps[OptionType /* <: BaseOptionType */](): web.typings.antd.esCascaderMod.SingleCascaderProps[OptionType] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[web.typings.antd.esCascaderMod.SingleCascaderProps[OptionType]]
    }
  }
