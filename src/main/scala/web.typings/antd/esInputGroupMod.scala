...
object esInputGroupMod extends Shortcut {
  
  @JSImport("antd/es/input/Group", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `esInputGroupMod.foo` */
