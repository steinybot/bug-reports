...
object esInputInputMod {
  
  @JSImport("antd/es/input/Input", JSImport.Namespace)
  @js.native
  ...
  /* Inlined parent std.Omit<rc-input.rc-input.InputProps, 'wrapperClassName' | 'groupClassName' | 'inputClassName' | 'affixWrapperClassName' | 'classes'> */
  @js.native
  trait InputProps
    extends StObject
