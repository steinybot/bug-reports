...
import web.typings.antd.esTableInterfaceMod.CompareFn
import web.typings.antd.esTableInterfaceMod.FilterDropdownProps
...
object esTableColumnGroupMod {
  
  @JSImport("antd/es/table/ColumnGroup", JSImport.Namespace)
  @js.native
  ...
  /* Inlined parent std.Omit<antd.antd/es/table/interface.ColumnType<RecordType>, 'children'> */
  @js.native
  ...
  object ColumnGroupProps {
    ...
    implicit class MutableBuilder[Self <: ColumnGroupProps[_], RecordType] (val x: Self with ColumnGroupProps[RecordType]) extends AnyVal {
      ...
      @scala.inline
      def setDefaultFilteredValueVarargs(value: (web.typings.antd.esTableInterfaceMod.Key | Boolean)*): Self = StObject.set(x, "defaultFilteredValue", js.Array(value :_*))
      ...
      @scala.inline
      def setFilteredValueVarargs(value: (web.typings.antd.esTableInterfaceMod.Key | Boolean)*): Self = StObject.set(x, "filteredValue", js.Array(value :_*))
