...
object esColorPickerStylePickerMod extends Shortcut {
  
  @JSImport("antd/es/color-picker/style/picker", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `esColorPickerStylePickerMod.foo` */
