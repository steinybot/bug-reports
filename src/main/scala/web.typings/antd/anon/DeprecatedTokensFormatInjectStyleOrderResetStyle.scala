...
@js.native
trait DeprecatedTokensFormatInjectStyleOrderResetStyle extends StObject {
  ...
  var deprecatedTokens: js.UndefOr[js.Array[js.Tuple2[ComponentTokenKey[Drawer], ComponentTokenKey[Drawer]]]] = js.native
  
  var format: js.UndefOr[FormatComponentToken[Drawer]] = js.native
...
object DeprecatedTokensFormatInjectStyleOrderResetStyle {
  
  @scala.inline
  def apply(): DeprecatedTokensFormatInjectStyleOrderResetStyle = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DeprecatedTokensFormatInjectStyleOrderResetStyle]
  }
  
  @scala.inline
  implicit class MutableBuilder[Self <: DeprecatedTokensFormatInjectStyleOrderResetStyle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeprecatedTokens(value: js.Array[js.Tuple2[ComponentTokenKey[Drawer], ComponentTokenKey[Drawer]]]): Self = StObject.set(x, "deprecatedTokens", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDeprecatedTokensUndefined: Self = StObject.set(x, "deprecatedTokens", js.undefined)
    
    @scala.inline
    def setDeprecatedTokensVarargs(value: (js.Tuple2[ComponentTokenKey[Drawer], ComponentTokenKey[Drawer]])*): Self = StObject.set(x, "deprecatedTokens", js.Array(value :_*))
