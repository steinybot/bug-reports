...
@js.native
trait ClientOnlyDeprecatedTokensFormatInjectStyleOrder extends StObject {
  ...
  var deprecatedTokens: js.UndefOr[js.Array[js.Tuple2[ComponentTokenKey[Divider], ComponentTokenKey[Divider]]]] = js.native
  
  var format: js.UndefOr[FormatComponentToken[Divider]] = js.native
...
object ClientOnlyDeprecatedTokensFormatInjectStyleOrder {
  
  @scala.inline
  def apply(): ClientOnlyDeprecatedTokensFormatInjectStyleOrder = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ClientOnlyDeprecatedTokensFormatInjectStyleOrder]
  }
  
  @scala.inline
  implicit class MutableBuilder[Self <: ClientOnlyDeprecatedTokensFormatInjectStyleOrder] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeprecatedTokens(value: js.Array[js.Tuple2[ComponentTokenKey[Divider], ComponentTokenKey[Divider]]]): Self = StObject.set(x, "deprecatedTokens", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDeprecatedTokensUndefined: Self = StObject.set(x, "deprecatedTokens", js.undefined)
    
    @scala.inline
    def setDeprecatedTokensVarargs(value: (js.Tuple2[ComponentTokenKey[Divider], ComponentTokenKey[Divider]])*): Self = StObject.set(x, "deprecatedTokens", js.Array(value :_*))
