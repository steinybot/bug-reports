...
trait `40` extends StObject {
  ...
  var deprecatedTokens: js.UndefOr[js.Array[js.Tuple2[ComponentTokenKey[Tabs], ComponentTokenKey[Tabs]]]] = js.native
...
object `40` {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: `40`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeprecatedTokens(value: js.Array[js.Tuple2[ComponentTokenKey[Tabs], ComponentTokenKey[Tabs]]]): Self = StObject.set(x, "deprecatedTokens", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDeprecatedTokensUndefined: Self = StObject.set(x, "deprecatedTokens", js.undefined)
    
    @scala.inline
    def setDeprecatedTokensVarargs(value: (js.Tuple2[ComponentTokenKey[Tabs], ComponentTokenKey[Tabs]])*): Self = StObject.set(x, "deprecatedTokens", js.Array(value :_*))
