...
/* Inlined {  override :std.Partial<antd.antd/es/theme/interface.AliasToken>} & antd.antd/es/theme/context.ComponentsToken */
@js.native
trait overridePartialAliasToken extends StObject {
...
object overridePartialAliasToken {
  
  @scala.inline
  def apply(`override`: Partial[AliasToken]): overridePartialAliasToken = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("override")(`override`.asInstanceOf[js.Any])
    __obj.asInstanceOf[overridePartialAliasToken]
  }
  
  @scala.inline
  implicit class MutableBuilder[Self <: overridePartialAliasToken] (val x: Self) extends AnyVal {
