...
@js.native
trait OrderResetStyle extends StObject {
  ...
  var deprecatedTokens: js.UndefOr[js.Array[js.Tuple2[ComponentTokenKey[Card], ComponentTokenKey[Card]]]] = js.native
...
object OrderResetStyle {
  
  @scala.inline
  def apply(): OrderResetStyle = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OrderResetStyle]
  }
  
  @scala.inline
  implicit class MutableBuilder[Self <: OrderResetStyle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeprecatedTokens(value: js.Array[js.Tuple2[ComponentTokenKey[Card], ComponentTokenKey[Card]]]): Self = StObject.set(x, "deprecatedTokens", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDeprecatedTokensUndefined: Self = StObject.set(x, "deprecatedTokens", js.undefined)
    
    @scala.inline
    def setDeprecatedTokensVarargs(value: (js.Tuple2[ComponentTokenKey[Card], ComponentTokenKey[Card]])*): Self = StObject.set(x, "deprecatedTokens", js.Array(value :_*))
