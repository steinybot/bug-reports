...
@js.native
trait DeprecatedTokens extends StObject {
  ...
  var deprecatedTokens: js.UndefOr[js.Array[js.Tuple2[ComponentTokenKey[Alert], ComponentTokenKey[Alert]]]] = js.native
...
object DeprecatedTokens {
  
  @scala.inline
  def apply(): DeprecatedTokens = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DeprecatedTokens]
  }
  
  @scala.inline
  implicit class MutableBuilder[Self <: DeprecatedTokens] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeprecatedTokens(value: js.Array[js.Tuple2[ComponentTokenKey[Alert], ComponentTokenKey[Alert]]]): Self = StObject.set(x, "deprecatedTokens", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDeprecatedTokensUndefined: Self = StObject.set(x, "deprecatedTokens", js.undefined)
    
    @scala.inline
    def setDeprecatedTokensVarargs(value: (js.Tuple2[ComponentTokenKey[Alert], ComponentTokenKey[Alert]])*): Self = StObject.set(x, "deprecatedTokens", js.Array(value :_*))
