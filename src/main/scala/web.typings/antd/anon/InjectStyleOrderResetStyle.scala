...
@js.native
trait InjectStyleOrderResetStyle extends StObject {
  ...
  var deprecatedTokens: js.UndefOr[
    js.Array[js.Tuple2[ComponentTokenKey[ColorPicker], ComponentTokenKey[ColorPicker]]]
  ] = js.native
...
object InjectStyleOrderResetStyle {
  
  @scala.inline
  def apply(): InjectStyleOrderResetStyle = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[InjectStyleOrderResetStyle]
  }
  
  @scala.inline
  implicit class MutableBuilder[Self <: InjectStyleOrderResetStyle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeprecatedTokens(value: js.Array[js.Tuple2[ComponentTokenKey[ColorPicker], ComponentTokenKey[ColorPicker]]]): Self = StObject.set(x, "deprecatedTokens", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDeprecatedTokensUndefined: Self = StObject.set(x, "deprecatedTokens", js.undefined)
    
    @scala.inline
    def setDeprecatedTokensVarargs(value: (js.Tuple2[ComponentTokenKey[ColorPicker], ComponentTokenKey[ColorPicker]])*): Self = StObject.set(x, "deprecatedTokens", js.Array(value :_*))
