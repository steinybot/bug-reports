...
object Compare {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: Compare[_], RecordType] (val x: Self with Compare[RecordType]) extends AnyVal {
    
    @scala.inline
    def setCompare(
      value: (RecordType, RecordType, /* sortOrder */ js.UndefOr[web.typings.antd.esTableInterfaceMod.SortOrder]) => Double
    ): Self = StObject.set(x, "compare", js.Any.fromFunction3(value))
