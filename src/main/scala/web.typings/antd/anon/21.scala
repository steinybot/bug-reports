...
trait `21` extends StObject {
  ...
  var deprecatedTokens: js.UndefOr[
    js.Array[js.Tuple2[ComponentTokenKey[Pagination], ComponentTokenKey[Pagination]]]
  ] = js.native
...
object `21` {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: `21`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeprecatedTokens(value: js.Array[js.Tuple2[ComponentTokenKey[Pagination], ComponentTokenKey[Pagination]]]): Self = StObject.set(x, "deprecatedTokens", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDeprecatedTokensUndefined: Self = StObject.set(x, "deprecatedTokens", js.undefined)
    
    @scala.inline
    def setDeprecatedTokensVarargs(value: (js.Tuple2[ComponentTokenKey[Pagination], ComponentTokenKey[Pagination]])*): Self = StObject.set(x, "deprecatedTokens", js.Array(value :_*))
