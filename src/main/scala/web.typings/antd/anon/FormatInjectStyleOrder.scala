...
@js.native
trait FormatInjectStyleOrder extends StObject {
  ...
  var deprecatedTokens: js.UndefOr[js.Array[js.Tuple2[ComponentTokenKey[Checkbox], ComponentTokenKey[Checkbox]]]] = js.native
...
object FormatInjectStyleOrder {
  
  @scala.inline
  def apply(): FormatInjectStyleOrder = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[FormatInjectStyleOrder]
  }
  
  @scala.inline
  implicit class MutableBuilder[Self <: FormatInjectStyleOrder] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeprecatedTokens(value: js.Array[js.Tuple2[ComponentTokenKey[Checkbox], ComponentTokenKey[Checkbox]]]): Self = StObject.set(x, "deprecatedTokens", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDeprecatedTokensUndefined: Self = StObject.set(x, "deprecatedTokens", js.undefined)
    
    @scala.inline
    def setDeprecatedTokensVarargs(value: (js.Tuple2[ComponentTokenKey[Checkbox], ComponentTokenKey[Checkbox]])*): Self = StObject.set(x, "deprecatedTokens", js.Array(value :_*))
