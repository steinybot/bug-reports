...
trait `35` extends StObject {
  ...
  var deprecatedTokens: js.UndefOr[js.Array[js.Tuple2[ComponentTokenKey[Tree], ComponentTokenKey[Tree]]]] = js.native
...
object `35` {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: `35`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeprecatedTokens(value: js.Array[js.Tuple2[ComponentTokenKey[Tree], ComponentTokenKey[Tree]]]): Self = StObject.set(x, "deprecatedTokens", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDeprecatedTokensUndefined: Self = StObject.set(x, "deprecatedTokens", js.undefined)
    
    @scala.inline
    def setDeprecatedTokensVarargs(value: (js.Tuple2[ComponentTokenKey[Tree], ComponentTokenKey[Tree]])*): Self = StObject.set(x, "deprecatedTokens", js.Array(value :_*))
