...
@js.native
trait InjectStyleOrder extends StObject {
  ...
  var deprecatedTokens: js.UndefOr[
    js.Array[js.Tuple2[ComponentTokenKey[Breadcrumb], ComponentTokenKey[Breadcrumb]]]
  ] = js.native
...
object InjectStyleOrder {
  
  @scala.inline
  def apply(): InjectStyleOrder = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[InjectStyleOrder]
  }
  
  @scala.inline
  implicit class MutableBuilder[Self <: InjectStyleOrder] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeprecatedTokens(value: js.Array[js.Tuple2[ComponentTokenKey[Breadcrumb], ComponentTokenKey[Breadcrumb]]]): Self = StObject.set(x, "deprecatedTokens", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDeprecatedTokensUndefined: Self = StObject.set(x, "deprecatedTokens", js.undefined)
    
    @scala.inline
    def setDeprecatedTokensVarargs(value: (js.Tuple2[ComponentTokenKey[Breadcrumb], ComponentTokenKey[Breadcrumb]])*): Self = StObject.set(x, "deprecatedTokens", js.Array(value :_*))
