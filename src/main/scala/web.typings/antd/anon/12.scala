...
trait `12` extends StObject {
  ...
  var deprecatedTokens: js.UndefOr[js.Array[js.Tuple2[ComponentTokenKey[Form], ComponentTokenKey[Form]]]] = js.native
...
object `12` {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: `12`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeprecatedTokens(value: js.Array[js.Tuple2[ComponentTokenKey[Form], ComponentTokenKey[Form]]]): Self = StObject.set(x, "deprecatedTokens", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDeprecatedTokensUndefined: Self = StObject.set(x, "deprecatedTokens", js.undefined)
    
    @scala.inline
    def setDeprecatedTokensVarargs(value: (js.Tuple2[ComponentTokenKey[Form], ComponentTokenKey[Form]])*): Self = StObject.set(x, "deprecatedTokens", js.Array(value :_*))
