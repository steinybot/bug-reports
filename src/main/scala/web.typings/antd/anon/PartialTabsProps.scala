...
import web.typings.antd.esTabsMod.TabsType
...
/* Inlined std.Partial<antd.antd/es/tabs.TabsProps> */
@js.native
trait PartialTabsProps extends StObject {
  ...
  var onChange: js.UndefOr[js.Function1[/* activeKey */ String, scala.Unit]] = js.native
...
object PartialTabsProps {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: PartialTabsProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnChange(value: /* activeKey */ String => scala.Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnEdit(
      value: (/* e */ SyntheticMouseEvent[Element] | SyntheticKeyboardEvent[Element] | String, /* action */ add | remove) => scala.Unit
    ...
    @scala.inline
    def setOnTabClick(
      value: (/* activeKey */ String, /* e */ SyntheticKeyboardEvent[Element] | SyntheticMouseEvent[Element]) => scala.Unit
    ...
    @scala.inline
    def setOnTabScroll(value: /* info */ web.typings.rcTabs.anon.Direction => scala.Unit): Self = StObject.set(x, "onTabScroll", js.Any.fromFunction1(value))
