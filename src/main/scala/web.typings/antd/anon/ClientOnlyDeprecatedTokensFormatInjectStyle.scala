...
@js.native
trait ClientOnlyDeprecatedTokensFormatInjectStyle extends StObject {
  ...
  var deprecatedTokens: js.UndefOr[js.Array[js.Tuple2[ComponentTokenKey[Collapse], ComponentTokenKey[Collapse]]]] = js.native
...
object ClientOnlyDeprecatedTokensFormatInjectStyle {
  
  @scala.inline
  def apply(): ClientOnlyDeprecatedTokensFormatInjectStyle = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ClientOnlyDeprecatedTokensFormatInjectStyle]
  }
  
  @scala.inline
  implicit class MutableBuilder[Self <: ClientOnlyDeprecatedTokensFormatInjectStyle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeprecatedTokens(value: js.Array[js.Tuple2[ComponentTokenKey[Collapse], ComponentTokenKey[Collapse]]]): Self = StObject.set(x, "deprecatedTokens", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDeprecatedTokensUndefined: Self = StObject.set(x, "deprecatedTokens", js.undefined)
    
    @scala.inline
    def setDeprecatedTokensVarargs(value: (js.Tuple2[ComponentTokenKey[Collapse], ComponentTokenKey[Collapse]])*): Self = StObject.set(x, "deprecatedTokens", js.Array(value :_*))
