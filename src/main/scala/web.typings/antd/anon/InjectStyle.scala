...
@js.native
trait InjectStyle extends StObject {
  ...
  var deprecatedTokens: js.UndefOr[js.Array[js.Tuple2[ComponentTokenKey[Anchor], ComponentTokenKey[Anchor]]]] = js.native
...
object InjectStyle {
  ...
  @scala.inline
  def apply(): InjectStyle = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[InjectStyle]
  }
  
  @scala.inline
  implicit class MutableBuilder[Self <: InjectStyle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeprecatedTokens(value: js.Array[js.Tuple2[ComponentTokenKey[Anchor], ComponentTokenKey[Anchor]]]): Self = StObject.set(x, "deprecatedTokens", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDeprecatedTokensUndefined: Self = StObject.set(x, "deprecatedTokens", js.undefined)
    
    @scala.inline
    def setDeprecatedTokensVarargs(value: (js.Tuple2[ComponentTokenKey[Anchor], ComponentTokenKey[Anchor]])*): Self = StObject.set(x, "deprecatedTokens", js.Array(value :_*))
