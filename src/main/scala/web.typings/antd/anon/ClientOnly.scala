...
trait ClientOnly extends StObject {
  ...
  var deprecatedTokens: js.UndefOr[js.Array[js.Tuple2[ComponentTokenKey[Affix], ComponentTokenKey[Affix]]]] = js.native
...
object ClientOnly {
  ...
  @scala.inline
  def apply(): ClientOnly = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ClientOnly]
  }
  
  @scala.inline
  implicit class MutableBuilder[Self <: ClientOnly] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeprecatedTokens(value: js.Array[js.Tuple2[ComponentTokenKey[Affix], ComponentTokenKey[Affix]]]): Self = StObject.set(x, "deprecatedTokens", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDeprecatedTokensUndefined: Self = StObject.set(x, "deprecatedTokens", js.undefined)
    
    @scala.inline
    def setDeprecatedTokensVarargs(value: (js.Tuple2[ComponentTokenKey[Affix], ComponentTokenKey[Affix]])*): Self = StObject.set(x, "deprecatedTokens", js.Array(value :_*))
