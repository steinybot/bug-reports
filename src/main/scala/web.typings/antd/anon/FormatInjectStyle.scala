...
@js.native
trait FormatInjectStyle extends StObject {
  ...
  var deprecatedTokens: js.UndefOr[js.Array[js.Tuple2[ComponentTokenKey[Button], ComponentTokenKey[Button]]]] = js.native
...
object FormatInjectStyle {
  
  @scala.inline
  def apply(): FormatInjectStyle = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[FormatInjectStyle]
  }
  
  @scala.inline
  implicit class MutableBuilder[Self <: FormatInjectStyle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeprecatedTokens(value: js.Array[js.Tuple2[ComponentTokenKey[Button], ComponentTokenKey[Button]]]): Self = StObject.set(x, "deprecatedTokens", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDeprecatedTokensUndefined: Self = StObject.set(x, "deprecatedTokens", js.undefined)
    
    @scala.inline
    def setDeprecatedTokensVarargs(value: (js.Tuple2[ComponentTokenKey[Button], ComponentTokenKey[Button]])*): Self = StObject.set(x, "deprecatedTokens", js.Array(value :_*))
