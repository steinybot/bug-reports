...
@js.native
trait DeprecatedTokensFormatInjectStyleOrder extends StObject {
  ...
  var deprecatedTokens: js.UndefOr[
    js.Array[
      js.Tuple2[
        ComponentTokenKey[web.typings.antd.antdStrings.DatePicker], 
        ComponentTokenKey[web.typings.antd.antdStrings.DatePicker]
      ]
    ]
  ] = js.native
...
object DeprecatedTokensFormatInjectStyleOrder {
  
  @scala.inline
  def apply(): DeprecatedTokensFormatInjectStyleOrder = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DeprecatedTokensFormatInjectStyleOrder]
  }
  
  @scala.inline
  implicit class MutableBuilder[Self <: DeprecatedTokensFormatInjectStyleOrder] (val x: Self) extends AnyVal {
