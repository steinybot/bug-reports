...
trait `9` extends StObject {
  ...
  var deprecatedTokens: js.UndefOr[js.Array[js.Tuple2[ComponentTokenKey[Empty], ComponentTokenKey[Empty]]]] = js.native
...
object `9` {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: `9`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeprecatedTokens(value: js.Array[js.Tuple2[ComponentTokenKey[Empty], ComponentTokenKey[Empty]]]): Self = StObject.set(x, "deprecatedTokens", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDeprecatedTokensUndefined: Self = StObject.set(x, "deprecatedTokens", js.undefined)
    
    @scala.inline
    def setDeprecatedTokensVarargs(value: (js.Tuple2[ComponentTokenKey[Empty], ComponentTokenKey[Empty]])*): Self = StObject.set(x, "deprecatedTokens", js.Array(value :_*))
