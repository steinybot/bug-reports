...
@js.native
trait ClientOnlyDeprecatedTokens extends StObject {
  ...
  var deprecatedTokens: js.UndefOr[js.Array[js.Tuple2[ComponentTokenKey[BackTop], ComponentTokenKey[BackTop]]]] = js.native
...
object ClientOnlyDeprecatedTokens {
  
  @scala.inline
  def apply(): ClientOnlyDeprecatedTokens = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ClientOnlyDeprecatedTokens]
  }
  
  @scala.inline
  implicit class MutableBuilder[Self <: ClientOnlyDeprecatedTokens] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeprecatedTokens(value: js.Array[js.Tuple2[ComponentTokenKey[BackTop], ComponentTokenKey[BackTop]]]): Self = StObject.set(x, "deprecatedTokens", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDeprecatedTokensUndefined: Self = StObject.set(x, "deprecatedTokens", js.undefined)
    
    @scala.inline
    def setDeprecatedTokensVarargs(value: (js.Tuple2[ComponentTokenKey[BackTop], ComponentTokenKey[BackTop]])*): Self = StObject.set(x, "deprecatedTokens", js.Array(value :_*))
