...
@js.native
trait FormatInjectStyleOrderResetStyle extends StObject {
  ...
  var deprecatedTokens: js.UndefOr[
    js.Array[js.Tuple2[ComponentTokenKey[Descriptions], ComponentTokenKey[Descriptions]]]
  ] = js.native
...
object FormatInjectStyleOrderResetStyle {
  
  @scala.inline
  def apply(): FormatInjectStyleOrderResetStyle = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[FormatInjectStyleOrderResetStyle]
  }
  
  @scala.inline
  implicit class MutableBuilder[Self <: FormatInjectStyleOrderResetStyle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeprecatedTokens(value: js.Array[js.Tuple2[ComponentTokenKey[Descriptions], ComponentTokenKey[Descriptions]]]): Self = StObject.set(x, "deprecatedTokens", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDeprecatedTokensUndefined: Self = StObject.set(x, "deprecatedTokens", js.undefined)
    
    @scala.inline
    def setDeprecatedTokensVarargs(value: (js.Tuple2[ComponentTokenKey[Descriptions], ComponentTokenKey[Descriptions]])*): Self = StObject.set(x, "deprecatedTokens", js.Array(value :_*))
