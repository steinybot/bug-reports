...
@js.native
trait ClientOnlyDeprecatedTokensFormat extends StObject {
  ...
  var deprecatedTokens: js.UndefOr[js.Array[js.Tuple2[ComponentTokenKey[Carousel], ComponentTokenKey[Carousel]]]] = js.native
...
object ClientOnlyDeprecatedTokensFormat {
  
  @scala.inline
  def apply(): ClientOnlyDeprecatedTokensFormat = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ClientOnlyDeprecatedTokensFormat]
  }
  
  @scala.inline
  implicit class MutableBuilder[Self <: ClientOnlyDeprecatedTokensFormat] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeprecatedTokens(value: js.Array[js.Tuple2[ComponentTokenKey[Carousel], ComponentTokenKey[Carousel]]]): Self = StObject.set(x, "deprecatedTokens", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDeprecatedTokensUndefined: Self = StObject.set(x, "deprecatedTokens", js.undefined)
    
    @scala.inline
    def setDeprecatedTokensVarargs(value: (js.Tuple2[ComponentTokenKey[Carousel], ComponentTokenKey[Carousel]])*): Self = StObject.set(x, "deprecatedTokens", js.Array(value :_*))
