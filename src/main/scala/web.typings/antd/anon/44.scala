...
trait `44` extends StObject {
  ...
  var deprecatedTokens: js.UndefOr[js.Array[js.Tuple2[ComponentTokenKey[Modal], ComponentTokenKey[Modal]]]] = js.native
...
object `44` {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: `44`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeprecatedTokens(value: js.Array[js.Tuple2[ComponentTokenKey[Modal], ComponentTokenKey[Modal]]]): Self = StObject.set(x, "deprecatedTokens", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDeprecatedTokensUndefined: Self = StObject.set(x, "deprecatedTokens", js.undefined)
    
    @scala.inline
    def setDeprecatedTokensVarargs(value: (js.Tuple2[ComponentTokenKey[Modal], ComponentTokenKey[Modal]])*): Self = StObject.set(x, "deprecatedTokens", js.Array(value :_*))
