...
@js.native
trait DeprecatedTokensFormat extends StObject {
  ...
  var deprecatedTokens: js.UndefOr[js.Array[js.Tuple2[ComponentTokenKey[Badge], ComponentTokenKey[Badge]]]] = js.native
...
object DeprecatedTokensFormat {
  
  @scala.inline
  def apply(): DeprecatedTokensFormat = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DeprecatedTokensFormat]
  }
  
  @scala.inline
  implicit class MutableBuilder[Self <: DeprecatedTokensFormat] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeprecatedTokens(value: js.Array[js.Tuple2[ComponentTokenKey[Badge], ComponentTokenKey[Badge]]]): Self = StObject.set(x, "deprecatedTokens", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDeprecatedTokensUndefined: Self = StObject.set(x, "deprecatedTokens", js.undefined)
    
    @scala.inline
    def setDeprecatedTokensVarargs(value: (js.Tuple2[ComponentTokenKey[Badge], ComponentTokenKey[Badge]])*): Self = StObject.set(x, "deprecatedTokens", js.Array(value :_*))
