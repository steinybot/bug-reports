...
@js.native
trait ResetStyle extends StObject {
  ...
  var deprecatedTokens: js.UndefOr[js.Array[js.Tuple2[ComponentTokenKey[Avatar], ComponentTokenKey[Avatar]]]] = js.native
...
object ResetStyle {
  ...
  @scala.inline
  def apply(): ResetStyle = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ResetStyle]
  }
  
  @scala.inline
  implicit class MutableBuilder[Self <: ResetStyle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeprecatedTokens(value: js.Array[js.Tuple2[ComponentTokenKey[Avatar], ComponentTokenKey[Avatar]]]): Self = StObject.set(x, "deprecatedTokens", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDeprecatedTokensUndefined: Self = StObject.set(x, "deprecatedTokens", js.undefined)
    
    @scala.inline
    def setDeprecatedTokensVarargs(value: (js.Tuple2[ComponentTokenKey[Avatar], ComponentTokenKey[Avatar]])*): Self = StObject.set(x, "deprecatedTokens", js.Array(value :_*))
