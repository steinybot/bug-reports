...
/* Inlined std.Partial<antd.antd/es/popconfirm.PopconfirmProps & react.react.RefAttributes<unknown>> */
@js.native
trait PartialPopconfirmPropsRef extends StObject {
  ...
  var onCancel: js.UndefOr[js.Function1[/* e */ js.UndefOr[SyntheticMouseEvent[HTMLElement]], scala.Unit]] = js.native
  
  var onConfirm: js.UndefOr[js.Function1[/* e */ js.UndefOr[SyntheticMouseEvent[HTMLElement]], scala.Unit]] = js.native
  ...
  var onPopupClick: js.UndefOr[js.Function1[/* e */ SyntheticMouseEvent[HTMLElement], scala.Unit]] = js.native
...
object PartialPopconfirmPropsRef {
  
  @scala.inline
  def apply(): PartialPopconfirmPropsRef = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialPopconfirmPropsRef]
  }
  
  @scala.inline
  implicit class MutableBuilder[Self <: PartialPopconfirmPropsRef] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnCancel(value: /* e */ js.UndefOr[SyntheticMouseEvent[HTMLElement]] => scala.Unit): Self = StObject.set(x, "onCancel", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnCancelUndefined: Self = StObject.set(x, "onCancel", js.undefined)
    
    @scala.inline
    def setOnConfirm(value: /* e */ js.UndefOr[SyntheticMouseEvent[HTMLElement]] => scala.Unit): Self = StObject.set(x, "onConfirm", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnOpenChange(
      value: (/* open */ Boolean, /* e */ js.UndefOr[SyntheticMouseEvent[HTMLElement] | SyntheticKeyboardEvent[HTMLDivElement]]) => scala.Unit
    ...
    @scala.inline
    def setOnPopupClick(value: /* e */ SyntheticMouseEvent[HTMLElement] => scala.Unit): Self = StObject.set(x, "onPopupClick", js.Any.fromFunction1(value))
