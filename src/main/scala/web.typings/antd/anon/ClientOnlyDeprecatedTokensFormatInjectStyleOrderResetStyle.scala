...
@js.native
trait ClientOnlyDeprecatedTokensFormatInjectStyleOrderResetStyle extends StObject {
  ...
  var deprecatedTokens: js.UndefOr[js.Array[js.Tuple2[ComponentTokenKey[Dropdown], ComponentTokenKey[Dropdown]]]] = js.native
  
  var format: js.UndefOr[FormatComponentToken[Dropdown]] = js.native
...
object ClientOnlyDeprecatedTokensFormatInjectStyleOrderResetStyle {
  
  @scala.inline
  def apply(): ClientOnlyDeprecatedTokensFormatInjectStyleOrderResetStyle = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ClientOnlyDeprecatedTokensFormatInjectStyleOrderResetStyle]
  }
  
  @scala.inline
  implicit class MutableBuilder[Self <: ClientOnlyDeprecatedTokensFormatInjectStyleOrderResetStyle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeprecatedTokens(value: js.Array[js.Tuple2[ComponentTokenKey[Dropdown], ComponentTokenKey[Dropdown]]]): Self = StObject.set(x, "deprecatedTokens", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDeprecatedTokensUndefined: Self = StObject.set(x, "deprecatedTokens", js.undefined)
    
    @scala.inline
    def setDeprecatedTokensVarargs(value: (js.Tuple2[ComponentTokenKey[Dropdown], ComponentTokenKey[Dropdown]])*): Self = StObject.set(x, "deprecatedTokens", js.Array(value :_*))
