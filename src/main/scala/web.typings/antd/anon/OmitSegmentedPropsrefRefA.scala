...
/* Inlined std.Omit<antd.antd/es/segmented.SegmentedProps, 'ref'> & react.react.RefAttributes<std.HTMLDivElement> */
@js.native
trait OmitSegmentedPropsrefRefA extends StObject {
  ...
  var onChange: js.UndefOr[js.Function1[/* value */ SegmentedValue, scala.Unit]] = js.native
...
object OmitSegmentedPropsrefRefA {
  
  @scala.inline
  def apply(options: js.Array[SegmentedRawOption | SegmentedLabeledOption]): OmitSegmentedPropsrefRefA = {
    val __obj = js.Dynamic.literal(options = options.asInstanceOf[js.Any])
    __obj.asInstanceOf[OmitSegmentedPropsrefRefA]
  }
  
  @scala.inline
  implicit class MutableBuilder[Self <: OmitSegmentedPropsrefRefA] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnChange(value: /* value */ SegmentedValue => scala.Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnResize(value: SyntheticEvent[Event, HTMLDivElement] => scala.Unit): Self = StObject.set(x, "onResize", js.Any.fromFunction1(value))
