...
/* Inlined antd.antd/es/upload/interface.UploadProps<any> & {  height :number | undefined} & react.react.RefAttributes<antd.antd/es/upload/Upload.UploadRef<any>> */
@js.native
trait UploadPropsanyheightnumbe extends StObject {
  ...
  var customRequest: js.UndefOr[js.Function1[/* options */ UploadRequestOption[Any], scala.Unit]] = js.native
  ...
  var onChange: js.UndefOr[js.Function1[/* info */ UploadChangeParam[UploadFile[Any]], scala.Unit]] = js.native
  
  var onDownload: js.UndefOr[js.Function1[/* file */ UploadFile[Any], scala.Unit]] = js.native
  
  var onDrop: js.UndefOr[js.Function1[/* event */ DragEvent[HTMLDivElement], scala.Unit]] = js.native
  
  var onPreview: js.UndefOr[js.Function1[/* file */ UploadFile[Any], scala.Unit]] = js.native
  
  var onRemove: js.UndefOr[
    js.Function1[
      /* file */ UploadFile[Any], 
      scala.Unit | Boolean | (js.Promise[scala.Unit | Boolean])
    ]
  ] = js.native
  ...
  /**
    ...
    */
  var ref: js.UndefOr[web.typings.react.mod.Ref[UploadRef[Any]]] = js.native
...
object UploadPropsanyheightnumbe {
  ...
  @scala.inline
  def apply(): UploadPropsanyheightnumbe = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UploadPropsanyheightnumbe]
  }
  
  @scala.inline
  implicit class MutableBuilder[Self <: UploadPropsanyheightnumbe] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCustomRequest(value: /* options */ UploadRequestOption[Any] => scala.Unit): Self = StObject.set(x, "customRequest", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnChange(value: /* info */ UploadChangeParam[UploadFile[Any]] => scala.Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
    
    @scala.inline
    def setOnDownload(value: /* file */ UploadFile[Any] => scala.Unit): Self = StObject.set(x, "onDownload", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnDownloadUndefined: Self = StObject.set(x, "onDownload", js.undefined)
    
    @scala.inline
    def setOnDrop(value: /* event */ DragEvent[HTMLDivElement] => scala.Unit): Self = StObject.set(x, "onDrop", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnDropUndefined: Self = StObject.set(x, "onDrop", js.undefined)
    
    @scala.inline
    def setOnPreview(value: /* file */ UploadFile[Any] => scala.Unit): Self = StObject.set(x, "onPreview", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnPreviewUndefined: Self = StObject.set(x, "onPreview", js.undefined)
    
    @scala.inline
    def setOnRemove(value: /* file */ UploadFile[Any] => scala.Unit | Boolean | (js.Promise[scala.Unit | Boolean])): Self = StObject.set(x, "onRemove", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setRef(value: web.typings.react.mod.Ref[UploadRef[Any]]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRefFunction1(value: /* instance */ UploadRef[Any] | Null => scala.Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
    
    @scala.inline
    def setRefNull: Self = StObject.set(x, "ref", null)
    
    @scala.inline
    def setRefReactRef(value: ReactRef[UploadRef[Any]]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
