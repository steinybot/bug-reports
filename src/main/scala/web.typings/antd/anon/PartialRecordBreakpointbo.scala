...
/* Inlined std.Partial<std.Record<antd.antd.Breakpoint, boolean>> */
@js.native
...
object PartialRecordBreakpointbo {
  ...
  @scala.inline
  def apply(): PartialRecordBreakpointbo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialRecordBreakpointbo]
  }
  
  @scala.inline
  implicit class MutableBuilder[Self <: PartialRecordBreakpointbo] (val x: Self) extends AnyVal {
