...
trait `65` extends StObject {
  ...
  var deprecatedTokens: js.UndefOr[
    js.Array[
      js.Tuple2[
        /* keyof std.Exclude<std.Partial<antd.antd/es/drawer/style.ComponentToken | undefined> & std.Partial<antd.antd/es/theme/interface/alias.AliasToken> | undefined, undefined> */ String, 
        /* keyof std.Exclude<std.Partial<antd.antd/es/drawer/style.ComponentToken | undefined> & std.Partial<antd.antd/es/theme/interface/alias.AliasToken> | undefined, undefined> */ String
      ]
    ]
  ] = js.native
  ...
  var unitless: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: keyof std.Exclude<std.Partial<antd.antd/es/drawer/style.ComponentToken | undefined> & std.Partial<antd.antd/es/theme/interface/alias.AliasToken> | undefined, undefined> extends infer T ? {[ key in T ]: boolean} : never */ js.Any
  ] = js.native
}
object `65` {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: `65`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUnitless(
      value: /* import warning: importer.ImportType#apply Failed type conversion: keyof std.Exclude<std.Partial<antd.antd/es/drawer/style.ComponentToken | undefined> & std.Partial<antd.antd/es/theme/interface/alias.AliasToken> | undefined, undefined> extends infer T ? {[ key in T ]: boolean} : never */ js.Any
