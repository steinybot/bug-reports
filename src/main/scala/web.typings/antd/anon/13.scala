...
trait `13` extends StObject {
  ...
  var deprecatedTokens: js.UndefOr[js.Array[js.Tuple2[ComponentTokenKey[Grid], ComponentTokenKey[Grid]]]] = js.native
...
object `13` {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: `13`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeprecatedTokens(value: js.Array[js.Tuple2[ComponentTokenKey[Grid], ComponentTokenKey[Grid]]]): Self = StObject.set(x, "deprecatedTokens", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDeprecatedTokensUndefined: Self = StObject.set(x, "deprecatedTokens", js.undefined)
    
    @scala.inline
    def setDeprecatedTokensVarargs(value: (js.Tuple2[ComponentTokenKey[Grid], ComponentTokenKey[Grid]])*): Self = StObject.set(x, "deprecatedTokens", js.Array(value :_*))
