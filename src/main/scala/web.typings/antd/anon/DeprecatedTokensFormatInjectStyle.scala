...
@js.native
trait DeprecatedTokensFormatInjectStyle extends StObject {
  ...
  var deprecatedTokens: js.UndefOr[js.Array[js.Tuple2[ComponentTokenKey[Cascader], ComponentTokenKey[Cascader]]]] = js.native
...
object DeprecatedTokensFormatInjectStyle {
  
  @scala.inline
  def apply(): DeprecatedTokensFormatInjectStyle = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DeprecatedTokensFormatInjectStyle]
  }
  
  @scala.inline
  implicit class MutableBuilder[Self <: DeprecatedTokensFormatInjectStyle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeprecatedTokens(value: js.Array[js.Tuple2[ComponentTokenKey[Cascader], ComponentTokenKey[Cascader]]]): Self = StObject.set(x, "deprecatedTokens", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDeprecatedTokensUndefined: Self = StObject.set(x, "deprecatedTokens", js.undefined)
    
    @scala.inline
    def setDeprecatedTokensVarargs(value: (js.Tuple2[ComponentTokenKey[Cascader], ComponentTokenKey[Cascader]])*): Self = StObject.set(x, "deprecatedTokens", js.Array(value :_*))
