...
object esDescriptionsCellMod extends Shortcut {
  ...
  object CellProps {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: CellProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `esDescriptionsCellMod.foo` */
