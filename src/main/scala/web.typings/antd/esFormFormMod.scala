...
import web.typings.antd.antdStrings.optional
...
object esFormFormMod {
  ...
  @JSImport("antd/es/form/Form", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("antd/es/form/Form", JSImport.Default)
  @js.native
  val default: (js.Function1[/* props */ ChildrenRef[Any] with FormProps[Any], ReactElement]) with `2` = js.native
  ...
  @scala.inline
  def useWatch[TForm /* <: web.typings.rcFieldForm.esInterfaceMod.FormInstance[Any] */](dependencies: NamePath[Any]): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("useWatch")(dependencies.asInstanceOf[js.Any]).asInstanceOf[Any]
  @scala.inline
  def useWatch[TForm /* <: web.typings.rcFieldForm.esInterfaceMod.FormInstance[Any] */](dependencies: NamePath[Any], form: TForm): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("useWatch")(dependencies.asInstanceOf[js.Any], form.asInstanceOf[js.Any])).asInstanceOf[Any]
  @scala.inline
  def useWatch[ValueType](dependencies: NamePath[Any], form: web.typings.rcFieldForm.esInterfaceMod.FormInstance[Any]): ValueType = (^.asInstanceOf[js.Dynamic].applyDynamic("useWatch")(dependencies.asInstanceOf[js.Any], form.asInstanceOf[js.Any])).asInstanceOf[ValueType]
  @scala.inline
  def useWatch[TForm /* <: web.typings.rcFieldForm.esInterfaceMod.FormInstance[Any] */](dependencies: NamePath[Any], form: WatchOptions[TForm]): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("useWatch")(dependencies.asInstanceOf[js.Any], form.asInstanceOf[js.Any])).asInstanceOf[Any]
  @scala.inline
  def useWatch[TForm /* <: web.typings.rcFieldForm.esInterfaceMod.FormInstance[Any] */](dependencies: js.Array[Any]): GetGeneric[TForm] = ^.asInstanceOf[js.Dynamic].applyDynamic("useWatch")(dependencies.asInstanceOf[js.Any]).asInstanceOf[GetGeneric[TForm]]
  @scala.inline
  def useWatch[TForm /* <: web.typings.rcFieldForm.esInterfaceMod.FormInstance[Any] */](dependencies: js.Array[Any], form: TForm): GetGeneric[TForm] = (^.asInstanceOf[js.Dynamic].applyDynamic("useWatch")(dependencies.asInstanceOf[js.Any], form.asInstanceOf[js.Any])).asInstanceOf[GetGeneric[TForm]]
  @scala.inline
  def useWatch[TForm /* <: web.typings.rcFieldForm.esInterfaceMod.FormInstance[Any] */](dependencies: js.Array[Any], form: WatchOptions[TForm]): GetGeneric[TForm] = (^.asInstanceOf[js.Dynamic].applyDynamic("useWatch")(dependencies.asInstanceOf[js.Any], form.asInstanceOf[js.Any])).asInstanceOf[GetGeneric[TForm]]
  @scala.inline
  def useWatch[TDependencies /* <: /* keyof rc-field-form.rc-field-form/es/useWatch.GetGeneric<TForm> */ String */, TForm /* <: web.typings.rcFieldForm.esInterfaceMod.FormInstance[Any] */](dependencies: TDependencies): /* import warning: importer.ImportType#apply Failed type conversion: rc-field-form.rc-field-form/es/useWatch.GetGeneric<TForm>[TDependencies] */ js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("useWatch")(dependencies.asInstanceOf[js.Any]).asInstanceOf[/* import warning: importer.ImportType#apply Failed type conversion: rc-field-form.rc-field-form/es/useWatch.GetGeneric<TForm>[TDependencies] */ js.Any]
  @scala.inline
  def useWatch[TDependencies /* <: /* keyof rc-field-form.rc-field-form/es/useWatch.GetGeneric<TForm> */ String */, TForm /* <: web.typings.rcFieldForm.esInterfaceMod.FormInstance[Any] */](dependencies: TDependencies, form: TForm): /* import warning: importer.ImportType#apply Failed type conversion: rc-field-form.rc-field-form/es/useWatch.GetGeneric<TForm>[TDependencies] */ js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("useWatch")(dependencies.asInstanceOf[js.Any], form.asInstanceOf[js.Any])).asInstanceOf[/* import warning: importer.ImportType#apply Failed type conversion: rc-field-form.rc-field-form/es/useWatch.GetGeneric<TForm>[TDependencies] */ js.Any]
  @scala.inline
  def useWatch[TDependencies /* <: /* keyof rc-field-form.rc-field-form/es/useWatch.GetGeneric<TForm> */ String */, TForm /* <: web.typings.rcFieldForm.esInterfaceMod.FormInstance[Any] */](dependencies: TDependencies, form: WatchOptions[TForm]): /* import warning: importer.ImportType#apply Failed type conversion: rc-field-form.rc-field-form/es/useWatch.GetGeneric<TForm>[TDependencies] */ js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("useWatch")(dependencies.asInstanceOf[js.Any], form.asInstanceOf[js.Any])).asInstanceOf[/* import warning: importer.ImportType#apply Failed type conversion: rc-field-form.rc-field-form/es/useWatch.GetGeneric<TForm>[TDependencies] */ js.Any]
  @scala.inline
  ...
  @scala.inline
  def useWatch[TForm /* <: web.typings.rcFieldForm.esInterfaceMod.FormInstance[Any] */, TSelected](selector: js.Function1[/* values */ GetGeneric[TForm], TSelected], form: TForm): TSelected = (^.asInstanceOf[js.Dynamic].applyDynamic("useWatch")(selector.asInstanceOf[js.Any], form.asInstanceOf[js.Any])).asInstanceOf[TSelected]
  @scala.inline
  def useWatch[ValueType, TSelected](
    selector: js.Function1[/* values */ ValueType, TSelected],
    form: web.typings.rcFieldForm.esInterfaceMod.FormInstance[Any]
  ): TSelected = (^.asInstanceOf[js.Dynamic].applyDynamic("useWatch")(selector.asInstanceOf[js.Any], form.asInstanceOf[js.Any])).asInstanceOf[TSelected]
  @scala.inline
  def useWatch[ValueType, TSelected](
    selector: js.Function1[/* values */ ValueType, TSelected],
    form: WatchOptions[web.typings.rcFieldForm.esInterfaceMod.FormInstance[Any]]
  ): TSelected = (^.asInstanceOf[js.Dynamic].applyDynamic("useWatch")(selector.asInstanceOf[js.Any], form.asInstanceOf[js.Any])).asInstanceOf[TSelected]
  @scala.inline
  def useWatch[TDependencies1 /* <: /* keyof rc-field-form.rc-field-form/es/useWatch.GetGeneric<TForm> */ String */, TForm /* <: web.typings.rcFieldForm.esInterfaceMod.FormInstance[Any] */, TDependencies2 /* <: /* import warning: importer.ImportType#apply Failed type conversion: keyof rc-field-form.rc-field-form/es/useWatch.GetGeneric<TForm>[TDependencies1] */ js.Any */](dependencies: js.Tuple2[TDependencies1, TDependencies2]): /* import warning: importer.ImportType#apply Failed type conversion: rc-field-form.rc-field-form/es/useWatch.GetGeneric<TForm>[TDependencies1][TDependencies2] */ js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("useWatch")(dependencies.asInstanceOf[js.Any]).asInstanceOf[/* import warning: importer.ImportType#apply Failed type conversion: rc-field-form.rc-field-form/es/useWatch.GetGeneric<TForm>[TDependencies1][TDependencies2] */ js.Any]
  @scala.inline
  ...
  @scala.inline
  def useWatch_TDependenciesTForm_Any[TDependencies /* <: /* keyof rc-field-form.rc-field-form/es/useWatch.GetGeneric<TForm> */ String */, TForm /* <: web.typings.rcFieldForm.esInterfaceMod.FormInstance[Any] */](dependencies: js.Array[TDependencies]): /* import warning: importer.ImportType#apply Failed type conversion: rc-field-form.rc-field-form/es/useWatch.GetGeneric<TForm>[TDependencies] */ js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("useWatch")(dependencies.asInstanceOf[js.Any]).asInstanceOf[/* import warning: importer.ImportType#apply Failed type conversion: rc-field-form.rc-field-form/es/useWatch.GetGeneric<TForm>[TDependencies] */ js.Any]
  @scala.inline
  def useWatch_TDependenciesTForm_Any[TDependencies /* <: /* keyof rc-field-form.rc-field-form/es/useWatch.GetGeneric<TForm> */ String */, TForm /* <: web.typings.rcFieldForm.esInterfaceMod.FormInstance[Any] */](dependencies: js.Array[TDependencies], form: TForm): /* import warning: importer.ImportType#apply Failed type conversion: rc-field-form.rc-field-form/es/useWatch.GetGeneric<TForm>[TDependencies] */ js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("useWatch")(dependencies.asInstanceOf[js.Any], form.asInstanceOf[js.Any])).asInstanceOf[/* import warning: importer.ImportType#apply Failed type conversion: rc-field-form.rc-field-form/es/useWatch.GetGeneric<TForm>[TDependencies] */ js.Any]
  @scala.inline
  def useWatch_TDependenciesTForm_Any[TDependencies /* <: /* keyof rc-field-form.rc-field-form/es/useWatch.GetGeneric<TForm> */ String */, TForm /* <: web.typings.rcFieldForm.esInterfaceMod.FormInstance[Any] */](dependencies: js.Array[TDependencies], form: WatchOptions[TForm]): /* import warning: importer.ImportType#apply Failed type conversion: rc-field-form.rc-field-form/es/useWatch.GetGeneric<TForm>[TDependencies] */ js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("useWatch")(dependencies.asInstanceOf[js.Any], form.asInstanceOf[js.Any])).asInstanceOf[/* import warning: importer.ImportType#apply Failed type conversion: rc-field-form.rc-field-form/es/useWatch.GetGeneric<TForm>[TDependencies] */ js.Any]
  
  @scala.inline
  def useWatch_TFormTSelected[TForm /* <: web.typings.rcFieldForm.esInterfaceMod.FormInstance[Any] */, TSelected](selector: js.Function1[/* values */ GetGeneric[TForm], TSelected]): TSelected = ^.asInstanceOf[js.Dynamic].applyDynamic("useWatch")(selector.asInstanceOf[js.Any]).asInstanceOf[TSelected]
  @scala.inline
  def useWatch_TFormTSelected[TForm /* <: web.typings.rcFieldForm.esInterfaceMod.FormInstance[Any] */, TSelected](selector: js.Function1[/* values */ GetGeneric[TForm], TSelected], form: WatchOptions[TForm]): TSelected = (^.asInstanceOf[js.Dynamic].applyDynamic("useWatch")(selector.asInstanceOf[js.Any], form.asInstanceOf[js.Any])).asInstanceOf[TSelected]
  ...
  @scala.inline
  def useWatch_ValueType_ValueType[ValueType](
    dependencies: NamePath[Any],
    form: WatchOptions[web.typings.rcFieldForm.esInterfaceMod.FormInstance[Any]]
  ): ValueType = (^.asInstanceOf[js.Dynamic].applyDynamic("useWatch")(dependencies.asInstanceOf[js.Any], form.asInstanceOf[js.Any])).asInstanceOf[ValueType]
  
  /* Rewritten from type alias, can be one of: 
    - `web.typings`.antd.antdStrings.horizontal
    - `web.typings`.antd.antdStrings.`inline`
  ...
  */
  ...
  object FormLayout {
    ...
    @scala.inline
    def `inline`: web.typings.antd.antdStrings.`inline` = "inline".asInstanceOf[web.typings.antd.antdStrings.`inline`]
  ...
  trait FormProps[Values] extends StObject {
    ...
    var component: js.UndefOr[`false` | String | ReactComponentClass[Any]] = js.native
    ...
    var onResize: js.UndefOr[ReactEventHandler[HTMLFormElement]] = js.native
    ...
    var onValuesChange: js.UndefOr[js.Function2[/* changedValues */ Any, /* values */ Values, Unit]] = js.native
  ...
  object FormProps {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: FormProps[_], Values] (val x: Self with FormProps[Values]) extends AnyVal {
      ...
      @scala.inline
      def setAction(value: String | (js.Function1[/* formData */ FormData, Unit])): Self = StObject.set(x, "action", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setActionFunction1(value: /* formData */ FormData => Unit): Self = StObject.set(x, "action", js.Any.fromFunction1(value))
      ...
      def setChildrenFunction2(
        value: (/* values */ Store, /* form */ web.typings.rcFieldForm.esInterfaceMod.FormInstance[Any]) => web.typings.react.mod.global.JSX.Element | ReactElement
      ...
      @scala.inline
      def setComponent(value: `false` | String | ReactComponentClass[Any]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnResize(value: SyntheticEvent[Event, HTMLFormElement] => Unit): Self = StObject.set(x, "onResize", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnValuesChange(value: (/* changedValues */ Any, /* values */ Values) => Unit): Self = StObject.set(x, "onValuesChange", js.Any.fromFunction2(value))
  ...
  type RequiredMark = Boolean | optional | (js.Function2[/* labelNode */ ReactElement, /* info */ Required, ReactElement])
}
