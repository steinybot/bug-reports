...
object esMenuStyleHorizontalMod extends Shortcut {
  
  @JSImport("antd/es/menu/style/horizontal", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `esMenuStyleHorizontalMod.foo` */
