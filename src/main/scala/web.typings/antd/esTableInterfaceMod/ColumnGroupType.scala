...
/* Inlined parent std.Omit<antd.antd/es/table/interface.ColumnType<RecordType>, 'dataIndex'> */
@js.native
...
object ColumnGroupType {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: ColumnGroupType[_], RecordType] (val x: Self with ColumnGroupType[RecordType]) extends AnyVal {
