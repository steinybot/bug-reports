...
object esModalPurePanelMod {
  
  @JSImport("antd/es/modal/PurePanel", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @scala.inline
  def default(props: Any): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  
  /* Inlined parent std.Omit<rc-dialog.rc-dialog/es/Dialog/Content/Panel.PanelProps, 'prefixCls' | 'footer'> */
  /* Inlined parent std.Pick<antd.antd/es/modal/interface.ModalFuncProps, 'type' | 'footer'> */
  @js.native
  trait PurePanelProps extends StObject {
    ...
    var onClose: js.UndefOr[js.Function1[/* e */ SyntheticEvent[Event, org.scalajs.dom.Element], Any]] = js.native
    
    var onMouseDown: js.UndefOr[MouseEventHandler[org.scalajs.dom.Element]] = js.native
    
    var onMouseUp: js.UndefOr[MouseEventHandler[org.scalajs.dom.Element]] = js.native
  ...
  object PurePanelProps {
    ...
    implicit class MutableBuilder[Self <: PurePanelProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnClose(value: /* e */ SyntheticEvent[Event, org.scalajs.dom.Element] => Any): Self = StObject.set(x, "onClose", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnCloseUndefined: Self = StObject.set(x, "onClose", js.undefined)
      
      @scala.inline
      def setOnMouseDown(value: SyntheticMouseEvent[org.scalajs.dom.Element] => Unit): Self = StObject.set(x, "onMouseDown", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnMouseDownUndefined: Self = StObject.set(x, "onMouseDown", js.undefined)
      
      @scala.inline
      def setOnMouseUp(value: SyntheticMouseEvent[org.scalajs.dom.Element] => Unit): Self = StObject.set(x, "onMouseUp", js.Any.fromFunction1(value))
