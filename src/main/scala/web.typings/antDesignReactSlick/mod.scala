package web.typings.antDesignReactSlick

import web.typings.antDesignReactSlick.antDesignReactSlickStrings.unslick
...
object mod {
  ...
  object CustomArrowProps {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: CustomArrowProps] (val x: Self) extends AnyVal {
  ...
  /* Rewritten from type alias, can be one of: 
    - `web.typings`.antDesignReactSlick.antDesignReactSlickStrings.ondemand
    - `web.typings`.antDesignReactSlick.antDesignReactSlickStrings.progressive
  */
  trait LazyLoadTypes extends StObject
  object LazyLoadTypes {
    
    @scala.inline
    def ondemand: web.typings.antDesignReactSlick.antDesignReactSlickStrings.ondemand = "ondemand".asInstanceOf[web.typings.antDesignReactSlick.antDesignReactSlickStrings.ondemand]
    
    @scala.inline
    def progressive: web.typings.antDesignReactSlick.antDesignReactSlickStrings.progressive = "progressive".asInstanceOf[web.typings.antDesignReactSlick.antDesignReactSlickStrings.progressive]
  }
  ...
  object ResponsiveObject {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: ResponsiveObject] (val x: Self) extends AnyVal {
  ...
  trait Settings extends StObject {
    ...
    var appendDots: js.UndefOr[js.Function1[/* dots */ ReactElement, Element]] = js.native
  ...
  object Settings {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: Settings] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAppendDots(value: /* dots */ ReactElement => Element): Self = StObject.set(x, "appendDots", js.Any.fromFunction1(value))
  ...
  /* Rewritten from type alias, can be one of: 
    - `web.typings`.antDesignReactSlick.antDesignReactSlickStrings.left
    - `web.typings`.antDesignReactSlick.antDesignReactSlickStrings.down
    - `web.typings`.antDesignReactSlick.antDesignReactSlickStrings.right
    - `web.typings`.antDesignReactSlick.antDesignReactSlickStrings.up
    - java.lang.String
  */
