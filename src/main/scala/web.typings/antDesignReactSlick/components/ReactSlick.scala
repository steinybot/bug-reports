package web.typings.antDesignReactSlick.components
...
object ReactSlick {
  ...
  class Builder (val args: js.Array[Any])
    ...
    @scala.inline
    def appendDots(value: /* dots */ ReactElement => Element): this.type = set("appendDots", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def customPaging(value: /* index */ Double => Element): this.type = set("customPaging", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def nextArrow(value: Element): this.type = set("nextArrow", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def prevArrow(value: Element): this.type = set("prevArrow", value.asInstanceOf[js.Any])
