...
object anon {
  ...
  object A {
    ...
    @scala.inline
    def apply(a: Double, b: Double, format: Any, g: Double, ok: Boolean, r: Double): A = {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: A] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFormat(value: Any): Self = StObject.set(x, "format", value.asInstanceOf[js.Any])
  ...
  trait FnCall extends StObject {
    ...
    def apply(): js.Array[TinyColor_] = js.native
  ...
  object NumberifyHSL {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: NumberifyHSL] (val x: Self) extends AnyVal {
  ...
  object NumberifyHSLA {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: NumberifyHSLA] (val x: Self) extends AnyVal {
  ...
  object NumberifyHSV {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: NumberifyHSV] (val x: Self) extends AnyVal {
  ...
  object NumberifyHSVA {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: NumberifyHSVA] (val x: Self) extends AnyVal {
  ...
  object NumberifyRGB {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: NumberifyRGB] (val x: Self) extends AnyVal {
  ...
  object PartialTinyColorOptions {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: PartialTinyColorOptions] (val x: Self) extends AnyVal {
