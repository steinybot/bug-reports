...
import web.typings.antDesignIconsSvg.antDesignIconsSvgStrings.filled_
import web.typings.antDesignIconsSvg.antDesignIconsSvgStrings.outlined_
import web.typings.antDesignIconsSvg.antDesignIconsSvgStrings.twotone_
...
object esTypesMod {
  ...
  object AbstractNode {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: AbstractNode] (val x: Self) extends AnyVal {
  ...
  object IconDefinition {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: IconDefinition] (val x: Self) extends AnyVal {
  ...
  /* Rewritten from type alias, can be one of: 
    - `web.typings`.antDesignIconsSvg.antDesignIconsSvgStrings.filled_
    - `web.typings`.antDesignIconsSvg.antDesignIconsSvgStrings.outlined_
    - `web.typings`.antDesignIconsSvg.antDesignIconsSvgStrings.twotone_
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - `web.typings`.antDesignIconsSvg.antDesignIconsSvgStrings.Filled
    - `web.typings`.antDesignIconsSvg.antDesignIconsSvgStrings.Outlined
    - `web.typings`.antDesignIconsSvg.antDesignIconsSvgStrings.TwoTone
  */
  trait ThemeTypeUpperCase extends StObject
  object ThemeTypeUpperCase {
    
    @scala.inline
    def Filled: web.typings.antDesignIconsSvg.antDesignIconsSvgStrings.Filled = "Filled".asInstanceOf[web.typings.antDesignIconsSvg.antDesignIconsSvgStrings.Filled]
    
    @scala.inline
    def Outlined: web.typings.antDesignIconsSvg.antDesignIconsSvgStrings.Outlined = "Outlined".asInstanceOf[web.typings.antDesignIconsSvg.antDesignIconsSvgStrings.Outlined]
    
    @scala.inline
    def TwoTone: web.typings.antDesignIconsSvg.antDesignIconsSvgStrings.TwoTone = "TwoTone".asInstanceOf[web.typings.antDesignIconsSvg.antDesignIconsSvgStrings.TwoTone]
  }
}
