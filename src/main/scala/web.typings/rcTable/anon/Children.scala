...
object Children {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: Children[_], RecordType /* <: /* import warning: importer.ImportType#apply Failed type conversion: {  children :std.Array<RecordType> | undefined} */ js.Any */] (val x: Self with Children[RecordType]) extends AnyVal {
