...
import web.typings.rcTable.anon.Y
...
object libVirtualTableMod {
  
  @JSImport("rc-table/lib/VirtualTable", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("rc-table/lib/VirtualTable", JSImport.Default)
  @js.native
  val default: ForwardGenericVirtualTable = js.native
  ...
  type ForwardGenericVirtualTable = (js.Function1[/* props */ TableProps[Any] with Ref, ReactElement]) with DisplayName
  
  /* Inlined parent std.Omit<rc-table.rc-table/lib/Table.TableProps<RecordType>, 'scroll'> */
  @js.native
  trait VirtualTableProps[RecordType] extends StObject {
  ...
  object VirtualTableProps {
    
    @scala.inline
    def apply[RecordType](scroll: Y): VirtualTableProps[RecordType] = {
      val __obj = js.Dynamic.literal(scroll = scroll.asInstanceOf[js.Any])
      __obj.asInstanceOf[VirtualTableProps[RecordType]]
    }
    
    @scala.inline
    implicit class MutableBuilder[Self <: VirtualTableProps[_], RecordType] (val x: Self with VirtualTableProps[RecordType]) extends AnyVal {
      ...
      @scala.inline
      def setScroll(value: Y): Self = StObject.set(x, "scroll", value.asInstanceOf[js.Any])
