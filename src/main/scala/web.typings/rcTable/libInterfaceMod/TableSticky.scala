...
trait TableSticky extends StObject {
  ...
  var offsetSummary: js.UndefOr[Double] = js.native
}
object TableSticky {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: TableSticky] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOffsetSummaryUndefined: Self = StObject.set(x, "offsetSummary", js.undefined)
  }
}
