...
import web.typings.rcTable.libInterfaceMod.ColScopeType
...
import web.typings.rcTable.libInterfaceMod._Component
import web.typings.rcTable.libInterfaceMod._FixedType
