...
object RcMentions {
  ...
  implicit def make(companion: RcMentions.type): SharedBuilder_MentionsPropsRefAttributes_680664533[MentionsRef] = new SharedBuilder_MentionsPropsRefAttributes_680664533[MentionsRef](js.Array(this.component, js.Dictionary.empty))()
