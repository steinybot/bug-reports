...
@scala.inline
class SharedBuilder_MentionsPropsRefAttributes_680664533[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  @scala.inline
  def filterOption(value: `false` | (js.Function2[/* input */ String, /* param1 */ OptionProps, Boolean])): this.type = set("filterOption", value.asInstanceOf[js.Any])
  
  @scala.inline
  def filterOptionFunction2(value: (/* input */ String, /* param1 */ OptionProps) => Boolean): this.type = set("filterOption", js.Any.fromFunction2(value))
