...
object esMentionsMod {
  ...
  object BaseTextareaAttrs {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: BaseTextareaAttrs] (val x: Self) extends AnyVal {
  ...
  object DataDrivenOptionProps {
    ...
    @scala.inline
    def apply(): DataDrivenOptionProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[DataDrivenOptionProps]
    }
    
    @scala.inline
    implicit class MutableBuilder[Self <: DataDrivenOptionProps] (val x: Self) extends AnyVal {
  ...
  /* Rewritten from type alias, can be one of: 
    - `web.typings`.rcMentions.rcMentionsStrings.ltr
    - `web.typings`.rcMentions.rcMentionsStrings.rtl
  */
  trait Direction extends StObject
  object Direction {
    
    @scala.inline
    def ltr: web.typings.rcMentions.rcMentionsStrings.ltr = "ltr".asInstanceOf[web.typings.rcMentions.rcMentionsStrings.ltr]
    
    @scala.inline
    def rtl: web.typings.rcMentions.rcMentionsStrings.rtl = "rtl".asInstanceOf[web.typings.rcMentions.rcMentionsStrings.rtl]
  }
  ...
  object MentionsProps {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: MentionsProps] (val x: Self) extends AnyVal {
  ...
  trait MentionsRef extends StObject {
    ...
    var textarea: HTMLTextAreaElement | Null = js.native
  }
  object MentionsRef {
    
    @scala.inline
    def apply(blur: () => Unit, focus: () => Unit): MentionsRef = {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: MentionsRef] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTextareaNull: Self = StObject.set(x, "textarea", null)
    }
  }
  
  /* Rewritten from type alias, can be one of: 
    - `web.typings`.rcMentions.rcMentionsStrings.top
    - `web.typings`.rcMentions.rcMentionsStrings.bottom
  */
  trait Placement extends StObject
  object Placement {
    
    @scala.inline
    def bottom: web.typings.rcMentions.rcMentionsStrings.bottom = "bottom".asInstanceOf[web.typings.rcMentions.rcMentionsStrings.bottom]
    
    @scala.inline
    def top: web.typings.rcMentions.rcMentionsStrings.top = "top".asInstanceOf[web.typings.rcMentions.rcMentionsStrings.top]
  }
}
