...
@scala.inline
class SharedBuilder_InputPropsRefAttributes498402693[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  @scala.inline
  def classNames(value: js.UndefOr[Prefix] with web.typings.rcInput.anon.Input): this.type = set("classNames", value.asInstanceOf[js.Any])
  ...
  @scala.inline
  def count(value: CountConfig): this.type = set("count", value.asInstanceOf[js.Any])
  ...
  @scala.inline
  def htmlSize(value: Double): this.type = set("htmlSize", value.asInstanceOf[js.Any])
  ...
  @scala.inline
  def showCount(value: Boolean | Formatter): this.type = set("showCount", value.asInstanceOf[js.Any])
  ...
  @scala.inline
  def styles(value: js.UndefOr[Suffix] with CountInput): this.type = set("styles", value.asInstanceOf[js.Any])
