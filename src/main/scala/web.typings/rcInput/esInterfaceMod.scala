...
import web.typings.rcInput.esUtilsCommonUtilsMod.InputFocusOptions
import web.typings.rcInput.esUtilsTypesMod.LiteralUnion
import web.typings.rcInput.rcInputStrings._empty
import web.typings.rcInput.rcInputStrings.`additions removals`
import web.typings.rcInput.rcInputStrings.`additions text`
import web.typings.rcInput.rcInputStrings.`datetime-local`
import web.typings.rcInput.rcInputStrings.`inline`
import web.typings.rcInput.rcInputStrings.`removals additions`
import web.typings.rcInput.rcInputStrings.`removals text`
import web.typings.rcInput.rcInputStrings.`text additions`
import web.typings.rcInput.rcInputStrings.`text removals`
import web.typings.rcInput.rcInputStrings.`use-credentials`
import web.typings.rcInput.rcInputStrings.additions
import web.typings.rcInput.rcInputStrings.all
import web.typings.rcInput.rcInputStrings.anonymous
import web.typings.rcInput.rcInputStrings.ascending
import web.typings.rcInput.rcInputStrings.assertive
import web.typings.rcInput.rcInputStrings.backward
import web.typings.rcInput.rcInputStrings.both
import web.typings.rcInput.rcInputStrings.button
import web.typings.rcInput.rcInputStrings.checkbox
import web.typings.rcInput.rcInputStrings.color
import web.typings.rcInput.rcInputStrings.copy
import web.typings.rcInput.rcInputStrings.date
import web.typings.rcInput.rcInputStrings.decimal
import web.typings.rcInput.rcInputStrings.descending
import web.typings.rcInput.rcInputStrings.dialog
import web.typings.rcInput.rcInputStrings.done
import web.typings.rcInput.rcInputStrings.email
import web.typings.rcInput.rcInputStrings.enter
import web.typings.rcInput.rcInputStrings.environment
import web.typings.rcInput.rcInputStrings.execute
import web.typings.rcInput.rcInputStrings.file
import web.typings.rcInput.rcInputStrings.forward
import web.typings.rcInput.rcInputStrings.go
import web.typings.rcInput.rcInputStrings.grammar
import web.typings.rcInput.rcInputStrings.grid
import web.typings.rcInput.rcInputStrings.hidden
import web.typings.rcInput.rcInputStrings.horizontal
import web.typings.rcInput.rcInputStrings.image
import web.typings.rcInput.rcInputStrings.inherit
import web.typings.rcInput.rcInputStrings.link
import web.typings.rcInput.rcInputStrings.list
import web.typings.rcInput.rcInputStrings.listbox
import web.typings.rcInput.rcInputStrings.location
import web.typings.rcInput.rcInputStrings.menu
import web.typings.rcInput.rcInputStrings.mixed
import web.typings.rcInput.rcInputStrings.month
import web.typings.rcInput.rcInputStrings.move
import web.typings.rcInput.rcInputStrings.next
import web.typings.rcInput.rcInputStrings.no
import web.typings.rcInput.rcInputStrings.none
import web.typings.rcInput.rcInputStrings.number
import web.typings.rcInput.rcInputStrings.numeric
import web.typings.rcInput.rcInputStrings.off
import web.typings.rcInput.rcInputStrings.on
import web.typings.rcInput.rcInputStrings.other
import web.typings.rcInput.rcInputStrings.page
import web.typings.rcInput.rcInputStrings.password
import web.typings.rcInput.rcInputStrings.polite
import web.typings.rcInput.rcInputStrings.popup
import web.typings.rcInput.rcInputStrings.previous
import web.typings.rcInput.rcInputStrings.radio
import web.typings.rcInput.rcInputStrings.range
import web.typings.rcInput.rcInputStrings.removals
import web.typings.rcInput.rcInputStrings.reset
import web.typings.rcInput.rcInputStrings.search
import web.typings.rcInput.rcInputStrings.send
import web.typings.rcInput.rcInputStrings.spelling
import web.typings.rcInput.rcInputStrings.step
import web.typings.rcInput.rcInputStrings.submit
import web.typings.rcInput.rcInputStrings.tel
import web.typings.rcInput.rcInputStrings.text
import web.typings.rcInput.rcInputStrings.time
import web.typings.rcInput.rcInputStrings.tree
import web.typings.rcInput.rcInputStrings.url
import web.typings.rcInput.rcInputStrings.user
import web.typings.rcInput.rcInputStrings.vertical
import web.typings.rcInput.rcInputStrings.week
import web.typings.rcInput.rcInputStrings.yes
...
object esInterfaceMod {
  ...
  @js.native
  trait BaseInputProps
    extends StObject
       with CommonInputProps {
    
    var className: js.UndefOr[String] = js.native
    
    var components: js.UndefOr[GroupAddon] = js.native
    
    var dataAttrs: js.UndefOr[`0`] = js.native
    
    var disabled: js.UndefOr[Boolean] = js.native
    
    var focused: js.UndefOr[Boolean] = js.native
    
    var handleReset: js.UndefOr[MouseEventHandler[Element]] = js.native
  ...
  object BaseInputProps {
    ...
    @scala.inline
    def apply(inputElement: ReactElement): BaseInputProps = {
      val __obj = js.Dynamic.literal(inputElement = inputElement.asInstanceOf[js.Any])
      __obj.asInstanceOf[BaseInputProps]
    }
    
    @scala.inline
    implicit class MutableBuilder[Self <: BaseInputProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setComponents(value: GroupAddon): Self = StObject.set(x, "components", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentsUndefined: Self = StObject.set(x, "components", js.undefined)
      
      @scala.inline
      def setDataAttrs(value: `0`): Self = StObject.set(x, "dataAttrs", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setHandleReset(value: SyntheticMouseEvent[Element] => Unit): Self = StObject.set(x, "handleReset", js.Any.fromFunction1(value))
  ...
  @js.native
  trait CommonInputProps extends StObject {
    ...
    var classNames: js.UndefOr[Prefix] = js.native
    ...
    var styles: js.UndefOr[Suffix] = js.native
  ...
  object CommonInputProps {
    ...
    @scala.inline
    def apply(): CommonInputProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[CommonInputProps]
    }
    
    @scala.inline
    implicit class MutableBuilder[Self <: CommonInputProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClassNames(value: Prefix): Self = StObject.set(x, "classNames", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setStyles(value: Suffix): Self = StObject.set(x, "styles", value.asInstanceOf[js.Any])
  ...
  @js.native
  trait CountConfig extends StObject {
    ...
    var show: js.UndefOr[Boolean | ShowCountFormatter] = js.native
  ...
  object CountConfig {
    ...
    @scala.inline
    def apply(): CountConfig = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[CountConfig]
    }
    
    @scala.inline
    implicit class MutableBuilder[Self <: CountConfig] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setShow(value: Boolean | ShowCountFormatter): Self = StObject.set(x, "show", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setShowFunction1(value: /* args */ Count => ReactElement): Self = StObject.set(x, "show", js.Any.fromFunction1(value))
  ...
  type ExceedFormatter = js.Function2[/* value */ String, /* config */ Max, String]
  
  /* Inlined parent rc-input.rc-input/es/interface.CommonInputProps */
  /* Inlined parent std.Omit<react.react.InputHTMLAttributes<std.HTMLInputElement>, 'size' | 'prefix' | 'type' | 'value'> */
  @js.native
  trait InputProps extends StObject {
    ...
    var htmlSize: js.UndefOr[Double] = js.native
    ...
    var showCount: js.UndefOr[Boolean | Formatter] = js.native
  ...
  object InputProps {
    ...
    implicit class MutableBuilder[Self <: InputProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHtmlSize(value: Double): Self = StObject.set(x, "htmlSize", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setHtmlSizeUndefined: Self = StObject.set(x, "htmlSize", js.undefined)
      ...
      @scala.inline
      def setShowCount(value: Boolean | Formatter): Self = StObject.set(x, "showCount", value.asInstanceOf[js.Any])
  ...
  type ShowCountFormatter = js.Function1[/* args */ Count, ReactElement]
  
  type ValueType = js.UndefOr[String | js.Array[String] | Double | js.BigInt]
}
