...
import web.typings.rcTextarea.esInterfaceMod.ResizableTextAreaRef
import web.typings.rcTextarea.esInterfaceMod.TextAreaRef
import web.typings.rcTextarea.rcTextareaStrings.`additions removals`
import web.typings.rcTextarea.rcTextareaStrings.`additions text`
import web.typings.rcTextarea.rcTextareaStrings.`inline`
import web.typings.rcTextarea.rcTextareaStrings.`removals additions`
import web.typings.rcTextarea.rcTextareaStrings.`removals text`
import web.typings.rcTextarea.rcTextareaStrings.`text additions`
import web.typings.rcTextarea.rcTextareaStrings.`text removals`
import web.typings.rcTextarea.rcTextareaStrings.additions
import web.typings.rcTextarea.rcTextareaStrings.all
import web.typings.rcTextarea.rcTextareaStrings.ascending
import web.typings.rcTextarea.rcTextareaStrings.assertive
import web.typings.rcTextarea.rcTextareaStrings.both
import web.typings.rcTextarea.rcTextareaStrings.copy
import web.typings.rcTextarea.rcTextareaStrings.date
import web.typings.rcTextarea.rcTextareaStrings.decimal
import web.typings.rcTextarea.rcTextareaStrings.descending
import web.typings.rcTextarea.rcTextareaStrings.dialog
import web.typings.rcTextarea.rcTextareaStrings.email
import web.typings.rcTextarea.rcTextareaStrings.execute
import web.typings.rcTextarea.rcTextareaStrings.grammar
import web.typings.rcTextarea.rcTextareaStrings.grid
import web.typings.rcTextarea.rcTextareaStrings.horizontal
import web.typings.rcTextarea.rcTextareaStrings.inherit
import web.typings.rcTextarea.rcTextareaStrings.link
import web.typings.rcTextarea.rcTextareaStrings.list
import web.typings.rcTextarea.rcTextareaStrings.listbox
import web.typings.rcTextarea.rcTextareaStrings.location
import web.typings.rcTextarea.rcTextareaStrings.menu
import web.typings.rcTextarea.rcTextareaStrings.mixed
import web.typings.rcTextarea.rcTextareaStrings.move
import web.typings.rcTextarea.rcTextareaStrings.no
import web.typings.rcTextarea.rcTextareaStrings.none
import web.typings.rcTextarea.rcTextareaStrings.numeric
import web.typings.rcTextarea.rcTextareaStrings.off
import web.typings.rcTextarea.rcTextareaStrings.on
import web.typings.rcTextarea.rcTextareaStrings.other
import web.typings.rcTextarea.rcTextareaStrings.page
import web.typings.rcTextarea.rcTextareaStrings.polite
import web.typings.rcTextarea.rcTextareaStrings.popup
import web.typings.rcTextarea.rcTextareaStrings.removals
import web.typings.rcTextarea.rcTextareaStrings.search
import web.typings.rcTextarea.rcTextareaStrings.spelling
import web.typings.rcTextarea.rcTextareaStrings.step
import web.typings.rcTextarea.rcTextareaStrings.tel
import web.typings.rcTextarea.rcTextareaStrings.text
import web.typings.rcTextarea.rcTextareaStrings.time
import web.typings.rcTextarea.rcTextareaStrings.tree
import web.typings.rcTextarea.rcTextareaStrings.url
import web.typings.rcTextarea.rcTextareaStrings.vertical
import web.typings.rcTextarea.rcTextareaStrings.yes
...
object anon {
  ...
  trait AffixWrapper extends StObject {
    ...
    var countWrapper: js.UndefOr[String] = js.native
  }
  object AffixWrapper {
    ...
    implicit class MutableBuilder[Self <: AffixWrapper] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCountWrapper(value: String): Self = StObject.set(x, "countWrapper", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCountWrapperUndefined: Self = StObject.set(x, "countWrapper", js.undefined)
    }
  }
  ...
  /* Inlined std.Omit<rc-textarea.rc-textarea/es/interface.HTMLTextareaProps, 'value' | 'onResize'> & {  value :string | number | bigint | std.Array<string> | undefined,   prefixCls :string | undefined,   className :string | undefined,   style :react.react.CSSProperties | undefined,   autoSize :boolean | rc-textarea.rc-textarea/es/interface.AutoSizeType | undefined,   onPressEnter :react.react.KeyboardEventHandler<std.HTMLTextAreaElement> | undefined,   onResize :(size : {  width :number,   height :number}): void | undefined,   classes :{  countWrapper :string | undefined,   affixWrapper :string | undefined} | undefined,   classNames :{  textarea :string | undefined,   count :string | undefined} | undefined,   styles :{  textarea :react.react.CSSProperties | undefined,   count :react.react.CSSProperties | undefined} | undefined} & std.Pick<rc-input.rc-input/es/interface.BaseInputProps, 'allowClear' | 'suffix'> & std.Pick<rc-input.rc-input.InputProps, 'showCount' | 'count'> & react.react.RefAttributes<rc-textarea.rc-textarea/es/interface.ResizableTextAreaRef> */
  @js.native
  trait OmitHTMLTextareaPropsvalu extends StObject {
    ...
    /**
      ...
      */
    var ref: js.UndefOr[Ref[ResizableTextAreaRef]] = js.native
    ...
    var value: js.UndefOr[String | Double | js.BigInt | js.Array[String]] = js.native
    
    var vocab: js.UndefOr[String] = js.native
    
    var wrap: js.UndefOr[String] = js.native
  }
  object OmitHTMLTextareaPropsvalu {
    
    @scala.inline
    def apply(): OmitHTMLTextareaPropsvalu = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[OmitHTMLTextareaPropsvalu]
    }
    
    @scala.inline
    implicit class MutableBuilder[Self <: OmitHTMLTextareaPropsvalu] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRef(value: Ref[ResizableTextAreaRef]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRefFunction1(value: /* instance */ ResizableTextAreaRef | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
      
      @scala.inline
      def setRefNull: Self = StObject.set(x, "ref", null)
      
      @scala.inline
      def setRefReactRef(value: ReactRef[ResizableTextAreaRef]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setValue(value: String | Double | js.BigInt | js.Array[String]): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
  ...
  /* Inlined std.Omit<rc-textarea.rc-textarea/es/interface.HTMLTextareaProps, 'value' | 'onResize'> & {  value :string | number | bigint | std.Array<string> | undefined,   prefixCls :string | undefined,   className :string | undefined,   style :react.react.CSSProperties | undefined,   autoSize :boolean | rc-textarea.rc-textarea/es/interface.AutoSizeType | undefined,   onPressEnter :react.react.KeyboardEventHandler<std.HTMLTextAreaElement> | undefined,   onResize :(size : {  width :number,   height :number}): void | undefined,   classes :{  countWrapper :string | undefined,   affixWrapper :string | undefined} | undefined,   classNames :{  textarea :string | undefined,   count :string | undefined} | undefined,   styles :{  textarea :react.react.CSSProperties | undefined,   count :react.react.CSSProperties | undefined} | undefined} & std.Pick<rc-input.rc-input/es/interface.BaseInputProps, 'allowClear' | 'suffix'> & std.Pick<rc-input.rc-input.InputProps, 'showCount' | 'count'> & react.react.RefAttributes<rc-textarea.rc-textarea/es/interface.TextAreaRef> */
  @js.native
  trait OmitHTMLTextareaPropsvaluAbout extends StObject {
    ...
    /**
      ...
      * @see https://react.dev/learn/referencing-values-with-refs#refs-and-the-dom
      */
    var ref: js.UndefOr[Ref[TextAreaRef]] = js.native
  ...
  object OmitHTMLTextareaPropsvaluAbout {
    
    @scala.inline
    def apply(): OmitHTMLTextareaPropsvaluAbout = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[OmitHTMLTextareaPropsvaluAbout]
    }
    
    @scala.inline
    implicit class MutableBuilder[Self <: OmitHTMLTextareaPropsvaluAbout] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRef(value: Ref[TextAreaRef]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRefFunction1(value: /* instance */ TextAreaRef | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
      
      @scala.inline
      def setRefNull: Self = StObject.set(x, "ref", null)
      
      @scala.inline
      def setRefReactRef(value: ReactRef[TextAreaRef]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
  ...
  trait Textarea extends StObject {
    ...
    var textarea: js.UndefOr[CSSProperties] = js.native
  }
  object Textarea {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: Textarea] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTextarea(value: CSSProperties): Self = StObject.set(x, "textarea", value.asInstanceOf[js.Any])
