...
object ResizableTextArea {
  ...
  class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[tag.type, ResizableTextAreaRef] {
    ...
    @scala.inline
    def classNames(value: Count): this.type = set("classNames", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def styles(value: Textarea): this.type = set("styles", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def value(value: String | Double | js.BigInt | js.Array[String]): this.type = set("value", value.asInstanceOf[js.Any])
  ...
  type Props = OmitHTMLTextareaPropsvalu
  
  implicit def make(companion: ResizableTextArea.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: OmitHTMLTextareaPropsvalu): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
