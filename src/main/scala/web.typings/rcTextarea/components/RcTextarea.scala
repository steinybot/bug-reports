...
object RcTextarea {
  ...
  implicit def make(companion: RcTextarea.type): SharedBuilder_OmitHTMLTextareaPropsvaluAbout_1374936960[TextAreaRef] = new SharedBuilder_OmitHTMLTextareaPropsvaluAbout_1374936960[TextAreaRef](js.Array(this.component, js.Dictionary.empty))()
