...
import web.typings.react.mod.TextareaHTMLAttributes
...
object esInterfaceMod {
  ...
  object AutoSizeType {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: AutoSizeType] (val x: Self) extends AnyVal {
  ...
  object ResizableTextAreaRef {
    ...
    @scala.inline
    def apply(textArea: HTMLTextAreaElement): ResizableTextAreaRef = {
      val __obj = js.Dynamic.literal(textArea = textArea.asInstanceOf[js.Any])
      __obj.asInstanceOf[ResizableTextAreaRef]
    }
    
    @scala.inline
    implicit class MutableBuilder[Self <: ResizableTextAreaRef] (val x: Self) extends AnyVal {
  ...
  /* Inlined std.Omit<rc-textarea.rc-textarea/es/interface.HTMLTextareaProps, 'onResize' | 'value'> & {  value :rc-textarea.rc-textarea/es/interface.HTMLTextareaProps['value'] | bigint | undefined,   prefixCls :string | undefined,   className :string | undefined,   style :react.react.CSSProperties | undefined,   autoSize :boolean | rc-textarea.rc-textarea/es/interface.AutoSizeType | undefined,   onPressEnter :react.react.KeyboardEventHandler<std.HTMLTextAreaElement> | undefined,   onResize :(size : {  width :number,   height :number}): void | undefined,   classes :{  countWrapper :string | undefined,   affixWrapper :string | undefined} | undefined,   classNames :{  textarea :string | undefined,   count :string | undefined} | undefined,   styles :{  textarea :react.react.CSSProperties | undefined,   count :react.react.CSSProperties | undefined} | undefined} & std.Pick<rc-input.rc-input/es/interface.BaseInputProps, 'allowClear' | 'suffix'> & std.Pick<rc-input.rc-input/es/interface.InputProps, 'showCount' | 'count'> */
  @js.native
  trait TextAreaProps extends StObject {
    ...
    var value: js.UndefOr[String | js.Array[String] | Double | js.BigInt] = js.native
  ...
  object TextAreaProps {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: TextAreaProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setValue(value: String | js.Array[String] | Double | js.BigInt): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
  ...
  object TextAreaRef {
    ...
    @scala.inline
    def apply(blur: () => Unit, focus: () => Unit, resizableTextArea: ResizableTextAreaRef): TextAreaRef = {
      val __obj = js.Dynamic.literal(blur = js.Any.fromFunction0(blur), focus = js.Any.fromFunction0(focus), resizableTextArea = resizableTextArea.asInstanceOf[js.Any])
      __obj.asInstanceOf[TextAreaRef]
    }
    
    @scala.inline
    implicit class MutableBuilder[Self <: TextAreaRef] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResizableTextArea(value: ResizableTextAreaRef): Self = StObject.set(x, "resizableTextArea", value.asInstanceOf[js.Any])
    }
  }
}
