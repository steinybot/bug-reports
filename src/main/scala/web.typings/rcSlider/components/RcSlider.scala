...
object RcSlider {
  ...
  implicit def make(companion: RcSlider.type): SharedBuilder_SliderPropsRefAttributes_1844665825[SliderRef] = new SharedBuilder_SliderPropsRefAttributes_1844665825[SliderRef](js.Array(this.component, js.Dictionary.empty))()
