...
import web.typings.rcUpload.esInterfaceMod.Action
import web.typings.rcUpload.esInterfaceMod.BeforeUploadFileType
import web.typings.rcUpload.esInterfaceMod.RcFile
import web.typings.rcUpload.esInterfaceMod.UploadProgressEvent
import web.typings.rcUpload.esInterfaceMod.UploadRequestHeader
import web.typings.rcUpload.esInterfaceMod.UploadRequestMethod
...
@scala.inline
class SharedBuilder_UploadProps_119302209[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  @scala.inline
  def action(value: Action): this.type = set("action", value.asInstanceOf[js.Any])
  
  @scala.inline
  def actionFunction1(value: /* file */ RcFile => String | PromiseLike[String]): this.type = set("action", js.Any.fromFunction1(value))
  ...
  @scala.inline
  def component(value: JSXElementConstructor[Any]): this.type = set("component", value.asInstanceOf[js.Any])
  
  @scala.inline
  def componentFunction2(value: (Any, /* deprecatedLegacyContext */ js.UndefOr[Any]) => ReactElement): this.type = set("component", js.Any.fromFunction2(value))
  ...
  @scala.inline
  def customRequest(value: /* option */ UploadRequestOption[Any] => Unit): this.type = set("customRequest", js.Any.fromFunction1(value))
  ...
  @scala.inline
  def dataFunction1(value: /* file */ RcFile | String | Blob => Record[String, Any]): this.type = set("data", js.Any.fromFunction1(value))
  ...
  @scala.inline
  def headers(value: UploadRequestHeader): this.type = set("headers", value.asInstanceOf[js.Any])
  ...
  @scala.inline
  def method(value: UploadRequestMethod): this.type = set("method", value.asInstanceOf[js.Any])
  ...
  @scala.inline
  def onBatchStart(value: /* fileList */ js.Array[File] => Unit): this.type = set("onBatchStart", js.Any.fromFunction1(value))
  ...
  @scala.inline
  def onError(value: (/* error */ js.Error, /* ret */ Record[String, Any], /* file */ RcFile) => Unit): this.type = set("onError", js.Any.fromFunction3(value))
  ...
  @scala.inline
  def onMouseEnter(value: /* e */ SyntheticMouseEvent[HTMLDivElement] => Unit): this.type = set("onMouseEnter", js.Any.fromFunction1(value))
  
  @scala.inline
  def onMouseLeave(value: /* e */ SyntheticMouseEvent[HTMLDivElement] => Unit): this.type = set("onMouseLeave", js.Any.fromFunction1(value))
  ...
  @scala.inline
  def onProgress(value: (/* event */ UploadProgressEvent, /* file */ RcFile) => Unit): this.type = set("onProgress", js.Any.fromFunction2(value))
  ...
  @scala.inline
  def onStart(value: /* file */ RcFile => Unit): this.type = set("onStart", js.Any.fromFunction1(value))
  ...
  @scala.inline
  def onSuccess(value: (/* response */ Record[String, Any], /* file */ RcFile, /* xhr */ XMLHttpRequest) => Unit): this.type = set("onSuccess", js.Any.fromFunction3(value))
