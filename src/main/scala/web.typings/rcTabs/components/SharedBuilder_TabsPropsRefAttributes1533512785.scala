...
@scala.inline
class SharedBuilder_TabsPropsRefAttributes1533512785[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  @scala.inline
  def items(value: js.Array[Tab]): this.type = set("items", value.asInstanceOf[js.Any])
  
  @scala.inline
  def itemsVarargs(value: Tab*): this.type = set("items", js.Array(value :_*))
