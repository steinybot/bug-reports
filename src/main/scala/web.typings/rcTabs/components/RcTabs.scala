...
object RcTabs {
  ...
  implicit def make(companion: RcTabs.type): SharedBuilder_TabsPropsRefAttributes1533512785[HTMLDivElement] = new SharedBuilder_TabsPropsRefAttributes1533512785[HTMLDivElement](js.Array(this.component, js.Dictionary.empty))()
