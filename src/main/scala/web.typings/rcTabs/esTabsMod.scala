...
import web.typings.rcTabs.rcTabsStrings.`additions removals`
import web.typings.rcTabs.rcTabsStrings.`additions text`
import web.typings.rcTabs.rcTabsStrings.`inline`
import web.typings.rcTabs.rcTabsStrings.`removals additions`
import web.typings.rcTabs.rcTabsStrings.`removals text`
import web.typings.rcTabs.rcTabsStrings.`text additions`
import web.typings.rcTabs.rcTabsStrings.`text removals`
import web.typings.rcTabs.rcTabsStrings.additions
import web.typings.rcTabs.rcTabsStrings.all
import web.typings.rcTabs.rcTabsStrings.ascending
import web.typings.rcTabs.rcTabsStrings.assertive
import web.typings.rcTabs.rcTabsStrings.both
import web.typings.rcTabs.rcTabsStrings.copy
import web.typings.rcTabs.rcTabsStrings.date
import web.typings.rcTabs.rcTabsStrings.decimal
import web.typings.rcTabs.rcTabsStrings.descending
import web.typings.rcTabs.rcTabsStrings.dialog
import web.typings.rcTabs.rcTabsStrings.email
import web.typings.rcTabs.rcTabsStrings.execute
import web.typings.rcTabs.rcTabsStrings.grammar
import web.typings.rcTabs.rcTabsStrings.grid
import web.typings.rcTabs.rcTabsStrings.horizontal
import web.typings.rcTabs.rcTabsStrings.inherit
import web.typings.rcTabs.rcTabsStrings.link
import web.typings.rcTabs.rcTabsStrings.list
import web.typings.rcTabs.rcTabsStrings.listbox
import web.typings.rcTabs.rcTabsStrings.location
import web.typings.rcTabs.rcTabsStrings.ltr
import web.typings.rcTabs.rcTabsStrings.menu
import web.typings.rcTabs.rcTabsStrings.mixed
import web.typings.rcTabs.rcTabsStrings.move
import web.typings.rcTabs.rcTabsStrings.no
import web.typings.rcTabs.rcTabsStrings.none
import web.typings.rcTabs.rcTabsStrings.numeric
import web.typings.rcTabs.rcTabsStrings.off
import web.typings.rcTabs.rcTabsStrings.on
import web.typings.rcTabs.rcTabsStrings.other
import web.typings.rcTabs.rcTabsStrings.page
import web.typings.rcTabs.rcTabsStrings.polite
import web.typings.rcTabs.rcTabsStrings.popup
import web.typings.rcTabs.rcTabsStrings.removals
import web.typings.rcTabs.rcTabsStrings.rtl
import web.typings.rcTabs.rcTabsStrings.search
import web.typings.rcTabs.rcTabsStrings.spelling
import web.typings.rcTabs.rcTabsStrings.step
import web.typings.rcTabs.rcTabsStrings.tel
import web.typings.rcTabs.rcTabsStrings.text
import web.typings.rcTabs.rcTabsStrings.time
import web.typings.rcTabs.rcTabsStrings.tree
import web.typings.rcTabs.rcTabsStrings.url
import web.typings.rcTabs.rcTabsStrings.vertical
import web.typings.rcTabs.rcTabsStrings.yes
...
object esTabsMod extends Shortcut {
  ...
  /* Inlined parent std.Omit<react.react.HTMLAttributes<std.HTMLDivElement>, 'onChange' | 'children'> */
  @js.native
  trait TabsProps extends StObject {
    ...
    var items: js.UndefOr[js.Array[Tab]] = js.native
  ...
  object TabsProps {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: TabsProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: js.Array[Tab]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
      
      @scala.inline
      def setItemsVarargs(value: Tab*): Self = StObject.set(x, "items", js.Array(value :_*))
  ...
  /* This means you don't have to write `default`, but can instead just say `esTabsMod.foo` */
