...
object RcCollapse {
  ...
  implicit def make(companion: RcCollapse.type): SharedBuilder_CollapsePropsRefAttributes_894168561[HTMLDivElement] = new SharedBuilder_CollapsePropsRefAttributes_894168561[HTMLDivElement](js.Array(this.component, js.Dictionary.empty))()
