...
import web.typings.rcFieldForm.anon.Errors
...
object ValidateErrorEntity {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: ValidateErrorEntity[_], Values] (val x: Self with ValidateErrorEntity[Values]) extends AnyVal {
