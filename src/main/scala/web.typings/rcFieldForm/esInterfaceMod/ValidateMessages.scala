...
import web.typings.rcFieldForm.anon.Array
import web.typings.rcFieldForm.anon.Format
import web.typings.rcFieldForm.anon.Len
import web.typings.rcFieldForm.anon.Mismatch
...
object ValidateMessages {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: ValidateMessages] (val x: Self) extends AnyVal {
