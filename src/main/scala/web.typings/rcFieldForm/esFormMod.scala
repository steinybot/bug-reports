...
object esFormMod extends Shortcut {
  ...
  object BaseFormProps {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: BaseFormProps] (val x: Self) extends AnyVal {
  ...
  object FormProps {
    ...
    implicit class MutableBuilder[Self <: FormProps[_], Values] (val x: Self with FormProps[Values]) extends AnyVal {
      ...
      @scala.inline
      def setChildrenFunction2(value: (/* values */ Store, /* form */ FormInstance[Any]) => Element | ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction2(value))
  ...
  type RenderProps = js.Function2[/* values */ Store, /* form */ FormInstance[Any], Element | ReactElement]
