...
object esmPluginRelativeTimeMod extends Shortcut {
  ...
  object RelativeTimeOptions {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: RelativeTimeOptions] (val x: Self) extends AnyVal {
  ...
  object RelativeTimeThreshold {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: RelativeTimeThreshold] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `^`, but can instead just say `esmPluginRelativeTimeMod.foo` */
