...
object esmPluginToObjectMod extends Shortcut {
  ...
  object DayjsObject {
    ...
    @scala.inline
    implicit class MutableBuilder[Self <: DayjsObject] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `^`, but can instead just say `esmPluginToObjectMod.foo` */
