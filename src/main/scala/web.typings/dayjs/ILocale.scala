...
import web.typings.dayjs.anon.PartialLTstringLTSstringL
import web.typings.dayjs.anon.Partialfuturestringpastst
...
object ILocale {
  ...
  @scala.inline
  implicit class MutableBuilder[Self <: ILocale] (val x: Self) extends AnyVal {
